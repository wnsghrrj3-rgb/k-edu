...
(function(){
  ...
  if(!document.getElementById('kspace-style')){
    ...
    function makePlanetLabel(t){
      ...
      var x=cv.getContext('2d');
      x.font='38px Gowun Dodum,sans-serif'; x.textAlign='center'; x.textBaseline='middle';
    ...
    function makeLabel(t){
      ...
      var x=cv.getContext('2d'); x.font='34px Gowun Dodum,sans-serif'; x.textAlign='center'; x.textBaseline='middle';
