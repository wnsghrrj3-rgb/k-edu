  ...
  window.LESSONS["u5_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"두리가 활짝 웃고 있네. 무슨 좋은 일이 있나?\""},{"face":"👦","label":"두리 \"말 안 해도 내 마음을 알겠어?\""}],
        "tnote": {"ask":["친구가 활짝 웃고 있어. 어떤 마음일까? 말하지 않아도 알 수 있어?"],"watch":"표정으로","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["말하지 않아도 마음을 알 수 있을까?","마음은 무엇으로 짐작할 수 있어? 네 가지!"],"watch":"마음 짐작 감각 열기 · 말·행동·표정·상황","min":4},
          "title": "마음을 짐작하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"넘어져서 고개를 숙이고 있어요\"는 어떤 마음?"],"watch":"속상","min":4},
          "title": "이때 어떤 마음일까요? 💭",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["마음을 짐작해 본 적 있어? 무엇을 보고 알았어?"],"watch":"경험","min":5},
          "title": "마음을 나눠요",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["짝 표정을 보고 마음을 맞혀 볼까?"],"watch":"놀이","min":5},
          "title": "마음을 짐작하며 느끼기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["짝 활동에서 맞힌 마음은? 어떻게 알았어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음을 헤아리면 무엇이 좋아?"],"watch":"이해·배려","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "마음은 무엇으로 짐작하나요?",
  ...
  window.LESSONS["u5_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"아빠가방에들어가신다… 아빠 가방?\""},{"face":"👧","label":"하나 \"아빠가 / 방에 / 들어가신다! 쉬어 읽으니 뜻이 보여.\""}],
        "tnote": {"ask":["\"아빠가방에들어가신다\"를 어떻게 읽느냐에 따라 뜻이 달라져. 어떻게 읽어야 할까?"],"watch":"아빠가/방에/들어가신다","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["왜 띄어 읽어야 할까?","뜻이 통하는 덩어리로 쉬어 읽으면 뭐가 좋아? 어디서 쉬면 좋을까?"],"watch":"띄어 읽기 필요성 · 누가 뒤·문장 사이","min":4},
          "title": "뜻이 드러나게 띄어 읽기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"동생이 우유를 마신다\"를 띄어 읽어 볼까? 어색한 읽기는?"],"watch":"동생이/우유를/마신다","min":4},
          "title": "바르게 띄어 읽은 것은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["문장을 뜻이 드러나게 띄어 읽어 볼까?"],"watch":"읽기","min":5},
          "title": "띄어 읽어 봐요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 같은 문장을 다르게 띄어 읽어 보고 어느 쪽이 뜻이 잘 드러나는지 말해 볼까?"],"watch":"비교","min":5},
          "title": "뜻이 드러나게 띄어 읽기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 활동에서 뜻이 바뀐 읽기가 있었어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
          "title": "문장 띄어 읽기 짝 활동",
          "type": "pair",
          "goal": "뜻이 드러나게 띄어 읽어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["어디서 쉬어 읽어?"],"watch":"뜻이 통하는 덩어리","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "왜 띄어 읽나요?",
  ...
  window.LESSONS["u5_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"지호가 드디어 줄넘기 열 번을 넘었대!\""},{"face":"👦","label":"두리 \"\"드디어 됐다!\" 하며 두 손을 번쩍 들었겠지? 얼마나 기쁠까!\""}],
        "tnote": {"ask":["자꾸 걸리던 줄넘기를 열 번 넘은 지호, 어떤 마음일까?"],"watch":"기쁨·뿌듯","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["무엇을 보고 인물의 마음을 알 수 있을까?","인물의 마음은 무엇으로 짐작해? 지호의 말과 행동은?"],"watch":"근거 들어 마음 짐작 · 말·행동","min":4},
          "title": "말·행동으로 마음 짐작",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"고개를 푹 숙이고 작게 미안해\"는 어떤 마음?"],"watch":"미안·부끄러움","min":4},
          "title": "이 말·행동은 어떤 마음? 💭",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["지호와 비슷한 경험이 있어? 그때 무슨 말과 행동을 했어?"],"watch":"경험","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 마음이 드러난 말·행동을 찾아 볼까?"],"watch":"찾기","min":5},
          "title": "인물의 마음을 짐작해요 ①",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 말한 경험은 어떤 마음이었어?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음이 드러난 것은?"],"watch":"말과 행동","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u5_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"소풍 날 아침인데 비가 와…\""},{"face":"👧","label":"하나 \"기다렸는데 얼마나 아쉽고 속상할까.\""}],
        "tnote": {"ask":["소풍 가는 날 비가 내려. 소풍을 기다리던 친구는 어떤 마음일까?"],"watch":"아쉬움·속상","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["나라면 어떤 마음이었을까?","마음은 상황으로도 짐작할 수 있어. 마음을 나타내는 말에는 무엇이 있어?"],"watch":"자신과 견주어 짐작 · 기쁘다·속상하다·설레다…","min":4},
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"내일 현장 체험을 가요\"는 어떤 마음 말? \"아끼던 물건을 잃어버렸어요\"는?"],"watch":"설레다·속상하다","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["내 마음을 마음 말로 표현해 볼까?"],"watch":"표현","min":5},
          "title": "마음을 말로 표현해요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 상황 카드를 뽑아 마음 말을 말해 볼까?"],"watch":"놀이","min":5},
          "title": "인물의 마음을 짐작해요 ②",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 말한 마음 말 중 새로 안 것은?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음은 무엇으로도 짐작해?"],"watch":"상황","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "해냈을 때는 어떤 마음일까요?",
  ...
  window.LESSONS["u5_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"전학 온 다은이는 처음엔 낯설고 떨렸대.\""},{"face":"👦","label":"두리 \"친구가 \"같이 놀자!\" 하면 마음이 바뀔 거야.\""}],
        "tnote": {"ask":["전학 온 다은이는 처음엔 낯설고 떨렸어. 시간이 지나면 마음이 어떻게 변할까?"],"watch":"반갑고 즐거움","min":3},
          "scene_title": "전학 온 첫날 🏫",
          "visual": "🏫",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["마음을 알면 어떻게 읽게 될까?","인물의 마음이 시간에 따라 변하는 까닭은?"],"watch":"마음 담아 읽기 · 일이 일어남","min":4},
          "title": "시간에 따라 변하는 마음",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"교실 문 앞에서 머뭇거리는 다은이\"는 어떤 마음? \"함께 웃으며 노는 다은이\"는?"],"watch":"떨림·즐거움","min":4},
          "title": "이 장면의 마음은? 💭",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["다은이의 마음이 어떻게 변했어? 장면마다 말해 볼까?"],"watch":"처음→나중","min":5},
          "title": "마음 변화를 말해요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 장면 세 개의 마음을 차례로 말해 볼까?"],"watch":"순서","min":5},
          "title": "마음을 짐작하며 글을 읽어요 ①",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝은 어느 장면에서 마음이 변했다고 봤어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
          "title": "마음 담아 읽기 짝 활동",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["인물의 마음은 무엇에 따라 변해?"],"watch":"시간","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소풍이 미뤄지면 어떤 마음일까요?",
  ...
  window.LESSONS["u5_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"아기 여우가 혼자 놀고 있었어.\""},{"face":"👧","label":"하나 \"토끼가 \"같이 놀래?\" 하니까 눈이 반짝!\""}],
        "tnote": {"ask":["혼자 놀던 아기 여우에게 토끼가 다가왔어. 마음이 어떻게 변할까?"],"watch":"외로움→반가움","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["내 경험과 이으면 마음이 더 잘 보일까?","글을 읽을 때 마음을 짐작하려면 무엇을 살펴?"],"watch":"경험 이어 마음 읽기 · 말·행동·상황","min":4},
          "title": "마음을 짐작하며 읽기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"정말? 나랑?\" 하며 눈이 반짝이는 것은 어떤 마음?"],"watch":"설렘","min":4},
          "title": "마음이 드러난 부분은? 💭",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["아기 여우의 마음을 짐작해 볼까? 어느 부분에서 알았어?"],"watch":"근거","min":5},
          "title": "인물의 마음을 나눠요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 마음이 드러난 부분을 찾아 밑줄 그어 볼까?"],"watch":"찾기","min":5},
          "title": "마음을 짐작하며 글을 읽어요 ②",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 찾은 부분은 나와 같았어?"],"watch":"비교","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음이 드러난 부분은 무엇으로 알아?"],"watch":"말·행동·상황","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "칭찬을 들으면 어떤 마음일까요?",
  ...
  window.LESSONS["u5_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"걸음? 거름? 소리가 똑같은데…\""},{"face":"👦","label":"두리 \"걸음은 걷는 거고, 거름은 식물 키우는 흙이야!\""}],
        "tnote": {"ask":["\"걸음\"과 \"거름\"은 소리가 비슷해. 뜻은 어떻게 달라?"],"watch":"걷기·흙","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["비슷해 보여도 뜻이 다른 낱말이 있을까?","소리가 비슷한 낱말을 어떻게 골라 써야 해?"],"watch":"헷갈리는 낱말 구별(가르치다/가리키다·다르다/틀리다) · 문장의 뜻","min":4},
          "title": "헷갈리기 쉬운 낱말",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"텃밭에 ( )을 주었다\"에 알맞은 낱말은? \"한 ( )씩 걸었다\"는?"],"watch":"거름·걸음","min":4},
          "title": "문장에 알맞은 낱말은? ✅",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["바르게 따라 쓸 때 뜻을 생각하며 썼어?"],"watch":"점검","min":5},
          "title": "바르게 따라 써요 ✍️",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 문장에 알맞은 낱말을 골라 볼까?"],"watch":"고르기","min":5},
          "title": "헷갈리기 쉬운 낱말에 주의해요 ①",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["헷갈리는 낱말은 무엇으로 구분해?"],"watch":"뜻","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "'가르치다'의 뜻은?",
  ...
  window.LESSONS["u5_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"다치다? 닫히다? 반듯이? 반드시?\""},{"face":"👧","label":"하나 \"뜻을 알면 헷갈리지 않아. 다치다는 몸이 상하는 거!\""}],
        "tnote": {"ask":["\"다치다\"와 \"닫히다\", \"반듯이\"와 \"반드시\" — 어떻게 구분할까?"],"watch":"뜻","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["소리가 비슷하면 어떻게 구별할까?","\"반듯이\"와 \"반드시\"의 뜻은 각각?"],"watch":"헷갈리는 낱말 구별(바라다/바래다·잊다/잃다) · 곧게·꼭","min":4},
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"넘어져 무릎을 상한 일\"은 어느 낱말? \"꼭 약속을 지키겠다\"는?"],"watch":"다치다·반드시","min":4},
          "title": "바르게 쓴 문장은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["헷갈리기 쉬운 낱말로 문장을 만들어 볼까?"],"watch":"문장","min":5},
          "title": "낱말을 넣어 문장을 써요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 낱말 카드를 뽑아 뜻에 맞는 문장을 말해 볼까?"],"watch":"놀이","min":5},
          "title": "헷갈리기 쉬운 낱말에 주의해요 ②",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 만든 문장에서 낱말이 바르게 쓰였어?"],"watch":"점검","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["\"닫히다\"는 무슨 뜻?"],"watch":"문이 닫힘","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "'바라다'의 뜻은?",
  ...
  window.LESSONS["u5_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"작은/새가/나뭇/가지에/앉았다… 뚝뚝 끊으니 어색해.\""},{"face":"👦","label":"두리 \"작은 새가 / 나뭇가지에 / 앉았다 — 이게 자연스럽지!\""}],
        "tnote": {"ask":["낱말마다 뚝뚝 끊어 읽으면 어색해. 어떻게 읽으면 물 흐르듯 자연스러울까?"],"watch":"의미 덩어리","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["어디에서 쉬어 읽어야 자연스러울까?","너무 자주 끊으면? 안 끊으면?"],"watch":"의미 단위 띄어 읽기 · 어색·숨참","min":4},
          "title": "의미 단위로 자연스럽게",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"비가 와서 우산을 썼다\"를 자연스럽게 읽으면?"],"watch":"비가 와서/우산을 썼다","min":4},
          "title": "더 자연스러운 읽기는? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["글을 자연스럽게 띄어 읽어 볼까?"],"watch":"읽기","min":5},
          "title": "자연스럽게 읽어 봐요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 같은 글을 읽고 더 자연스러운 쪽을 골라 볼까?"],"watch":"비교","min":5},
          "title": "자연스럽게 띄어 읽어요 ①",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 읽기에서 어색한 곳이 있었어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
          "title": "빗금 긋고 읽기 짝 활동",
          "type": "pair",
          "goal": "알맞은 곳에서 띄어 읽어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["자연스럽게 읽으려면 어떻게 쉬어?"],"watch":"의미가 통하는 덩어리","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "자연스럽게 띄어 읽으려면?",
  ...
  window.LESSONS["u5_l10"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"기쁜 장면은 밝게!\""},{"face":"👧","label":"하나 \"슬픈 장면은 차분하게… 마음을 담으면 글이 살아나.\""}],
        "tnote": {"ask":["인물이 기쁠 땐 밝게, 슬플 땐 차분하게 읽으면 글이 어떻게 돼?"],"watch":"살아남","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["띄어 읽기와 마음을 함께 살리면 어떨까?","자연스럽게 띄어 읽으면서 무엇도 살려 읽어?"],"watch":"띄어 읽기+마음 함께 · 마음","min":4},
          "title": "마음을 살려 읽기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["기쁜 장면과 슬픈 장면, 목소리를 어떻게 바꿀까?"],"watch":"밝게·차분하게","min":4},
          "title": "자연스럽게 읽는 방법은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["마음을 담아 읽어 볼까? 듣는 친구는 마음을 맞혀 볼까?"],"watch":"맞히기","min":5},
          "title": "마음을 담아 읽어요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 같은 장면을 다른 마음으로 읽어 볼까?"],"watch":"비교","min":5},
          "title": "자연스럽게 띄어 읽어요 ②",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 낭독에서 마음이 잘 느껴진 부분은?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음을 담아 읽으면 듣는 사람은?"],"watch":"잘 느낌","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "띄어 읽기와 마음을 함께 살리면?",
  ...
  window.LESSONS["u5_l11"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"기쁘다, 속상하다, 설레다, 뿌듯하다…\""},{"face":"👦","label":"두리 \"마음 말을 모아 사전을 만들자! 상황도 같이 적고.\""}],
        "tnote": {"ask":["마음을 나타내는 말을 모으면 무엇이 좋을까?"],"watch":"표현","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["마음을 말로 전하면 무엇이 달라질까?","마음 사전에는 무엇과 무엇을 적어?"],"watch":"마음 나타내는 말 쓰기 · 마음 말·상황","min":4},
          "title": "마음 사전 만들기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"오랫동안 기다린 일이 이루어졌어요\"는 어떤 마음 말?"],"watch":"뿌듯·기쁨","min":4},
          "title": "이 상황의 마음 말은? 💭",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["마음 사전을 만들어 볼까? 몇 개의 마음 말을 적었어?"],"watch":"개수","min":5},
          "title": "마음 사전을 만들어요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 마음 말을 주고받으며 상황을 말해 볼까?"],"watch":"놀이","min":5},
          "title": "마음을 나타내는 말을 써요 ① (실천)",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 사전에서 내게 없던 마음 말은?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음 말을 많이 알면?"],"watch":"마음을 잘 표현","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "마음을 나타내는 말에는?",
  ...
  window.LESSONS["u5_l12"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"기분 나빠!\""},{"face":"👧","label":"하나 \"\"네 말에 서운했어\"라고 하면 마음이 더 잘 전해져.\""}],
        "tnote": {"ask":["\"기분 나빠\"보다 \"네 말에 서운했어\"가 왜 마음이 더 잘 전해질까?"],"watch":"정확한 마음 말","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["글로 마음을 전하면 어떤 점이 좋을까?","마음 말로 표현하면 상대는? 친구의 마음 말을 들으면 나는?"],"watch":"마음 담은 글 쓰기·전하기 · 이해·배려","min":4},
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["친구가 도와줬을 때 어떤 마음 말을 쓸까? 약속을 어겼을 때는?"],"watch":"고마웠어·서운했어","min":4},
          "title": "마음을 잘 전하는 말은? 💬",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["마음을 나눠 볼까? 짝의 마음 말을 듣고 어떻게 답했어?"],"watch":"헤아리기","min":5},
          "title": "마음을 나눠요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 상황을 정해 마음 말로 대화해 볼까?"],"watch":"대화","min":5},
          "title": "마음을 나타내는 말을 써요 ② (실천)",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 말한 마음을 듣고 무엇을 느꼈어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음 말로 표현하면?"],"watch":"상대가 잘 이해","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "쪽지에 마음을 담으려면?",
  ...
  window.LESSONS["u5_l13"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"마음 짐작, 헷갈리는 낱말, 띄어 읽기…\""},{"face":"👦","label":"두리 \"난 마음 사전 만든 게 제일 기억나!\""}],
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["무엇을 새로 알게 되었나?","마음 짐작·낱말 구분·띄어 읽기를 한 문장씩으로 말해 볼까?"],"watch":"단원 자기 점검 · 정리","min":4},
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"한 ( )씩 걸었다\"에 알맞은 말은? 마음은 무엇으로 짐작해?"],"watch":"걸음·말행동상황","min":4},
          "title": "배운 것을 확인해요 ✅",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["문장은 어떻게 띄어 읽어?"],"watch":"의미 덩어리로","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "마음은 무엇으로 짐작하나요?",
  ...
  window.LESSONS["u5_l14"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"오늘 속상했어…\""},{"face":"👧","label":"하나 \"속상했겠다. 무슨 일 있었어?\""}],
        "tnote": {"ask":["친구가 \"오늘 속상했어\" 하면 뭐라고 대꾸하면 마음이 풀릴까?"],"watch":"속상했겠다","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["긴 문장은 어떻게 나눠 읽을까?","마음을 헤아린 맞장구가 왜 친구를 위로할까?"],"watch":"띄어 읽기 다지기 · 알아줌","min":4},
          "title": "마음을 헤아린 맞장구",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"강아지가 아파\" 하면? \"상을 받았어!\" 하면?"],"watch":"걱정되겠다·정말 기쁘겠다","min":4},
          "title": "알맞은 맞장구는? 💬",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["글씨를 바르게 쓰며 맞장구 문장을 적어 볼까?"],"watch":"또박또박","min":5},
          "title": "글씨를 바르게 써요 ✍️",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짝과 마음 말·맞장구를 주고받아 볼까?"],"watch":"놀이","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝의 맞장구를 들으니 어땠어?"],"watch":"느낌","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["마음을 헤아린 맞장구는 친구를?"],"watch":"위로·기쁘게","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "긴 문장은 어떻게 읽나요?",
