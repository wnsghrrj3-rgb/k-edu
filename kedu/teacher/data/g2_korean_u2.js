  ...
  window.LESSONS["u2_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"\"비\"로 시작하는 낱말… 비행기!\""},{"face":"👦","label":"두리 \"비누! 비빔밥! 낱말로도 놀 수 있네!\""}],
        "tnote": {"ask":["\"비\"로 시작하는 낱말, 무엇이 떠올라? 몇 개까지 말할 수 있을까?"],"watch":"비행기·비누·비빔밥·비둘기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["낱말로 어떻게 놀 수 있을까?","같은 첫 글자 모으기와 낱말 이어 가기, 둘 다 무엇이 있어야 놀이가 돼?"],"watch":"말놀이에 대한 흥미 열기 · 규칙","min":4},
          "title": "말로 노는 재미",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"손을 씻을 때 쓰는 것\" — \"비\"로 시작하는 게 뭘까?"],"watch":"비누","min":4},
          "title": "'비'로 시작하는 낱말은? 🤔",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["알고 있는 말놀이가 있어? 어떻게 하는 거야?"],"watch":"끝말잇기·수수께끼","min":5},
          "title": "말놀이를 떠올려요",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["\"비\"로 시작하는 낱말을 짝과 번갈아 말해 볼까? 누가 더 오래 이어?"],"watch":"규칙 안에서","min":5},
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["짝 활동에서 새로 안 낱말이 있었어?"],"watch":"낱말 늘리기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["말놀이의 재미는 어디서 올까?"],"watch":"규칙 안에서 낱말 떠올리기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "낱말로 무엇을 할 수 있나요?",
  ...
  window.LESSONS["u2_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"오늘 비는 가늘게 조용히 내려.\""},{"face":"👦","label":"두리 \"이런 비를 이슬비라고 한대! 비 이름이 여러 개래.\""}],
        "tnote": {"ask":["비에 여러 이름이 있다는 걸 알고 있었어? 어떤 이름을 들어 봤어?"],"watch":"소나기·장맛비","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["비에 왜 여러 이름이 있을까?","이슬비·가랑비·단비·소나기는 무엇에 따라 이름이 달라?"],"watch":"어휘의 다양함 느끼기 · 내리는 모습","min":4},
          "title": "비의 여러 이름",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"갑자기 굵게 쏟아지다 그쳐요\" — 이 비의 이름은?"],"watch":"소나기","min":4},
          "title": "이 비의 이름은? 🌧️",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["비 이름으로 짧은 말을 만들어 볼까? \"가랑비에 옷 젖듯…\""],"watch":"표현","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"가랑비\"를 읽고 어떤 비인지 말해 볼까?"],"watch":"가늘게","min":5},
          "title": "비의 여러 이름 놀이",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝은 어떤 비 이름을 썼어? 나와 같았어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
          "title": "비 이름 잇기 짝 활동",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["비 이름을 알면 무엇이 좋아?"],"watch":"더 자세히 말함","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "비에는 이름이 몇 가지인가요?",
  ...
  window.LESSONS["u2_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"안녕하세요, 다섯 글자!\""},{"face":"👧","label":"하나 \"고맙습니다도 다섯 글자야! 원숭이 엉덩이는 빨개~\""}],
        "tnote": {"ask":["\"안녕하세요\"처럼 다섯 글자인 말을 또 떠올릴 수 있어?"],"watch":"고맙습니다·미안합니다","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["말놀이에는 어떤 규칙이 있을까?","꼬리따기는 무엇을 받아 이어? \"원숭이 엉덩이는 빨개\" 다음은?"],"watch":"규칙 있는 말놀이 익히기 · 빨가면 사과","min":4},
          "title": "꼬리따기 말놀이",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"높은 것은 하늘 → 하늘은 ( )\" 무엇으로 이을까?"],"watch":"파래·넓어","min":4},
          "title": "꼬리따기로 이어 봐요 🔗",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["짝과 꼬리따기를 몇 번까지 이었어? 막히면 어떻게 했어?"],"watch":"규칙","min":5},
          "title": "짝과 말놀이를 해요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"안녕하세요\"를 또박또박 읽고 글자 수를 세어 볼까?"],"watch":"5","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["다섯 글자 말놀이에서 짝이 만든 말은?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
          "title": "꼬리따기 잇기 짝 놀이",
          "type": "pair",
          "goal": "규칙대로 말을 이어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["꼬리따기는 무엇을 이어?"],"watch":"앞말의 끝","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "다섯 글자 말놀이는 몇 글자로?",
  ...
  window.LESSONS["u2_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"무엇이 무엇이 똑같을까?\""},{"face":"👦","label":"두리 \"젓가락 두 짝이 똑같지! 시장에 가면 사과도 있고…\""}],
        "tnote": {"ask":["\"무엇이 무엇이 똑같을까?\"에 뭐라고 답해? 어떤 말놀이일까?"],"watch":"주고받기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["주고받는 말놀이는 왜 재미있을까?","주고받는 말놀이와 말 덧붙이기는 무엇이 달라?"],"watch":"문답·누적형 말놀이 · 묻고 답하기 vs 한 가지씩 더하기","min":4},
          "title": "주고받기·말 덧붙이기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"시장에 가면 무엇이 있을까?\"에 알맞은 답은?"],"watch":"~도 있고","min":4},
          "title": "주고받는 말, 알맞은 답은? 💬",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["모둠 말 덧붙이기에서 몇 개까지 이었어? 앞말을 다 기억했어?"],"watch":"잘 듣기","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"무엇이 무엇이 똑같을까?\"에 어떻게 답할까?"],"watch":"~하고 ~이 똑같지","min":5},
          "title": "주고받기·말 덧붙이기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝과 주고받기에서 내가 낸 물음은?"],"watch":"되짚기","min":5},
          "tag": "👋 짝 활동",
          "title": "말 덧붙이기 짝 놀이",
          "type": "pair",
          "goal": "앞말에 덧붙여 이어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["함께 하면 무엇이 좋아?"],"watch":"더 재미있음","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "주고받는 말놀이는 어떻게 하나요?",
  ...
  window.LESSONS["u2_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"말놀이 하니까 낱말을 많이 알게 됐어!\""},{"face":"👧","label":"하나 \"규칙을 지키니까 다 같이 재미있었지.\""}],
        "tnote": {"ask":["여러 말놀이를 해 봤어. 말놀이를 하면 무엇이 좋을까?"],"watch":"낱말·즐거움","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["말놀이를 즐겁게 하려면 무엇이 필요할까?","말놀이마다 규칙이 있는 까닭은?"],"watch":"규칙·태도 정리 · 모두 즐겁게","min":4},
          "title": "말놀이의 좋은 점·규칙",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["친구가 막혔을 때 어떻게 하는 게 규칙을 지킨 모습일까?"],"watch":"기다리거나 도와주기","min":4},
          "title": "규칙을 지킨 모습은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["가장 좋아하는 말놀이는? 왜?"],"watch":"까닭","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"차례를 지켜 말놀이를 합니다\"는 바른 모습이야?"],"watch":"판단","min":5},
          "title": "말놀이 좋은 점과 규칙",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 말한 규칙과 내 규칙이 같았어?"],"watch":"나누기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["규칙을 지키면 어떻게 돼?"],"watch":"모두 즐거움","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "말놀이를 하면 무엇이 좋나요?",
  ...
  window.LESSONS["u2_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"칠판, 창문, 시계… 교실에 낱말이 가득해!\""},{"face":"👦","label":"두리 \"\"칠판이 깨끗하다\" — 낱말에 말을 더하니 문장이 됐어!\""}],
        "tnote": {"ask":["교실을 둘러보면 어떤 낱말이 보여? 그 낱말로 문장을 만들 수 있을까?"],"watch":"무엇이 어찌하다","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["주변에서 어떤 낱말을 찾을 수 있을까?","\"칠판\"이 \"칠판이 깨끗하다\"가 되려면 무엇을 더해?"],"watch":"낱말→문장 확장 · 어찌하다","min":4},
          "title": "낱말로 문장 만들기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"창문\"으로 만든 문장은 어느 카드야? 다른 문장도 만들어 볼까?"],"watch":"창문이 열렸다","min":4},
          "title": "낱말로 만든 문장은? ✍️",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["주변 낱말로 문장을 만들어 볼까? 낱말 하나에 문장 몇 개?"],"watch":"여러 문장","min":5},
          "title": "문장을 만들어 나눠요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"창문\"이 든 문장을 읽어 볼까?"],"watch":"읽기","min":5},
          "title": "낱말을 찾아 문장 만들기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 만든 문장 중 재미있는 것은?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
          "title": "낱말 찾아 문장 짝 활동",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["문장은 무엇으로 만들지?"],"watch":"낱말","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "문장은 무엇으로 만드나요?",
  ...
  window.LESSONS["u2_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"토끼가 숲으로 갔어요.\""},{"face":"👧","label":"하나 \"거기서 다람쥐를 만났어요! 다음은 네 차례!\""}],
        "tnote": {"ask":["한 사람이 한 문장씩 이으면 긴 이야기가 돼. 어떻게 이으면 자연스러울까?"],"watch":"앞 내용 듣고 흐름 맞추기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["문장을 자연스럽게 이으려면?","앞 문장을 잘 듣지 않으면 이야기가 어떻게 될까?"],"watch":"문장 이어 쓰기·협동 · 엉뚱해짐","min":4},
          "title": "줄줄이 이야기 만들기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"토끼가 숲으로 갔어요\" 다음에 어색한 문장은 왜 어색할까?"],"watch":"흐름 안 맞음","min":4},
          "title": "자연스럽게 이은 문장은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["모둠 줄줄이 이야기에서 가장 재미있던 문장은?"],"watch":"나누기","min":5},
          "title": "모둠 줄줄이 이야기 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"그래서·그리고\"는 문장을 어떻게 이어 줘?"],"watch":"이음말","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝과 이은 이야기의 끝은 어떻게 됐어?"],"watch":"결말","min":5},
          "tag": "👋 짝 활동",
          "title": "줄줄이 이야기 짝 놀이",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["이어 만들면 무엇이 되지?"],"watch":"긴 이야기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "줄줄이 이야기는 어떻게 만드나요?",
  ...
  window.LESSONS["u2_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"\"펄쩍펄쩍 깡충깡충\" 이 부분 너무 웃겨!\""},{"face":"👦","label":"두리 \"난 \"하늘에서 사탕이 내렸어요\"가 제일 신기했어.\""}],
        "tnote": {"ask":["글을 읽다 \"이 부분 재미있다!\" 싶었던 곳이 있어? 어떤 부분?"],"watch":"문장·장면","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["어떤 부분이 왜 재미있었을까?","재미있는 부분이 사람마다 다른 까닭은?"],"watch":"감상의 근거 말하기 · 느낌이 다름","min":4},
          "title": "재미있는 부분 찾기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"꼬불꼬불 미끄럼틀\"이 재미있는 까닭은 무엇일까?"],"watch":"소리·모습 흉내","min":4},
          "title": "왜 재미있을까요? 🤔",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["글에서 어떤 부분이 재미있었어? 왜?"],"watch":"까닭","min":5},
          "title": "생각·느낌을 나눠요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짧은 글에서 재미있는 문장을 찾아 손가락으로 짚어 볼까?"],"watch":"찾기","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 고른 재미있는 부분은 나와 같았어?"],"watch":"다름","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["재미있는 부분은 사람마다?"],"watch":"다를 수 있음","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "글을 읽으며 무엇을 찾나요?",
  ...
  window.LESSONS["u2_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"가운데에 \"토끼\" 제목을 쓰고…\""},{"face":"👧","label":"하나 \"가지에 재미있던 점, 슬펐던 점, 궁금한 점!\""}],
        "tnote": {"ask":["가운데에 제목을 쓰고 생각을 가지로 이으면 뭐가 좋을까?"],"watch":"한눈에","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["이 글을 읽고 어떤 생각이 떠올랐을까?","생각그물의 가지에는 어떤 생각을 쓸 수 있어?"],"watch":"생각그물로 감상 조직 · 재미·느낌·궁금","min":4},
          "title": "생각그물 만들기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"토끼는 왜 혼자 살았을까?\"는 어떤 가지에 넣을까?"],"watch":"궁금한 점","min":4},
          "title": "이건 어떤 가지일까요? 🕸️",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["생각그물을 펼쳐 볼까? 가지를 몇 개나 그렸어?"],"watch":"가지 수","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["생각그물 가운데에는 무엇을 쓰지?"],"watch":"중심 낱말","min":5},
          "title": "생각그물로 느낌 표현하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝의 생각그물에서 내 것과 다른 가지는?"],"watch":"비교","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["가지에는 무엇을 쓰지?"],"watch":"떠오른 생각","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "생각그물은 무엇을 하나요?",
  ...
  window.LESSONS["u2_l10"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"이 문장 마음에 쏙 들어!\""},{"face":"👦","label":"두리 \"책갈피에 옮겨 쓰고 왜 좋은지도 적어 보자.\""}],
        "tnote": {"ask":["마음에 쏙 드는 문장을 만난 적 있어? 책갈피에 담으면 어떨까?"],"watch":"좋아하는 문장","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["마음에 든 문장은 어떤 것이었을까?","책갈피에 문장을 옮겨 쓸 때 무엇을 더하면 멋져질까?"],"watch":"문장 감상·선택 · 까닭·그림","min":4},
          "title": "좋아하는 문장과 책갈피",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["책갈피의 가장 중요한 내용은? 그림은 왜 넣을까?"],"watch":"문장·꾸밈","min":4},
          "title": "책갈피에 담을 내용은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["어떤 문장으로 책갈피를 만들 거야? 왜 그 문장이야?"],"watch":"까닭","min":5},
          "title": "책갈피를 만들어요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["마음에 드는 문장을 소리 내어 읽어 볼까?"],"watch":"읽기","min":5},
          "title": "좋아하는 문장과 책갈피",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝의 책갈피 문장은 어떤 문장이었어?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
          "title": "책갈피 만들기 짝 활동",
          "type": "pair",
          "goal": "좋아하는 문장을 담아요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["책갈피에 무엇을 담지?"],"watch":"좋아하는 문장","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "책갈피에 무엇을 담나요?",
  ...
  window.LESSONS["u2_l11"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"제가 좋아하는 문장은 \"달이 웃었어요\"입니다.\""},{"face":"👧","label":"하나 \"나도 그 문장 좋다! 왜 좋아?\""}],
        "tnote": {"ask":["어떻게 소개하면 친구도 그 문장을 좋아하게 될까?"],"watch":"또박또박·까닭","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["친구가 그 문장을 좋아하게 하려면 어떻게 소개할까?","소개할 때 까닭을 말하는 까닭은?"],"watch":"소개·경청 태도 · 마음이 전해짐","min":4},
          "title": "문장 소개하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["친구 문장이 좋을 때 어떤 반응을 할까?"],"watch":"\"나도 좋다\"","min":4},
          "title": "바른 소개 모습은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["책갈피로 좋아하는 문장을 소개해 볼까? 듣는 친구는?"],"watch":"반응","min":5},
          "title": "좋아하는 문장을 소개해요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["소개할 때 목소리는 어떻게?"],"watch":"또렷하게","min":5},
          "title": "좋아하는 문장 소개하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["\"제가 좋아하는 문장은 ~입니다\"로 말해 볼까?"],"watch":"표현","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["소개 뒤에는 무엇을 해 줘?"],"watch":"좋았던 점","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소개할 때 자세는?",
  ...
  window.LESSONS["u2_l12"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"국수 파는 식당 이름… 호로록 국수집!\""},{"face":"👦","label":"두리 \"보글보글 찌개집은 어때? 이름이 재미있어야 기억에 남아!\""}],
        "tnote": {"ask":["식당을 연다면 어떤 재미있는 이름을 지어 줄까?"],"watch":"흉내말·느낌","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["어떤 이름이 재미있고 잘 어울릴까?","\"호로록 국수집\"은 왜 재미있고 기억에 남을까?"],"watch":"말의 재미로 창작 · 소리 흉내","min":4},
          "title": "재미있게 이름 짓기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["빵 가게 이름은 뭐라고 지을까? 카드 중 어느 것?"],"watch":"폭신폭신 빵집","min":4},
          "title": "재미있는 이름은? 🏪",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["나만의 가게 이름을 지어 볼까? 무엇을 파는 곳인지 알 수 있어?"],"watch":"뜻+재미","min":5},
          "title": "나만의 이름을 지어요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"방긋방긋 김밥집\"을 읽고 어떤 느낌이 들어?"],"watch":"느낌","min":5},
          "title": "재미있게 이름 짓기 놀이",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 지은 이름과 까닭은?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
          "title": "이름 짓기 짝 놀이",
          "type": "pair",
          "goal": "재미있는 이름을 지어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["이름을 지을 때 무엇을 넣으면 재미있어?"],"watch":"소리·뜻의 재미","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u2_l13"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"모둠끼리 말놀이 한마당이야!\""},{"face":"👧","label":"하나 \"이기는 것보다 다 같이 즐기는 게 제일이야.\""}],
        "tnote": {"ask":["모둠이 다 같이 재미있게 하려면 어떤 약속이 필요할까?"],"watch":"차례·듣기·돕기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["모두 재미있게 놀려면 어떤 약속이 필요할까?","이기는 것보다 함께 즐기는 것이 왜 중요할까?"],"watch":"협동·규칙 준수 종합 · 모두의 재미","min":4},
          "title": "모둠 말놀이 약속",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["친구가 막혔을 때 카드처럼 어떻게 할까?"],"watch":"도와주기","min":4},
          "title": "모둠 말놀이, 바른 모습은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["말놀이 한마당에서 어떤 놀이를 골랐어? 약속을 지켰어?"],"watch":"자기 점검","min":5},
          "title": "모둠 말놀이 한마당 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"차례를 지켜 함께 놀이합니다\"는 바른 약속이야?"],"watch":"판단","min":5},
          "title": "모둠 말놀이 한마당",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["모둠에 제안한 말놀이는?"],"watch":"제안","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["함께 놀 때 필요한 것은?"],"watch":"약속·차례","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "함께 놀 때 필요한 것은?",
  ...
  window.LESSONS["u2_l14"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"말놀이, 이야기 만들기, 책갈피… 다 재미있었어!\""},{"face":"👦","label":"두리 \"난 줄줄이 이야기가 제일 기억나.\""}],
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["이 단원에서 가장 재미있던 것은 무엇일까?","말의 재미와 글 읽고 나누기, 둘을 한 문장으로 말해 볼까?"],"watch":"단원 자기점검 · 정리","min":4},
          "title": "말놀이·감상 정리",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"말놀이에는 규칙이 있습니다\"는 바른 문장이야?"],"watch":"판단","min":5},
          "title": "단원을 돌아보며 확인하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 기억에 남는다고 한 말놀이는?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["글에서 무엇을 찾았지?"],"watch":"재미있는 부분","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "말놀이에 필요한 것은?",
  ...
  window.LESSONS["u2_l15"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"사과 → 과자 → 자전거 → 거…\""},{"face":"👧","label":"하나 \"거울! 끝 글자로 이어 가는 거야.\""}],
        "tnote": {"ask":["끝말잇기, 어디까지 이을 수 있을까? \"사과\" 다음은?"],"watch":"과자·과일","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["끝말잇기를 오래 이으려면?","끝말잇기는 앞 낱말의 무엇으로 시작해? 배운 낱말로 하면 뭐가 좋아?"],"watch":"끝말잇기·바른 글씨 마무리 · 끝 글자·복습","min":4},
          "title": "끝말잇기로 정리해요",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"바다 → ( )\" 무엇으로 이을까? \"구름\"은?"],"watch":"다람쥐·름…","min":4},
          "title": "끝말을 이어 봐요 🔗",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["글씨를 바르게 쓰며 끝말잇기 낱말을 적어 볼까?"],"watch":"또박또박","min":5},
          "title": "글씨를 바르게 써요 ✍️",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"사과→과자→자전거\"를 이어 읽어 볼까?"],"watch":"읽기","min":5},
          "title": "끝말잇기로 정리하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝과 끝말잇기 세 번, 무슨 낱말이 나왔어?"],"watch":"되짚기","min":5},
          "tag": "👋 짝 활동",
          "title": "끝말잇기 짝 놀이",
          "type": "pair",
          "goal": "끝 글자로 낱말을 이어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["\"과자\" 다음에 올 낱말은 무엇으로 시작해?"],"watch":"자","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "끝말잇기는 무엇을 이어요?",
