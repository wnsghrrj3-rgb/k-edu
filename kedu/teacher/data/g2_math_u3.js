  ...
  window.LESSONS["u3_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "data": {
          ...
          "items": [
            { "q": "18 + 5 = ?", "a": "23" },
            { "q": "25 + 7 = ?", "a": "32" },
            { "q": "일의 자리가 10을 넘으면 어떻게 하나요?", "a": "십의 자리로 1을 받아올림해요" }
          ]
        },
        "tnote": {
          "ask": ["18 더하기 5를 머릿속으로 어떻게 계산했나요?", "받아올림이 뭐였는지 짝에게 한 문장으로 말해 볼까요?"],
      ...
      },
      {
        ...
        "tnote": {
          "ask": ["곰이와 펭이의 도토리를 어떻게 하면 한 번에 셀 수 있을까요?", "28과 19를 그냥 세면 어떤 점이 힘들까요?"],
      ...
      },
      {
        ...
        "tnote": {
          "ask": ["왜 십은 십끼리, 일은 일끼리 더할까요?", "8+9는 왜 그냥 두지 않고 30에 더할까요?"],
      ...
      },
      {
        ...
        "tnote": {
          "ask": ["받아올림한 1을 어디에 적어 두면 잊지 않을까요?", "이 실수를 한 친구에게 뭐라고 말해 주면 좋을까요?"],
      ...
      },
      {
        ...
        "data": {
          ...
          "levels": {
            "기본": { "q": "곰이가 34개, 펭이가 28개를 모았어요. 모두 몇 개일까요?", "a": "62개", "steps": ["일: 4+8=12 (2쓰고 1올림)", "십: 3+2+1=6", "→ 62"] },
            "도전": { "q": "곰이가 47개, 펭이가 39개를 모았어요. 모두 몇 개일까요?", "a": "86개", "steps": ["일: 7+9=16", "십: 4+3+1=8", "→ 86"] },
            "심화": { "q": "곰이와 펭이의 도토리를 합쳐서 딱 60개가 되게 하려면, 각자 몇 개씩 모았을 수 있을까요?", "a": "여러 답 (예: 28+32, 41+19, 15+45 …)", "open": true }
          },
          "note": "기본=오늘 배운 자리별 받아올림 / 도전=수치 확장 / 심화=거꾸로 생각하기(정답 여러 개)."
        },
        "tnote": {
          "ask": ["기본을 푼 친구는 도전에서 무엇이 달라졌나요?", "심화에서 답을 하나 찾았다면, 또 다른 답도 있을까요?"],
      ...
      },
      {
        ...
        "data": {
          "title": "문구점 계산대 🛒",
          "levels": {
            "기본": { "q": "지우개 45원과 연필 17원을 샀어요. 모두 얼마일까요?", "a": "62원", "steps": ["45+17", "→ 62원"] },
            "도전": { "q": "공책 38원과 색연필 26원을 샀어요. 모두 얼마일까요?", "a": "64원", "steps": ["38+26", "→ 64원"] },
            "심화": { "q": "70원짜리와 다른 물건을 사서 값을 만들려고 해요. 받아올림이 생기는 두 물건 값을 정해 볼까요?", "a": "여러 답 (예: 48+26, 35+27 …)", "open": true }
          }
        },
        "tnote": {
          "ask": ["돈으로 바꿔 생각하니 계산이 더 쉬운가요, 어려운가요?", "'받아올림이 생기게'라는 조건은 무슨 뜻일까요?"],
      ...
      },
      {
        ...
        "tnote": {
          "ask": ["짝의 계산에서 받아올림이 생긴 자리는 어디였나요?", "두 수를 어떻게 정하면 꼭 받아올림이 생길까요?"],
      ...
      },
      {
        ...
        "data": {
          ...
          "items": [
            { "q": "28 + 19 = ?", "a": "47" },
            { "q": "45 + 17 = ?", "a": "62" },
            { "q": "일의 자리 합이 10을 넘으면?", "a": "십의 자리로 1을 받아올림" }
          ],
          "self": ["오늘 내용을 설명할 수 있어요", "조금 헷갈려요", "다시 배우고 싶어요"]
        },
        "tnote": {
          "ask": ["세 문제 중 가장 자신 있는 건 무엇인가요?", "신호등에서 노랑·빨강을 든 친구는 어느 부분이 헷갈렸나요?"],
      ...
      },
      {
        ...
        "tnote": {
          "ask": ["곰이와 펭이의 도토리를 이제 한 번에 셀 수 있게 됐나요?", "오늘 배운 걸 집에서 어디에 써 볼 수 있을까요?"],
