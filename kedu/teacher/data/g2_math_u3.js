  ...
  window.LESSONS["u3_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"북극 얼음이 자꾸 녹아…\""},{"face":"🐧","label":"펭이 \"남극 바다엔 쓰레기가 늘었어. 수학으로 도울 수 있을까?\""}],
        "tnote": {"ask":["모으는 건 덧셈일까 뺄셈일까?","덜어내면 어느 쪽일까?","곰이와 펭이를 수학으로 어떻게 도울 수 있을까? 모으는 건 덧셈일까 뺄셈일까?"],"watch":"상황을 식으로 옮기게 — 모으기＝＋, 덜기＝－ · 쓰레기 줍기·물고기 세기 — 모으면 덧셈, 덜면 뺄셈","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["물고기 13마리에 5마리를 더 잡으면? 모으는 그림을 보고 식으로 말해 볼까?"],"watch":"13+5=18","min":4},
          "title": "모으면 덧셈",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["펭귄 16마리 중 4마리가 떠나면? 덜어 내는 그림은 어느 쪽?"],"watch":"16-4=12","min":4},
          "title": "덜어 내면 뺄셈",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["13+5는 받아올림이 필요해? 일의 자리만 더하면 어때?"],"watch":"3+5=8 — 십은 그대로","min":3},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["16-4를 할 때 십의 자리는 어떻게 돼?"],"watch":"그대로 1","min":3},
          "title": "기본 ② 덜어내기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["24+13은 십은 십끼리, 일은 일끼리? 어떻게 되는지 말해 볼까?"],"watch":"20+10·4+3 → 37","min":4},
          "title": "기본 ③ 두 자리 더하기",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["물고기 20마리를 두 통에 나누는 방법, 짝과 다르게 말해 볼까?"],"watch":"10+10·12+8·15+5 …","min":5},
          "title": "물고기 세기",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["이 그림은 모으기 이야기야, 덜어내기 이야기야? 식으로 말해 볼까?"],"watch":"모으기 — 합 17","min":4},
          "title": "물고기 이야기",
          "scenario": {
            "icon": "🐟",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["오늘 세 문제 중 뺄셈은 어느 것? 어떻게 알았어?"],"watch":"16-4 — 덜어냄","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "13+5는?",
  ...
  window.LESSONS["u3_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"사탕 17개에 6개를 더 받았어!\""},{"face":"🐧","label":"펭이 \"7 더하기 6은 10이 넘는데… 어떻게 세지?\""}],
        "tnote": {"ask":["17+6, 일의 자리 7+6이 10을 넘어! 어떻게 계산하면 좋을까?"],"watch":"10 만들기·가르기 두 방법을 아이들 말로 먼저","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["10을 먼저 만들면 왜 더 쉬울까?","17에 몇을 더하면 20이 될까? 10을 먼저 만들면 왜 더 쉬울까?"],"watch":"가르기로 10 채우기 — 몇을 더 줘야 10이 될까 · 3 — 20에서 남은 3","min":4},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["6을 3과 3으로 갈랐어. 왜 하필 3으로 갈랐을까?"],"watch":"17이 20이 되려면 3이 필요","min":4},
          "title": "방법 ② 6을 갈라서 더해요",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["7+6을 1713처럼 이어 붙이면 왜 안 될까?","7+6=13이니까 1713? 이 친구는 무엇을 빼먹었을까?"],"watch":"자리값 — 일의 자리끼리만 더함 · 13의 10을 십의 자리로 올림","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["18+5는 5를 몇과 몇으로 가를까?"],"watch":"2와 3 — 18+2=20","min":3},
          "title": "기본 ① ",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["25+7은 7을 어떻게 가를까? 25가 30이 되려면?"],"watch":"5와 2","min":3},
          "title": "기본 ② ",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["38+5에서 38을 40으로 만들려면 몇이 필요해?"],"watch":"2 — 남은 3","min":3},
          "title": "기본 ③ ",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["□+7=32에서 □는? 어떻게 생각했어?"],"watch":"25 — 32에서 7 거꾸로","min":5},
          "title": "구슬 더하기",
          "levels": {
            "기본": {
              "q": "17 + 6 은 얼마일까요?",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["세 문제 모두 어떤 방법으로 풀었어? 10 만들기? 가르기?"],"watch":"방법을 말로","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "18+5는?",
  ...
  window.LESSONS["u3_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"도토리 28개 모았어!\""},{"face":"🐧","label":"펭이 \"나는 19개! 합치면 몇 개지?\""}],
  ...
  window.LESSONS["u3_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"62 더하기 53… 가로로 쓰니까 헷갈려.\""},{"face":"🐧","label":"펭이 \"자리를 위아래로 맞춰 쓰면 어때?\""}],
        "tnote": {"ask":["수가 커지면 가로셈이 왜 불편할까? 위아래로 맞춰 쓰면 뭐가 좋을까?"],"watch":"자리끼리 한눈에 — 세로셈","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["자리를 안 맞추고 쓰면 무엇이 잘못될까?","세로셈에서 어느 자리부터 계산해? 자리를 안 맞추고 쓰면 무엇이 잘못될까?"],"watch":"일·십 세로 정렬 확인 · 일의 자리부터 — 십과 일이 섞임","min":4},
          "title": "세로셈 — 자리를 맞춰요",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["합이 100을 넘으면 백의 자리는 어디서 올까?","62+53에서 십의 자리 6+5=11이야. 이 1은 어디로 갈까? 합이 100을 넘으면 백의 자리는 어디서 올까?"],"watch":"십의 자리 합이 10 넘으면 백으로 올림 · 백의 자리 — 십에서 올림","min":4},
          "title": "합이 100을 넘어요",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["끝에 맞춰 쓴 이 세로셈, 어디가 틀렸을까?"],"watch":"십의 자리 아래 일의 자리가 옴","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["58+46 세로셈: 8+6은? 4를 쓰고 1은 어디에?"],"watch":"14 — 십의 자리로","min":3},
          "title": "기본 ① 세로셈",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["68+59에서 6+5+1은? 답이 세 자리 수가 됐어. 왜?"],"watch":"12 — 백의 자리 생김","min":3},
          "title": "기본 ③ ",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["더해서 100이 넘는 두 자리 수 짝을 짝과 서로 다르게 말해 볼까?"],"watch":"58+46·70+35·99+1 …","min":5},
          "title": "책 세기",
          "levels": {
            "기본": {
              "q": "47 + 38 은 얼마일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["책이 모두 몇 권? 세로셈으로 어떻게 썼어?"],"watch":"123","min":4},
          "title": "책 이야기",
          "scenario": {
            "icon": "📚",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["75+74에서 받아올림이 있었어? 어느 자리에서?"],"watch":"십의 자리에서 백으로","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "58+46은?",
  ...
  window.LESSONS["u3_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"사탕 23개 중 5개를 줬어. 3에서 5를 못 빼!\""},{"face":"🐧","label":"펭이 \"십에서 빌려오면 어떨까?\""}],
  ...
  window.LESSONS["u3_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"연필 50자루 중 27자루를 나눠 줬어.\""},{"face":"🐧","label":"펭이 \"0에서 7을 어떻게 빼? 십을 풀어야겠다!\""}],
        "tnote": {"ask":["50-27, 일의 자리 0에서 7을 못 빼! 어떻게 할까?"],"watch":"십 하나를 풀어 10으로","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["50을 40과 10으로 바꾸면 무엇이 편해져? 10-7은?"],"watch":"3 — 십은 4 남음","min":4},
          "title": "자리별로 빼요",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["십에서 10을 빌리면 십의 자리는 어떻게 될까?","십에서 10을 빌리면 십의 자리는 어떻게 될까? 5가 몇으로?"],"watch":"빌린 뒤 십의 자리 1 줄이기 잊지 않기 · 4 — 4-2=2","min":4},
          "title": "받아내림 세로셈",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["빌려 놓고 십의 자리를 안 줄이면 무엇이 잘못될까?","빌려 놓고 십의 자리를 안 줄이면 답이 얼마가 돼? 왜 틀릴까?"],"watch":"받아내림 표시로 확인 · 33 — 10을 두 번 씀","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["42-19: 2에서 9를 못 빼면? 12-9는?"],"watch":"3 — 십 3-1=2 → 23","min":3},
          "title": "기본 ① ",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["45-28에서 십의 자리는 4에서 몇이 됐어?"],"watch":"3 — 3-2=1","min":3},
          "title": "기본 ② ",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["□-19=23에서 □는? 어떻게 찾았어?"],"watch":"42 — 23+19","min":5},
          "title": "딱지 빼기",
          "levels": {
            "기본": {
              "q": "51 - 24 는 얼마일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["남은 딱지는 몇 장? 받아내림이 있었어?"],"watch":"35","min":3},
          "title": "딱지 이야기",
          "scenario": {
            "icon": "🟫",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["63-27에서 빌린 뒤 십의 자리 계산을 말해 볼까?"],"watch":"5-2=3","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "42-19는?",
  ...
  window.LESSONS["u3_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"사탕 54개 중 26개를 먹었어!\""},{"face":"🐧","label":"펭이 \"세로셈으로 자리를 맞춰 빼 보자. 4에서 6을 못 빼는데?\""}],
        "tnote": {"ask":["54-26을 세로셈으로 쓰면 뭐가 좋을까? 일의 자리 4-6은 어떻게 할까?"],"watch":"자리 맞춤 — 받아내림 14-6","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["일의 자리 3에서 4를 못 빼면 어떻게 할까?","일의 자리 4에서 6을 못 빼면 어떻게 할까? 십의 자리는 5에서 몇이 돼?"],"watch":"거꾸로 빼지 않게 — 십에서 빌리기 · 14-6=8 — 4-2=2","min":4},
          "title": "받아내림 세로셈",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["뺄셈이 맞는지 어떻게 확인할까?","뺄셈이 맞는지 어떻게 확인할까? 28에 26을 더하면?"],"watch":"답＋빼는 수＝처음 수 · 54 — 원래 수","min":4},
          "title": "덧셈으로 확인해요",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["6-4=2로 거꾸로 빼면 답이 얼마가 돼? 왜 이상할까?"],"watch":"32 — 확인하면 32+26≠54","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["23-4 세로셈: 3에서 4를 못 빼면 13-4는? 십은?"],"watch":"9 — 1 → 19","min":3},
          "title": "기본 ① 세로셈",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["65-18에서 십의 자리 계산은? 빌린 뒤 5가 몇?"],"watch":"4-1=3 → 47","min":3},
          "title": "기본 ② ",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["답이 45가 되는 뺄셈식을 짝과 서로 다르게 만들어 볼까?"],"watch":"74-29·63-18·52-7 …","min":5},
          "title": "색종이 빼기",
          "levels": {
            "기본": {
              "q": "52 - 7 은 얼마일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["남은 색종이는 몇 장? 덧셈으로 확인해 볼까?"],"watch":"24 — 24+뺀 수","min":4},
          "title": "색종이 이야기",
          "scenario": {
            "icon": "🟦",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["81-37의 답을 덧셈으로 확인해 볼까? 44+37은?"],"watch":"81","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "23-4는?",
  ...
  window.LESSONS["u3_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"곰 15마리에 19마리가 더 왔어!\""},{"face":"🐧","label":"펭이 \"그런데 21마리가 떠났대. 세 수를 어떻게 계산하지?\""}],
        "tnote": {"ask":["15마리 → 19마리 더 → 21마리 떠남. 세 수를 어떤 순서로 계산할까?"],"watch":"앞에서부터 ①②","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["세 수는 어느 쪽부터 계산할까?","세 수는 어느 쪽부터 계산할까? 15+19를 먼저 하면 얼마?"],"watch":"앞에서부터 차례대로 ①② · 34 — 그다음 34-21","min":4},
          "title": "앞에서부터 ① ②",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["더하고 빼기, 빼고 더하기 — 순서가 바뀌어도 규칙은 같아?"],"watch":"늘 앞에서부터","min":3},
          "title": "덧셈·뺄셈이 섞여도",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["뒤부터 계산하면 왜 답이 달라질까?","뒤의 19-21을 먼저 하면 무슨 일이 생겨? 뒤부터 계산하면 왜 답이 달라질까?"],"watch":"앞에서부터 순서 지키기 · 19에서 21을 못 뺌 — 순서 중요","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["24+17-19: ①은 얼마? 중간값을 적어 두면 뭐가 좋을까?"],"watch":"41 — 헷갈리지 않음","min":3},
          "title": "기본 ① ",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["42-15+27: 뺄셈이 앞이야. ①은?"],"watch":"27 — 27+27=54","min":3},
          "title": "기본 ③ ",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["45·27·19로 답이 53이 되는 식을 만들어 볼까? 어느 수를 빼야 할까?"],"watch":"45+27-19","min":5},
          "title": "도토리 계산",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["도토리 45-17+24, 중간값은? 지금은 몇 개?"],"watch":"28 → 52","min":4},
          "title": "도토리 이야기",
          "scenario": {
            "icon": "🌰",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["28+25-36에서 ①의 답을 말해 볼까?"],"watch":"53","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "24+17-19는?",
  ...
  window.LESSONS["u3_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"물 안에 7마리, 물 밖에 3마리! 모두 10마리야.\""},{"face":"🐧","label":"펭이 \"덧셈식으로도, 뺄셈식으로도 쓸 수 있을까?\""}],
        "tnote": {"ask":["7과 3, 10 — 이 세 수로 덧셈식과 뺄셈식을 만들 수 있을까?"],"watch":"전체·부분 낱말 꺼내기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["전체와 부분은 어떻게 다를까?","전체는 몇? 부분은 몇과 몇? 전체와 부분은 어떻게 다를까?"],"watch":"전체 하나에 부분 둘 · 10 — 7·3","min":4},
          "title": "전체와 부분",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["덧셈식 하나에서 뺄셈식이 왜 둘이 나올까?","7+3=10에서 뺄셈식이 두 개나 나와. 왜 둘일까?"],"watch":"전체-부분＝다른 부분 · 전체에서 어느 부분을 빼느냐","min":4},
          "title": "덧셈식 하나로 뺄셈식 둘",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["10-7의 답이 7이라는 친구, 전체와 부분 중 무엇을 헷갈렸을까?"],"watch":"전체 10에서 부분 7 → 다른 부분 3","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["부분 8과 5를 모으면 전체는? 이 식으로 뺄셈식을 두 개 말해 볼까?"],"watch":"13 — 13-8=5·13-5=8","min":3},
          "title": "기본 ① 전체 구하기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["전체 15, 한 부분 9. 다른 부분을 구하는 식은?"],"watch":"15-9=6","min":3},
          "title": "기본 ② 다른 부분",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["전체 14로 덧셈식·뺄셈식을 짝과 다르게 만들어 볼까?"],"watch":"6+8=14·14-8=6·9+5=14 …","min":5},
          "title": "사과 식 가족",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["9+□=15에서 더 받은 사과는? 어떤 뺄셈식으로 구했어?"],"watch":"15-9=6","min":4},
          "title": "사과 이야기",
          "scenario": {
            "icon": "🍎",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["7+8=15면 15-8은? 15-7은?"],"watch":"7 · 8","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "부분 8과 5를 모으면?",
  ...
  window.LESSONS["u3_l10"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"물고기 5마리 잡고 더 잡아서 9마리가 됐어.\""},{"face":"🐧","label":"펭이 \"더 잡은 수를 모르니까 □로 쓰자! 5+□=9\""}],
        "tnote": {"ask":["더 잡은 수를 모를 때 무엇으로 나타낼까? 5+□=9에서 □는 몇일까?"],"watch":"□ 도입 — 전체·부분으로","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["모르는 수를 무엇으로 나타낼까?","5+□=9에서 전체는? 부분은? □는 어떻게 구할까?"],"watch":"□＝모르는 수, 거꾸로 계산으로 찾기 · 9·5 — 9-5=4","min":4},
          "title": "모르는 수를 □로",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["= 는 무슨 뜻일까? 저울 양쪽이 같으려면 □에 뭐가 들어가야 해?"],"watch":"양쪽 같음 — 4","min":4},
          "title": "등호는 저울처럼",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["12-□=9에서 왜 12+9가 아닐까?","12-□=9에서 □=21이라는 친구, 무엇이 잘못됐을까? 12-□=9에서 왜 12+9가 아닐까?"],"watch":"□ 위치에 따라 더하기/빼기가 달라짐 · □는 빼는 수 — 12-9=3","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["5+□=9를 그림으로 그리면 전체는 어디, 부분은 어디?"],"watch":"막대그림","min":3},
          "title": "기본 ① ",
          "question": "5 + □ = 9 에서 □는?",
          "input": "count_input",
          "answer": 4,
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["13-□=8에서 □는 빼는 수야? 남은 수야?"],"watch":"빼는 수 — 13-8=5","min":3},
          "title": "기본 ② ",
          "question": "13 - □ = 8 에서 □는?",
          "input": "count_input",
          "answer": 5,
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["□-7=8에서 □는 처음 수야. 어떻게 구할까?"],"watch":"8+7=15","min":3},
          "title": "기본 ③ ",
          "question": "□ - 7 = 8 에서 □는?",
          "input": "count_input",
          "answer": 15,
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["□가 7이 되는 식을 덧셈으로 하나, 뺄셈으로 하나 만들어 볼까?"],"watch":"3+□=10·□-5=2","min":5},
          "title": "□ 찾기",
          "levels": {
            "기본": {
              "q": "6 + □ = 14 에서 □는?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["□-6=7, 처음 사탕은 몇 개? 더할까 뺄까?"],"watch":"13 — 더함","min":4},
          "title": "사탕 이야기",
          "scenario": {
            "icon": "🍬",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["세 문제에서 □가 전체였던 것은 어느 것?"],"watch":"□-7=8","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "5+□=9에서 □는?",
  ...
  window.LESSONS["u3_l11"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"받아올림, 받아내림, 세 수, □… 다 배웠어!\""},{"face":"🐧","label":"펭이 \"한 문제씩 풀면서 내가 잘 아는지 확인해 보자.\""}],
        "tnote": {"ask":["이번 단원에서 가장 자신 있는 건 무엇일까?","이번 단원에서 가장 자신 있는 건 무엇일까? 헷갈리는 건?"],"watch":"네 영역(덧셈·뺄셈·세 수·□) 스스로 점검 · 손 들기로 점검","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["네 가지를 순서대로 말해 볼까? 각각 한 문제씩 예를 들면?"],"watch":"세로셈·세 수·관계·□","min":3},
          "title": "네 가지를 점검해요",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["47+28에서 받아올림은 어디서 생겨?"],"watch":"일의 자리 7+8=15","min":3},
          "title": "확인 ① 받아올림",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["63-27에서 십의 자리는 6에서 몇이 됐어?"],"watch":"5 — 5-2=3","min":3},
          "title": "확인 ② 받아내림",
          "question": "63 - 27 은 얼마일까요?",
          "input": "count_input",
          "answer": 36,
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["28+35-19의 중간값은?"],"watch":"63","min":3},
          "title": "확인 ③ 세 수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["□+8=15에서 □는 전체야 부분이야?"],"watch":"부분 — 15-8","min":3},
          "title": "확인 ④ □값",
          "question": "□ + 8 = 15 에서 □는?",
          "input": "count_input",
          "answer": 7,
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["답이 40이 되는 세 수 식을 짝과 다르게 만들어 볼까?"],"watch":"25+30-15·50-20+10 …","min":5},
          "title": "단원 도전 문제",
          "levels": {
            "기본": {
              "q": "54 + 38 은 얼마일까요?",
      ...
      },
      {
        ...
        "data": {
          ...
          "steps": [
            "확인 ①~④ 답을 짝과 번갈아 말해요.",
            "답이 다르면 수 카드로 세로셈을 다시 써 봐요.",
            "뺄셈은 덧셈으로 확인해요(답+뺀 수=처음 수).",
            "틀린 문제는 ○ 표시해 두어요."
          ],
          "materials": [
            "확인 문제지",
  ...
  window.LESSONS["u3_l12"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"색 큐브로 북극곰을 만들었어!\""},{"face":"🐧","label":"펭이 \"나는 펭귄! 우리가 쓴 큐브를 세어 볼까?\""}],
        "tnote": {"ask":["작품에 쓴 큐브를 어떻게 세면 빠뜨리지 않을까?"],"watch":"색깔별로 나눠 세기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["모두 몇 개인지 구할 때는 무엇을 쓸까?","큐브가 많으면 어떻게 나눠 셀까? 모두 몇 개인지 구할 때는 무엇을 쓸까?"],"watch":"모으기＝덧셈 · 색깔별 → 더하기","min":4},
          "title": "부분으로 나눠 세요",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["곰이 42개, 펭이 35개. \"모두\"는 무슨 셈? \"몇 개 더\"는?"],"watch":"덧셈 77 · 뺄셈 7","min":4},
          "title": "나와 친구를 비교해요",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["몇 개 더 많은지 구할 때 왜 더하면 안 될까?","몇 개 더 많은지 구할 때 왜 더하면 안 될까? 두 줄로 나란히 놓으면 무엇이 보여?"],"watch":"차이＝뺄셈 · 차이는 빼기","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["빨강 23개와 파랑 19개, 모두 몇 개? 받아올림이 있어?"],"watch":"42 — 3+9=12","min":3},
          "title": "기본 ① 큐브 세기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["곰이 45개, 펭이 28개. 누가 몇 개 더 썼어?"],"watch":"곰이 17개","min":3},
          "title": "기본 ② 비교",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["모두 80개가 되도록 두 사람이 나누는 방법, 짝과 다르게 말해 볼까?"],"watch":"40+40·55+25·63+17 …","min":5},
          "title": "작품 재료 계산",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["곰이가 몇 개 더 모았을까? 어떤 식으로 구했어?"],"watch":"18 — 뺄셈","min":4},
          "title": "재활용품 이야기",
          "scenario": {
            "icon": "♻️",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["3단원에서 새로 할 수 있게 된 것 한 가지만 말해 볼래?"],"watch":"자기 평가","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "23+19는?",
