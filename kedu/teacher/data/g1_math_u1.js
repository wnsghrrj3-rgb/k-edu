...
LESSONS["u1_l10"] = {
  ...
  slides: [
    ...
    {id:"s08", stage:"기본문제", block:"basic_problem", data:{title:"5 vs 3 — 더 큰 쪽?", left:{ten_frame:5},right:{ten_frame:3}, component:"compare_picker", target:"larger"}, suggested_extras:[]},
    ...
    {id:"s14", stage:"응용문제", block:"match", data:{title:"양방향 표현 빈칸", left:"6은 4보다 ___", right:"4는 6보다 ___", options:["크다","작다"], answers:["크다","작다"]}, suggested_extras:[]},
