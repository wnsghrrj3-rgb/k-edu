  ...
  window.LESSONS["u6_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"텃밭에 토마토가 정말 많아! 하나씩 세면 하루 종일 걸리겠어.\""},{"face":"🐧","label":"펭이 \"몇 개씩 묶어서 세면 어떨까?\""}],
        "tnote": {"ask":["이 많은 것을 하나씩 세면 어떨까?","몇 개씩 묶으면 세기 편할까?","이 많은 것을 하나씩 세면 어떨까? 몇 개씩 묶으면 세기 편할까?"],"watch":"“많다”에서 멈추는 반응 — 같은 수로 묶는 쪽으로 유도 · \"묶어 세기\"가 나오면 오늘 열쇠","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["공을 5씩 묶었어. 4묶음이면 몇 개? 어떻게 세었어?"],"watch":"5·10·15·20","min":4},
          "title": "묶어 세면 빨라요",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["5씩 뛰어 세어 볼까? 5, 10, … 손뼉 치며!"],"watch":"5·10·15·20","min":3},
          "title": "뛰어 세기",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["하나씩 세는 게 늘 가장 빠를까? 언제 편하고 언제 힘들까?"],"watch":"적을 땐 하나씩, 많을 땐 묶어서","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["5씩 4묶음을 어떻게 세었니?","5씩 4묶음을 어떻게 세었니? 뛰어 세기로?"],"watch":"하나씩 세기로 되돌아가는 학생 — 뛰어 세기로 다시 · 20","min":3},
          "title": "기본 ① 묶어 세기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["3씩 6묶음이면? 3씩 뛰어 세어 볼까?"],"watch":"3·6·9·12·15·18","min":3},
          "title": "기본 ② 다른 묶음",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["교실에서 묶어 세면 좋은 물건이 있을까? 몇씩 몇 묶음?"],"watch":"책상 줄·사물함·신발","min":5},
          "title": "텃밭에서 묶어 세기",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["토마토는 모두 몇 개? 몇씩 몇 줄이었어?"],"watch":"15 — 5씩 3줄","min":3},
          "title": "텃밭 이야기",
          "scenario": {
            "icon": "🍅",
      ...
      },
      {
        ...
        "data": {
          ...
          "type": "pair",
          "icon": "⚫",
          "goal": "많은 바둑돌을 같은 수로 묶어 빠르게 세요.",
          "steps": [
            "짝과 바둑돌 한 줌(20개 안팎)을 받아요.",
            "한 사람은 하나씩, 한 사람은 5씩 묶어 세요.",
            "누가 먼저 맞게 세었는지, 무엇이 편했는지 말해요.",
            "이번엔 둘 다 2씩 묶어 뛰어 세어 봐요."
          ],
          "materials": [
            "바둑돌 20개(짝당)"
          ],
          ...
          "tnote": {
            "ask": [
              "5씩 묶으니 몇 번 만에 다 세었어요?"
            ],
            "watch": "묶어 세기의 편리함을 몸으로",
            "min": 4
          }
        }
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["많은 물건을 빠르게 세는 방법을 한 문장으로?"],"watch":"같은 수로 묶어 세기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "많은 물건을 빠르게 세는 방법은?",
  ...
  window.LESSONS["u6_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"딱지를 모았는데 너무 많아서 세다가 까먹었어!\""},{"face":"🐧","label":"펭이 \"하나씩? 뛰어서? 묶어서? 어떤 게 제일 편할까?\""}],
        "tnote": {"ask":["하나씩 세면 무엇이 힘들까?","딱지가 많을 때 어떻게 세면 가장 편할까? 하나씩 세면 무엇이 힘들까?"],"watch":"“정확하니까 하나씩”에 머무는 학생 — 시간·빠뜨림으로 견주기 · 세 가지 방법을 아이들 입에서","min":3},
          "scene_title": "딱지가 한가득! 🎴",
          "visual": "🎴",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["12장을 하나씩 세면 몇 번 세어야 해? 오래 걸릴까?"],"watch":"12번 — 정확하지만 느림","min":3},
          "title": "하나씩 세기",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["3씩 뛰어 세면 몇 번 만에 12가 돼? 3씩 4묶음으로 묶으면 한눈에 보여?"],"watch":"4번","min":4},
          "title": "뛰어 세기와 묶어 세기",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["들쭉날쭉 묶으면 왜 뛰어 세기 어려울까?","3, 2, 4 …처럼 들쭉날쭉 묶으면 왜 뛰어 세기 어려울까?"],"watch":"묶음 크기가 다르면 뛰어 세기가 무너짐을 손으로 확인 · 같은 수로 묶어야 뛰어 셈","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["3씩 4묶음, 뛰어 세어 볼까?"],"watch":"3·6·9·12","min":3},
          "title": "기본 ① 묶어 세기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["구슬 15개를 5씩 묶으면 몇 묶음? 5, 10, 15 — 몇 번 뛰었어?"],"watch":"3","min":3},
          "title": "기본 ② 묶음의 수",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["딱지 24장을 나만의 묶음으로 세어 볼까? 몇씩 몇 묶음?"],"watch":"4씩 6·6씩 4·8씩 3","min":5},
          "title": "어떻게 세면 편할까",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["단추는 모두 몇 개? 어떻게 묶어 세었어?"],"watch":"18","min":3},
          "title": "단추 이야기",
          "scenario": {
            "icon": "🔘",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["뛰어 세려면 어떻게 묶어야 해?"],"watch":"같은 수로","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u6_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"공 20개를 5씩 묶으면 4묶음이야!\""},{"face":"🐧","label":"펭이 \"나는 4씩 묶어서 5묶음인데? 누가 맞는 거지?\""}],
        "tnote": {"ask":["곰이와 펭이 중 누구 말이 맞을까?","곰이는 5씩 4묶음, 펭이는 4씩 5묶음. 누구 말이 맞을까?"],"watch":"한쪽만 정답으로 고르려는 반응 — 둘 다 20개임을 확인 · 둘 다 20 — 묶는 방법이 다를 뿐","min":3},
          "scene_title": "체육관의 공 🏐",
          "visual": "🏐",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["5씩 4묶음을 뛰어 세어 볼까? 모두 몇 개?"],"watch":"5·10·15·20","min":3},
          "title": "몇씩 몇 묶음",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["묶는 수를 키우면 묶음 수는 어떻게 될까?","같은 20개를 4씩 묶으면 몇 묶음? 묶는 수를 키우면 묶음 수는 어떻게 될까?"],"watch":"묶음 크기와 묶음 수가 반대로 움직임 · 5묶음 — 반대로 움직임","min":4},
          "title": "같은 양, 다른 묶음",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["묶는 수가 크면 묶음 수도 많아질까? 5씩과 4씩을 비교하면?"],"watch":"오히려 적어짐","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["5씩 4묶음, 몇 개? 5씩 뛰어 세어 볼까?"],"watch":"20","min":3},
          "title": "기본 ① 전체 수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["콩 주머니 18개를 6씩 묶으면 몇 묶음? 6, 12, 18!"],"watch":"3","min":3},
          "title": "기본 ② 묶음의 수",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["24개를 묶는 방법을 짝과 서로 다르게 말해 볼까?"],"watch":"6씩 4·4씩 6·8씩 3·3씩 8","min":5},
          "title": "몇씩 몇 묶음",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["달걀은 모두 몇 개? 몇씩 몇 묶음이었어?"],"watch":"15","min":3},
          "title": "달걀 이야기",
          "scenario": {
            "icon": "🥚",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["묶는 수가 커지면 묶음 수는? 왜?"],"watch":"적어짐 — 양은 같으니까","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "5씩 4묶음은 모두?",
  ...
  window.LESSONS["u6_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"내 탑은 쌓기나무 2개야.\""},{"face":"🐧","label":"펭이 \"내 탑은 곰이 탑의 4배 높이! 몇 개일까?\""}],
        "tnote": {"ask":["4배 높이라는 말은 무슨 뜻일까?","\"4배 높이\"라는 말은 무슨 뜻일까? 2개짜리 탑을 몇 번 쌓은 걸까?"],"watch":"“더 높다”에서 멈추지 않게 — 기준 탑이 몇 번인지로 · 2씩 4번 → 8","min":3},
          "scene_title": "쌓기나무 탑 🧱",
          "visual": "🧱",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["2씩 4묶음을 \"2의 4배\"라고 해. 기준은 몇? 몇 번 반복?"],"watch":"2 — 4번","min":4},
          "title": "몇의 몇 배",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["같은 8개를 4의 2배라고 할 수 있을까? 8의 1배는?"],"watch":"기준을 바꾸면 배가 달라짐","min":4},
          "title": "단위를 바꾸면",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["8의 1배는 얼마일까?","배는 무조건 커지는 걸까? 8의 1배는 얼마일까?"],"watch":"배는 무조건 커진다는 오해 — 1배는 그대로 · 8 — 그대로","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["2씩 4묶음은 2의 몇 배? 쌓기나무로 보여 줄래?"],"watch":"4배","min":3},
          "title": "기본 ① 배 구하기",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["6의 4배는? 6씩 뛰어 세어 볼까?"],"watch":"6·12·18·24","min":3},
          "title": "기본 ③ 전체 수",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["8개를 서로 다른 배로 말해 볼까? 몇 가지나 될까?"],"watch":"2의 4배·4의 2배·8의 1배·1의 8배","min":5},
          "title": "몇의 몇 배",
          "levels": {
            "기본": {
              "q": "2씩 4묶음은 2의 몇 배일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["빵은 모두 몇 개? 몇의 몇 배였어?"],"watch":"14","min":3},
          "title": "빵 이야기",
          "scenario": {
            "icon": "🍞",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["4씩 3묶음은 4의 몇 배? 배는 무엇을 세는 거야?"],"watch":"3배 — 기준이 몇 번","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "4씩 3묶음은 4의 몇 배?",
  ...
  window.LESSONS["u6_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"내 막대는 2칸이야.\""},{"face":"🐧","label":"펭이 \"내 막대는 6칸! 곰이 막대가 몇 번 들어갈까?\""}],
        "tnote": {"ask":["펭이 막대에 곰이 막대가 몇 번 들어갈까?","펭이 막대에 곰이 막대가 몇 번 들어갈까? 그럼 몇 배야?"],"watch":"“더 길다”로만 답하는 반응 — 몇 번인지 세도록 · 3번 → 3배","min":3},
          "scene_title": "색 막대 비교 📏",
          "visual": "📏",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["2칸 막대를 6칸 막대에 이어 대면 몇 번 들어가? 길이의 배는 무엇을 세는 거야?"],"watch":"3번 — 짧은 것이 몇 번","min":4},
          "title": "길이의 배",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["구슬 4개의 2배는? 적은 쪽을 기준으로 몇 번?"],"watch":"8 — 2번","min":3},
          "title": "양의 배",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["“3배 길다”와 “더 길다”는 어떻게 다를까?","\"더 길다\"와 \"3배 길다\"는 어떻게 다를까? 어느 쪽이 더 정확해?"],"watch":"기준을 대어 세는 말하기로 옮기기 · 몇 번 들어가는지 말해야 정확","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["2칸 막대의 3배는 몇 칸? 2, 4, 6!"],"watch":"6","min":3},
          "title": "기본 ① 길이의 배",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["8칸은 2칸의 몇 배? 2칸이 몇 번 들어가?"],"watch":"4배","min":3},
          "title": "기본 ③ 배 비교",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["교실에서 다른 물건의 몇 배가 되는 물건을 찾아볼까?"],"watch":"지우개 2개 = 연필 1개 길이 …","min":5},
          "title": "길이와 양의 배",
          "levels": {
            "기본": {
              "q": "2칸 막대의 3배는 몇 칸일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["긴 리본은 몇 칸? 짧은 리본의 몇 배?"],"watch":"12","min":3},
          "title": "리본 이야기",
          "scenario": {
            "icon": "🎀",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["구슬 5개의 2배는? 몇 배인지 어떻게 알았어?"],"watch":"10 — 5가 2번","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "2칸 막대의 3배는?",
  ...
  window.LESSONS["u6_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"컵이 3개씩 6줄이야. 3+3+3+3+3+3… 너무 길어!\""},{"face":"🐧","label":"펭이 \"짧게 쓰는 방법이 있을까?\""}],
        "tnote": {"ask":["3을 여섯 번 더한 식을 짧게 쓸 방법이 있을까?","3을 여섯 번 더한 식을 짧게 쓸 방법이 있을까? 3의 6배를 기호로 쓴다면?"],"watch":"긴 덧셈식의 불편함을 먼저 겪게 · × 도입","min":3},
          "scene_title": "컵이 줄줄이! 🥤",
          "visual": "🥤",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["3×6은 어떻게 읽을까? 3의 6배와 같은 말일까?"],"watch":"3 곱하기 6","min":4},
          "title": "곱셈 기호 ×",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["4+4+4+4+4를 곱셈식으로? \"4와 5의 곱은?\""],"watch":"4×5=20","min":4},
          "title": "동수누가는 곱셈",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["3×6의 곱은 어떻게 구할까?","3×6의 곱은 어떻게 구할까? 외우지 않고도 구할 수 있어?"],"watch":"외워 답하려는 반응 — 뛰어 세기(3·6·9·12·15·18)로 · 뛰어 세기 3·6·9·12·15·18","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["2×7은 2씩 몇 번? 뛰어 세어 볼까?"],"watch":"2·4·…·14","min":3},
          "title": "기본 ① 곱셈",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["5+5+5를 곱셈식으로 쓰면? 곱은?"],"watch":"5×3=15","min":3},
          "title": "기본 ② 동수누가→곱셈",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["6×4를 뛰어 세기로 구해 볼까? 어떻게 세었는지 짝에게 말해 볼까?"],"watch":"6·12·18·24","min":5},
          "title": "곱셈식으로 쓰기",
          "levels": {
            "기본": {
              "q": "2×7은 얼마일까요? (2씩 7번)",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["딸기는 모두 몇 개? 곱셈식으로 쓰면?"],"watch":"14","min":3},
          "title": "딸기 이야기",
          "scenario": {
            "icon": "🍓",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["4+4+4+4+4를 곱셈식으로 쓰고 읽어 볼까?"],"watch":"4×5 — 4 곱하기 5","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "3의 6배를 곱셈식으로 쓰면?",
  ...
  window.LESSONS["u6_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"소고 24개를 4씩 묶었어. 4×6!\""},{"face":"🐧","label":"펭이 \"나는 6씩 묶어서 6×4인데… 둘 다 맞아?\""}],
        "tnote": {"ask":["곰이와 펭이의 묶음이 둘 다 맞을 수 있을까?","곰이의 4×6과 펭이의 6×4, 둘 다 맞을 수 있을까? 곱은?"],"watch":"한 가지 식만 정답으로 여기는 반응 · 둘 다 24 — 묶는 방법 차이","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["4씩 6묶음은 무슨 식? 6씩 4묶음은? 소고 수는 같아?"],"watch":"4×6 · 6×4 · 24","min":4},
          "title": "여러 곱셈식",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["4×6과 6×4는 무엇이 같고 무엇이 다를까?","4×6과 6×4는 무엇이 같고 무엇이 다를까? 24를 나타내는 다른 곱셈식은?"],"watch":"곱은 같아도 묶는 방법(상황)은 다름 · 곱 같음·묶음 다름 — 3×8·8×3","min":4},
          "title": "순서를 바꿔도",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["곱셈식은 한 가지로만 써야 할까? 묶는 방법을 바꾸면?"],"watch":"여러 식 가능","min":4},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["4×6을 뛰어 세기로? 4씩 몇 번?"],"watch":"24","min":3},
          "title": "기본 ① 곱셈",
          "question": "4×6은 얼마인가요?",
          "input": "count_input",
          "answer": 24,
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["자전거 한 대에 바퀴 2개, 5대면? 곱셈식으로 쓰면?"],"watch":"2×5=10","min":3},
          "title": "기본 ② 실생활",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["소고 24개를 나타내는 곱셈식을 짝과 서로 다르게 말해 볼까?"],"watch":"4×6·6×4·3×8·8×3","min":5},
          "title": "여러 곱셈식",
          "levels": {
            "기본": {
              "q": "4×6은 얼마일까요?",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["소고는 모두 몇 개? 곱셈식 두 가지로 말해 볼까?"],"watch":"24","min":3},
          "title": "소고 이야기",
          "scenario": {
            "icon": "🥁",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["4×6과 곱이 같은 다른 식은? 사자 3마리 다리는 무슨 식?"],"watch":"6×4 · 4×3","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "4×6은?",
  ...
  window.LESSONS["u6_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["묶음·배·곱셈식 중 가장 자신 있는 건? 헷갈리는 건?"],"watch":"손 들기로 점검","min":3},
          "title": "단원을 점검해요",
          "question": "곰이와 펭이가 곱셈 단원을 정리해요.<br>묶음 → 배 → 곱셈식, 한 문제씩 풀며 내가 잘 아는지 확인해 볼까요?",
          "kids": [
            {
              "face": "🐻",
              "label": "곰이 \"묶어 세기, 몇의 몇 배, 곱셈식… 다 배웠어!\""
            },
            {
              "face": "🐧",
              "label": "펭이 \"한 문제씩 풀면서 확인해 보자. 뭐가 제일 자신 있어?\""
            }
          ]
        }
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["묶음·배·곱셈식은 어떻게 이어질까?","묶음·배·곱셈식은 어떻게 이어질까? 6씩 3묶음을 세 가지로 말해 볼까?"],"watch":"세 표현을 따로 외운 학생 — 한 그림으로 이어 보이기 · 6씩 3묶음=6의 3배=6×3","min":4},
          "title": "핵심 한눈에",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["6×3은 얼마? 6씩 뛰어 세어 볼까?"],"watch":"18","min":3},
          "title": "확인 ① 곱셈",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["2+2+2+2+2+2를 곱셈식으로? 2가 몇 번?"],"watch":"2×6=12","min":3},
          "title": "확인 ② 동수누가→곱셈",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["5×7은? 5씩 7번 뛰어 세어 볼까?"],"watch":"35","min":3},
          "title": "확인 ③ 곱셈",
          "question": "5×7은 얼마인가요?",
          "input": "count_input",
          "answer": 35,
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["매일 3개씩 5일이면 곱셈식은? 왜 3×5로 쓸까?"],"watch":"3개씩이 기준","min":5},
          "title": "단원 확인",
          "levels": {
            "기본": {
              "q": "6씩 3묶음, 6×3은 얼마일까요?",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["3개씩 5일을 왜 3×5로 쓸까?","3개씩 5일을 왜 3×5로 쓸까? 5×3이라고 쓰면 무슨 상황이 될까?"],"watch":"곱이 같다고 상황 표현까지 같다고 여기는 반응 · 5개씩 3일","min":4},
          "title": "이런 답을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["종이비행기는 모두 몇 개? 곱셈식으로 쓰면?"],"watch":"15","min":3},
          "title": "종이비행기 이야기",
          "scenario": {
            "icon": "✈️",
      ...
      },
      {
        ...
        "data": {
          ...
          "steps": [
            "확인 ①~③ 답을 짝과 번갈아 말해요.",
            "답이 다르면 바둑돌을 몇씩 몇 줄로 놓아 뛰어 세어 봐요.",
            "곱셈식을 묶음·배로 바꿔 말하며 확인해요.",
            "틀린 문제는 ○ 표시해 두어요."
          ],
          "materials": [
            "확인 문제지",
  ...
  window.LESSONS["u6_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐻","label":"곰이 \"텃밭에 무당벌레랑 나비가 가득해!\""},{"face":"🐧","label":"펭이 \"곤충으로 곱셈 카드를 만들자. 살살 다뤄야 해!\""}],
        "tnote": {"ask":["곤충을 셀 때 어떤 마음으로 다가갈까?","곤충을 셀 때 어떤 마음으로 다가갈까? 곱셈 카드에 무엇을 그릴까?"],"watch":"세기 활동과 생명 존중을 함께 · 생명 존중 한 마디 먼저","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["개미가 3마리씩 2줄이면 무슨 식? 어떻게 읽을까?"],"watch":"3×2=6 — 3 곱하기 2","min":4},
          "title": "곱셈 카드 만들기",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["같은 그림을 몇 가지 방법으로 말할 수 있을까?","3×2를 다른 말로 몇 가지나 할 수 있을까? 같은 그림을 몇 가지 방법으로 말할 수 있을까?"],"watch":"표현 한 가지만 고집하는 반응 · 3+3·3씩 2묶음·3의 2배","min":4},
          "title": "한 그림, 여러 표현",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["곱셈 카드는 한 가지 방법으로만 말해야 할까? 짝과 다른 표현을 찾아볼까?"],"watch":"여러 표현","min":3},
          "title": "이런 생각을 조심해요",
          "label": "자주 하는 실수",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["개미 카드 3×2는 몇 마리?"],"watch":"6","min":3},
          "title": "기본 ① 곱셈 카드",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["나비 카드 4×3은 몇 마리? 4씩 뛰어 세어 볼까?"],"watch":"12","min":3},
          "title": "기본 ③ 곱셈 카드",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["3×2를 나타내는 표현을 모두 말해 볼까? 몇 가지?"],"watch":"3+3·3씩 2묶음·3의 2배","min":5},
          "title": "곱셈 카드",
          "levels": {
            "기본": {
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["잠자리는 모두 몇 마리? 곱셈식으로?"],"watch":"12","min":3},
          "title": "잠자리 이야기",
          "scenario": {
            "icon": "🦗",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["6단원에서 새로 할 수 있게 된 것 한 가지만 말해 볼래?"],"watch":"자기 평가","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "3×2는?",
