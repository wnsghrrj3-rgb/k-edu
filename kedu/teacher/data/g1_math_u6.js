  ...
  window.LESSONS["u6_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["수학 보물이 뭘까? 만화 친구들은 뭘 찾았어요?"],"watch":"\"돈·금\"이 나오면 웃고 수·모양으로","min":3},
      ...
      },
      {
        ...
        "tnote": {
          "ask": [
            "수학은 교실 밖 어디에 숨어 있을까?",
            "우리 주변에서 수·모양·더하기·비교를 찾을 수 있어요?"
          ],
          "watch": "생활 속 수학(수·모양·규칙)을 보물로 연결 · 네 가지 이름 세우기",
          "min": 3
        }
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["이런 보물 중 우리 학교에 있을 것 같은 건?"],"watch":"구체적 장소","min":2},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["어디에서 찾을래요? 왜 거기?"],"watch":"이유 말하기","min":3},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["나가기 전 약속 세 가지를 말해 볼까?"],"watch":"안전·생명 존중·시간","min":2},
          "title": "나가기 전 약속 🤝",
          "tag": "꼭 함께 확인해요",
          "icon": "⚠️",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["눈에 안 보이는 보물도 있을까?"],"watch":"즐거움·호기심","min":2},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["찾은 보물을 어떻게 보여 줄래요?"],"watch":"다음 차시 예고","min":2},
          "title": "이 보물로 무엇을 할까?",
  ...
  window.LESSONS["u6_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["내 보물을 친구에게 어떻게 보여 주고 싶어요?"],"watch":"그리기·만들기·몸","min":3},
      ...
      },
      {
        ...
        "tnote": {
          "ask": [
            ...
            "세 가지 방법 중 내 보물엔 뭐가 어울려요?"
          ],
          "watch": "그림·몸(타블로)·만들기 등 다양한 표현 존중 · 보물 종류에 따라",
          "min": 3
        }
      },
      {
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["몸으로 미끄럼틀을 만들려면 몇 명이 필요해요?"],"watch":"수가 들어감","min":3},
          "title": "몸으로 표현하기 — 타블로",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["하나만 고른다면?"],"watch":"결정하기","min":2},
          "title": "나는 어떻게 표현할까?",
          "content": "내가 찾은 보물에는\n어떤 방법이 가장 잘 어울릴까요?\n\n그려서? 만들어서? 몸으로?\n하나를 골라 봐요."
        },
        "suggested_extras": [
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["그림 옆에 수나 모양 이름을 쓰면 뭐가 좋아요?"],"watch":"수학 보물임이 드러남","min":3},
          "title": "그려서 표현하기",
          "tag": "🙋 교실 활동",
          "icon": "✏️",
      ...
      },
      {
        ...
        "block": "game",
        "data": {
        "tnote": {"ask":["내 보물을 한 문장으로 소개하면?"],"watch":"\"이건 ___이고 ___이 ___개예요\"","min":3},
          "title": "내 보물 소개하기",
          "steps": [
            "\"내가 찾은 보물은 ○○야\"라고 말하기",
            "친구가 \"어디서?\", \"왜?\"라고 묻기",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["재료를 아껴 쓰는 방법은?"],"watch":"이면지·다 쓴 통","min":2},
          "title": "재료를 아껴 써요",
  ...
  window.LESSONS["u6_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["전시회를 열면 뭐가 좋아요?"],"watch":"보여 주고 보기","min":2},
      ...
      },
      {
        ...
        "tnote": {
          ...
          "watch": "전시·관람 예절과 표현 나눔 안내 · 공간·구역·이름표·역할",
          "min": 3
        }
      },
      {
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["둘 가고 둘 남기는 어떻게 하는 거예요?"],"watch":"역할 교대","min":2},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["우리 모둠은 어느 구역? 이름표에 뭘 쓸까?"],"watch":"작품 이름 + 수학 보물 종류","min":3},
          "title": "전시 구역 정하고 꾸미기",
          "tag": "🙋 교실 활동",
          "icon": "🏗️",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["친구 작품에서 좋았던 점 하나는?"],"watch":"비판 말고 감상","min":3},
          "title": "감상하기",
          "tag": "🙋 교실 활동",
          "icon": "👀",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["자연에서 본 수학 중 예뻤던 건?"],"watch":"꽃잎 수·잎 모양","min":2},
          "title": "수학은 아름다워요",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["보물찾기에서 가장 기억에 남는 순간은?"],"watch":"자유롭게","min":3},
          "title": "소감을 나눠요",
