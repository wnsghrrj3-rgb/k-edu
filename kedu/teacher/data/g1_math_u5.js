...
(function () {
    ...
    "slides": [
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["얼음 9개에 1개를 더 넣으면 몇 개?"],"watch":"\"열\" 또는 \"십\" 둘 다 인정 — 두 이름 예고","min":3},
          "scene_title": "건강한 여름, 빙수를 만들어요",
          "kids": [
            {
              "face": "🍧",
              "label": "빙수"
      ...
      },
      {
        ...
        "tnote": {
          "ask": [
            "9 다음에 오는 수는 무엇일까?",
            "9보다 1만큼 더 큰 수는? 배열판이 어떻게 돼요?"
          ],
          "watch": "9와 1을 모아 10 만들기 · 10 = 배열판이 꽉 참",
          "min": 3
        }
      },
      {
        ...
        "block": "visual_demo",
        "data": {
          "title": "10을 두 가지 모양으로 봐요",
          "ten_frame_solo": {
            "count": 10,
            "is_anchor": true,
            "label": "**연결 모형**으로 10개\n**십 배열판** 10칸\n모양은 달라도 **모두 10**"
          },
          "sub_text": "구체물로 10의 개념을 단단히"
        },
        "suggested_extras": [
          "a_link_cube_split",
          "m_ten_frame_value",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["10을 두 가지로 읽어 볼까?"],"watch":"열·십","min":2},
          "title": "10을 두 가지로 읽어요",
          "bidirect": [
            "수 **10**",
            "↓",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["10을 두 묶음으로 가르면? 다른 방법도?"],"watch":"5·5 말고도 여러 가지","min":3},
          "title": "10을 두 묶음으로 갈라 봐요",
          "bidirect": [
            "연결 모형 10개",
            "↓",
            "파랑 묶음 + 노랑 묶음",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["10은 9 다음 수인데 왜 두 글자로 써요?"],"watch":"1과 0 두 자리 — \"1이 앞에 서요\"","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "10은 9 다음이니까 한 자리 수야",
          "right": "10은 **두 자리** 수예요.\n10개씩 **묶음 1개**로 나타내요.",
          "hint": "9 다음에 묶음이 하나 생겨요."
        },
        "suggested_extras": []
      },
      {
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "10의 두 가지 읽기를 짝지어요",
          "question": "숫자 **10** 두 장과\n읽기 카드 **열 · 십**\n\n같은 것끼리 짝지어요.",
          "answer": "10 ↔ 열 · 십",
          "note": "같은 10끼리 짝. 10은 열 또는 십으로 읽어요."
        },
        "suggested_extras": [
          "m_two_readings"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["파랑이 3이면 노랑은 몇? 어떻게 알았어요?"],"watch":"10에서 3 세고 남은 것","min":2},
          "title": "10을 3과 ?로 갈라 봐요",
          "question": "파랑 묶음 **3개**,\n노랑 묶음은 ▢개?\n\n10 - 3 = 7\n(정답: 7)",
          "answer": 7,
          "note": "10은 3과 7. 10−3=7."
        },
        "suggested_extras": [
          "m_partition_meaning"
        ]
      },
      {
        ...
        "data": {
          ...
          "levels": {
            ...
            "심화": {
              "q": "10을 두 수로 가르는 방법을 여러 가지 말해 봐요.",
              "a": "여러 답 (예: 6과 4, 8과 2)",
              "open": true
            }
          }
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["10 가르기가 모두 몇 가지예요?"],"watch":"9가지 — 0·10은 오늘 안 셈","min":3},
          "title": "10을 두 수로 자유롭게 갈라요",
          "question": "정답은 **9가지**:\n(1,9) (2,8) (3,7) (4,6) (5,5)\n(6,4) (7,3) (8,2) (9,1)\n\n* (0,10)·(10,0)은 인정만, 권장 X",
          "answer": "9가지 — (1,9)(2,8)(3,7)(4,6)(5,5)(6,4)(7,3)(8,2)(9,1)",
          "note": "0을 넣은 (0,10)·(10,0)은 인정만, 권장하지 않아요."
        },
        "suggested_extras": [
          "x_one_split_answer",
          "x_zero_in_partition",
      ...
      },
      {
        ...
        "suggested_extras": [
          "m_card_count_per_player",
          "m_expected_responses",
          "a_supplement_make_ten"
        ]
      },
      {
        "id": "s15",
        ...
        "block": "advanced_problem",
        "data": {
          "title": "개수가 10개인 것을 모두 골라요",
          "question": "🪆 인형 10개 — 정답\n📚 책 10권 — 정답\n🍪 과자 9개 — 오답\n⭐ 별 8개 — 오답\n\n다중 정답: 두 가지 모두 선택",
          "answers": [
            "인형 10개",
            "책 10권"
          ],
          "note": "10개인 것만. 과자 9개·별 8개는 10이 아니에요."
        },
        "suggested_extras": [
          "r_dolls_books",
          "r_snack_box_ten",
      ...
      },
      {
        ...
        "data": {
          ...
          "type": "pair",
          "icon": "🤲",
          "goal": "둘의 손가락을 모아 10을 만들어요.",
          "steps": [
            "짝과 마주 봐요.",
            "한 사람이 손가락을 몇 개 펴요(예: 3).",
            "짝은 모아서 10이 되게 손가락을 펴요(7).",
            "역할을 바꿔 다섯 번 해요."
          ],
          "materials": [
            "없음"
      ...
      },
      {
        ...
        "block": "summary",
        "data": {
          "title": "10은 두 수로 9가지로 갈라요",
          "points": [
            "10 = **9보다 1만큼 더 큰 수**",
            "읽기 — **열** / **십** 두 가지",
            "가르기 9가지 = 1·9, 2·8, 3·7, 4·6, 5·5",
            "6·4, 7·3, 8·2, 9·1",
            "0과 10, 10과 0은 권장 X"
          ]
        },
      ...
      },
      {
        ...
        "data": {
          "title": "스스로 점검해 봐요",
          "content": "9 다음 수가 **10**임을 알 수 있나요?\n**10을 두 가지로 읽을** 수 있나요?\n**10을 두 수로 가르기** 할 수 있나요?"
        },
        "suggested_extras": [
          "m_self_assess_kind"
        ]
      },
      {
        ...
        "data": {
          "title": "다음 시간에는",
          "preview": "10보다 큰 수 — **십몇(11~19)** 을 배워요\n10개씩 묶음 1개와 낱개 몇 개로 봐요",
          "emoji": ""
        },
        "suggested_extras": [
          "e_to_teens",
  ...
  LESSONS["u5_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["과일이 모두 몇 개? 10개와 몇 개로 나눠 세 볼까?"],"watch":"10 묶고 남은 낱개","min":3},
          "scene_title": "빙수에 과일을 올려요",
          "kids": [
            {
              "face": "🍧",
              "label": "빙수"
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["12는 10개씩 묶음 몇 개와 낱개 몇 개?"],"watch":"묶음 1·낱개 2","min":2},
          "title": "12를 만들어 봐요",
          "bidirect": [
            "묶음 1개 (10)",
            "+",
      ...
      },
      {
        ...
        "block": "visual_demo",
        "data": {
        "tnote": {"ask":["12를 그림·말·수 세 가지로 말해 볼까?"],"watch":"열둘·십이","min":3},
          "title": "12를 세 가지로 나타내요",
          "ten_frame_solo": {
            "count": 12,
            "is_anchor": true,
            "label": "**그림**으로 12개\n**말**로 십이 / 열둘\n**수**로 12"
          },
          "sub_text": "그림 → 말 → 수, 표현이 자라요"
        },
        "suggested_extras": [
          "m_array_recognition",
          "a_link_cube_teens",
      ...
      },
      {
        ...
        "block": "arrow_flow",
        "data": {
        "tnote": {"ask":["묶어 세면 왜 빨라요?"],"watch":"10을 한 번에","min":2},
          "title": "묶어 세면 더 빨라요",
          "steps": [
            "하나씩 세기 — 느려요",
            "10개씩 **묶음**으로 보기",
      ...
      },
      {
        ...
        "data": {
          "title": "🍑 살구는 몇 개일까요?",
          "question": "10개씩 묶음 **1개**와\n낱개 **4개**가 있어요.\n\n살구는 모두 몇 개?",
          "answer": 14,
          "note": "10과 4로 14. 십사 / 열넷."
        },
        "suggested_extras": [
          "a_supp_count",
          "a_o_marks"
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["14의 앞 1은 그냥 1이에요?"],"watch":"묶음 1개 = 10","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "앞의 1은 그냥 1이야",
          "right": "십몇의 앞 1은 **10개씩 묶음 1개**(=10)예요.\n그냥 1이 아니에요.",
          "hint": "묶음 1개는 10."
        },
        "suggested_extras": []
      },
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["수박 17개는 묶음 몇, 낱개 몇?"],"watch":"1·7","min":2},
          "title": "🍉 수박을 묶음과 낱개로",
          "question": "수박 **17개**를\n10개씩 묶음 ▢개와\n낱개 ▢개로 나타내요.",
          "answer": "묶음 1개, 낱개 7개",
          "note": "17은 10개씩 1묶음과 낱개 7."
        },
        "suggested_extras": [
          "m_unit_changes"
        ]
      },
      {
        ...
        "data": {
          ...
          "levels": {
            ...
            "심화": {
              "q": "10개씩 묶음 1개와 낱개 몇 개로 만들 수 있는 수를 말해 봐요.",
              "a": "여러 답 (11~19)",
              "open": true
            }
          }
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "낱개를 몇 개 놓아야 할까요?",
          "question": "묶음 1개가 놓여 있어요.\n**15**를 만들려면\n낱개를 ▢개 더 놓아야 해요.",
          "answer": 5,
          "note": "10에 5를 더 놓으면 15. 낱개 5개."
        },
        "suggested_extras": [
          "a_supp_two_to_one",
          "m_concrete_repeat"
      ...
      },
      {
        ...
        "block": "question",
        "data": {
          "title": "빙수에 산딸기를 더 넣어 봐요",
          "content": "지금 **13개**가 있어요.\n산딸기를 **1개 더** 넣으면?\n\n1만큼 더 큰 수는 ▢"
        },
        "suggested_extras": [
          "a_bingsu_dragdrop",
          "m_free_count_first",
          "a_classroom_count_teens"
        ]
      },
      {
        "id": "s15",
        ...
        "block": "advanced_problem",
        "data": {
        "tnote": {"ask":["묶음이 같으면 무엇으로 비교해요?"],"watch":"낱개","min":3},
          "title": "누가 더 많이 가지고 있을까요?",
          "question": "친구 A — 묶음 1개와 낱개 6개\n친구 B — 묶음 1개와 낱개 3개\n\n누가 더 많을까요? 왜 그럴까요?",
          "answer": "친구 A (16 > 13)",
          "note": "묶음 수 같으면 낱개로 비교. A=16, B=13."
        },
        "suggested_extras": [
          "a_pair_compare",
          "x_compare_by_digits",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
          "title": "연결 모형으로 십몇 만들기",
          "tag": "짝 활동",
          "type": "pair",
          "icon": "🧱",
          "goal": "10개 묶음 하나와 낱개로 십몇을 만들어요.",
          "steps": [
            "연결 모형 10개를 한 줄로 끼워 묶음 하나를 만들어요.",
            "선생님이 부르는 수(예: 14)만큼 낱개를 옆에 놓아요.",
            "짝이 묶음 1·낱개 4를 확인하고 두 가지로 읽어요.",
            "역할을 바꿔요."
          ],
          "materials": [
            "연결 모형 20개(짝당)"
          ...
          "tnote": {
            ...
            "watch": "낱개를 10개 넘게 놓으면 묶어야 함을 발견",
            "min": 5
          }
        }
      },
      ...
      },
      {
        ...
        "data": {
          "title": "십몇을 정리해 봐요",
          "points": [
            "**십몇** — 10개씩 묶음 1개와 낱개 몇 개",
            "11~19는 **십일~십구**, **열하나~열아홉**",
            "그림·말·수 세 가지로 나타낼 수 있어요",
            "낱개가 1 늘면 수도 1 커져요"
          ]
        },
        "suggested_extras": [
  ...
  LESSONS["u5_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["두 묶음 조개를 모으면 몇 개? 빠르게 세는 법은?"],"watch":"큰 수부터 이어 세기(3단원 연결)","min":3},
          "scene_title": "조개껍데기로 목걸이를 만들어요",
          "kids": [
            {
              "face": "🐚",
              "label": "한 묶음"
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["9와 6을 모을 때 어디서 시작하면 빨라요?"],"watch":"9부터","min":3},
          "title": "큰 수부터 이어 세면 빨라요",
          "bidirect": [
            "8과 5를 모을 때",
            "8에서 시작 → 9,10,11,12,13",
            "**큰 수 8부터** 이어 세기",
            "하나씩 다 세지 않아도 돼요"
          ]
        },
        "suggested_extras": [
          "m_count_on_from_larger",
          "x_count_again_from_start"
        ]
      },
      {
        "id": "s06",
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["13을 두 묶음으로 갈라 볼까? 몇 가지?"],"watch":"여러 가지","min":3},
          "title": "한 묶음을 둘로 갈라 봐요",
          "bidirect": [
            "🐚🐚 13개",
            "↓",
            "왼쪽 그릇 🐚 (몇 개)",
      ...
      },
      {
        ...
        "suggested_extras": [
          "m_zero_pair_acceptable",
          "m_two_digit_one_digit",
          "a_linking_cube_teens"
        ]
      },
      {
        "id": "s08",
        ...
        "data": {
          ...
          "sub_text": "모으기 ↔ 가르기는 서로 반대"
        },
        "suggested_extras": [
          "m_linear_arrangement",
          "r_apple_pick"
        ]
      },
      {
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["큰 수에서 작은 수로만 갈라야 해요?"],"watch":"13 = 6과 7도 됨","min":2},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "큰 수에서 작은 수로만 갈라야 해",
          "right": "두 묶음의 **순서를 바꿔도** 같은 수예요.\n8과 6 = 6과 8.",
          "hint": "모으기는 순서를 바꿔도 합이 같아요."
        },
        "suggested_extras": []
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["14를 8과 몇으로? 어떻게 알았어요?"],"watch":"8에서 14까지 이어 세기","min":2},
          "title": "14를 갈라요 — 한 묶음은 8",
          "question": "**14**를 두 묶음으로 갈라요.\n한 묶음이 **8**이면\n다른 묶음은 ▢",
          "answer": 6,
          "note": "14는 8과 6. 14−8=6."
        },
        "suggested_extras": [
          "a_supp_workbook"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "16을 갈라요 — 한 묶음은 9",
          "question": "**16**을 두 묶음으로 갈라요.\n한 묶음이 **9**이면\n다른 묶음은 ▢",
          "answer": 7,
          "note": "16은 9와 7. 16−9=7."
        },
        "suggested_extras": [
          "m_count_back_subtraction"
        ]
      },
      {
        "id": "s101",
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "두 묶음을 자유롭게 모아 봐요",
          "challenge": "🐚 묶음을 자유롭게 골라\n**두 묶음을 모아** 봐요.\n친구와 만든 수가 다를 수 있어요.",
          "note": "열린 활동. 예 — 7과 8을 모으면 15. 친구와 고른 두 묶음이 달라 합도 달라요."
        },
        "suggested_extras": [
          "r_buttons_share",
          "x_order_diff_pair",
      ...
      },
      {
        ...
        "block": "real_world",
        "data": {
        "tnote": {"ask":["조개 11개를 두 어항에 어떻게 나눌래요?"],"watch":"정답 여러 개","min":3},
          "title": "조개 11개를 두 어항에 나눠 봐요",
          "scenario": {
            "icon": "🐚",
            "body": "조개 **11개**를\n어항 두 개에 나눠 담아요.\n\n왼쪽 ▢개 + 오른쪽 ▢개 = 11\n답이 **여러 가지** 가능해요"
          }
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["15부터 거꾸로 세어 볼까? 가르기에 왜 도움이 돼요?"],"watch":"15,14,13… — 뺄 때","min":2},
          "title": "거꾸로 세어 봐요",
          "content": "15에서 시작해\n14, 13, 12 … 거꾸로 세어 봐요.\n\n가르기를 할 때\n**거꾸로 세기**가 도움이 돼요."
        },
        "suggested_extras": [
          "m_count_back_subtraction",
          "e_to_addition_subtraction"
        ]
      },
      {
        "id": "s15b",
        ...
        "data": {
          ...
          "type": "pair",
          "icon": "🃏",
          "goal": "십몇을 두 수로 모으고 갈라요.",
          "steps": [
            "수 카드 1~9 를 두 장 뽑아 모으면 몇인지 말해요.",
            "짝은 이어 세기로 확인해요.",
            "이번엔 11~19 카드 한 장을 뽑아 두 수로 갈라 말해요.",
            "다른 방법으로 한 번 더 갈라요."
          ],
          "materials": [
            "수 카드 1~19"
  ...
  LESSONS["u5_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["사람이 아주 많을 땐 어떻게 세면 빠를까?"],"watch":"10명씩 묶기","min":3},
          "scene_title": "바닷가에 사람이 많아요",
          "kids": [
            {
              "face": "🏖️",
              "label": "바닷가"
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["20을 두 가지로 읽어 볼까?"],"watch":"스물·이십","min":2},
          "title": "20을 두 가지로 읽어요",
          "bidirect": [
            "수 — 20",
            "말 — **이십**",
      ...
      },
      {
        ...
        "block": "visual_demo",
        "data": {
        "tnote": {"ask":["묶음 수와 몇십은 어떤 관계예요?"],"watch":"묶음 3 → 30","min":3},
          "title": "묶음이 곧 몇십이에요",
          "ten_frame_solo": {
            "count": 40,
            "is_anchor": true,
          ...
          "sub_text": "묶음 수를 보면 몇십을 바로 알 수 있어요"
        },
        "suggested_extras": [
          "m_zero_ones_confirm",
          "e_place_value_position",
          "a_count_classroom_things"
        ]
      },
      {
        "id": "s09",
        ...
        "data": {
          "title": "튜브가 모두 몇 개일까요?",
          "question": "10개씩 묶음 **2개**가 있어요.\n\n튜브는 모두 ▢개",
          "answer": 20,
          "note": "10개씩 2묶음은 20. 이십 / 스물."
        },
        "suggested_extras": [
          "a_tube_count",
          "r_egg_carton"
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["묶음 3개는 3이에요?"],"watch":"30 — 묶음 하나가 10","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "묶음 3개는 3이야",
          "right": "10개씩 **묶음 3개는 30**.\n묶음 하나가 10이에요.",
          "hint": "몇십은 묶음 수에 0을 붙여요."
        },
        "suggested_extras": []
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "구명조끼가 모두 몇 개일까요?",
          "question": "10개씩 묶음 **4개**가 있어요.\n\n구명조끼는 모두 ▢개",
          "answer": 40,
          "note": "10개씩 4묶음은 40."
        },
        "suggested_extras": [
          "r_lifejacket_storage"
        ]
      },
      {
        "id": "s11",
        ...
        "data": {
          "title": "30을 두 가지로 읽어요",
          "question": "아이스크림 **묶음 3개**\n수로는 ▢\n말로는 ▢ / ▢",
          "answer": "수로 30, 말로 삼십 / 서른",
          "note": "10개씩 3묶음 = 30."
        },
        "suggested_extras": [
          "x_korean_writing_repeat"
        ]
      },
      {
        "id": "s101",
        ...
        "data": {
          ...
          "levels": {
            ...
            "심화": {
              "q": "10씩 뛰어 세며 말할 수 있는 수를 말해 봐요.",
              "a": "여러 답 (10, 20, 30, 40, 50)",
              "open": true
            }
          }
        },
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "10개씩 묶음을 자유롭게 만들어 봐요",
          "challenge": "구슬을 10개씩 묶어 봐요.\n묶음 ▢개를 만들면\n몇십이 될까요?",
          "note": "열린 활동. 묶음 ▢개면 몇십. 예 — 5묶음이면 50."
        },
        "suggested_extras": [
          "m_choose_tool",
          "q_thirty_things",
      ...
      },
      {
        ...
        "block": "compare",
        "data": {
        "tnote": {"ask":["50과 30 중 어느 쪽이 커요? 묶음으로 말해 볼까?"],"watch":"묶음 5 vs 3","min":2},
          "title": "50과 30, 어느 쪽이 더 클까요?",
          "items": [
            {
              "ten_frame": 5,
              "num": 5,
        ...
        "suggested_extras": [
          "m_count_units_compare",
          "a_compare_with_model"
        ]
      },
      {
        "id": "s14",
        ...
        "block": "question",
        "data": {
          "title": "카드를 골라 30과 비교해 봐요",
          "content": "몇십 카드를 하나 골라요.\n내가 고른 수와 **30**을 비교해요.\n\n더 큰가요, 더 작은가요? 왜요?"
        },
        "suggested_extras": [
          "x_compare_without_reason",
          "a_pair_count_classroom"
        ]
      },
      {
        "id": "s15",
        ...
        "block": "advanced_problem",
        "data": {
        "tnote": {"ask":["50은 30보다 묶음이 몇 개 더 많아요?"],"watch":"2개","min":2},
          "title": "50은 30보다 묶음이 몇 개 더 많을까요?",
          "question": "50 — 묶음 5개\n30 — 묶음 3개\n\n50이 30보다 묶음 ▢개 더 많아요.\n그래서 50이 더 ▢요.",
          "answer": "묶음 2개 더 많아요. 그래서 50이 더 커요.",
          "note": "50=묶음5, 30=묶음3. 5−3=2."
        },
        "suggested_extras": [
          "m_count_units_compare"
        ]
      },
      {
        ...
        "block": "offline_activity",
        "data": {
          "title": "10개씩 묶어 세기 — 교실 물건",
          "tag": "모둠 활동",
          "type": "group",
          "icon": "📦",
          "goal": "많은 물건을 10개씩 묶어 몇십인지 말해요.",
          "steps": [
            "모둠에 연결 모형(또는 바둑돌) 한 통을 받아요.",
            "10개씩 묶어 놓아요.",
            "묶음이 몇 개인지 세고 몇십인지 두 가지로 읽어요.",
            "남은 낱개가 있으면 따로 세어 봐요."
          ],
          "materials": [
            "연결 모형 또는 바둑돌 30~50개(모둠당)"
          ],
          "minutes": 5,
          "tnote": {
            "ask": [
  ...
  {
    "meta": {
      "title": "1학년 수학 5단원 7차시",
      "subtitle": "50까지의 수를 세어 볼까요",
      "std": "[2수01-01]",
      "duration": 40,
      "lesson_format": " · 40분 표준 증보(4요소)"
    },
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["색칠한 칸을 묶음과 낱개로 세 볼까?"],"watch":"10줄 묶기","min":3},
          "scene_title": "색칠한 칸을 세요",
          "kids": [
            {
              "face": "🟦",
              "label": "묶음"
          ...
          "question": "색칠한 칸이 **모두 몇 개**일까요?\n하나씩 말고 **묶음과 낱개**로 세어 봐요.",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["23을 두 가지로 읽어 볼까?"],"watch":"스물셋·이십삼","min":2},
          "title": "23을 두 가지로 읽어요",
          "bidirect": [
            "수 — 23",
            "말 — **이십삼**",
      ...
      },
      {
        ...
        "block": "visual_demo",
        "data": {
        "tnote": {"ask":["50은 낱개가 몇이에요? 왜 0을 써요?"],"watch":"낱개 없음 = 0","min":3},
          "title": "50은 낱개가 0",
          "ten_frame_solo": {
            "count": 50,
            "is_anchor": true,
      ...
      },
      {
        ...
        "data": {
          "title": "파라솔이 몇 개일까요?",
          "question": "10개씩 묶음 **2개**와\n낱개 **5개**가 있어요.\n\n파라솔은 모두 ▢개",
          "answer": 25,
          "note": "20과 5로 25. 이십오 / 스물다섯."
        },
        "suggested_extras": [
          "r_locker_24",
          "m_context_reading"
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["묶음 3, 낱개 4는 7이에요?"],"watch":"34 — 묶음은 10씩","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "묶음 3·낱개 4는 7이야",
          "right": "묶음은 10씩이라 30, 낱개 4를 더해 **34**.\n묶음과 낱개를 자리에 맞춰요.",
          "hint": "묶음은 십의 자리, 낱개는 일의 자리."
        },
        "suggested_extras": []
      },
      {
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["36은 묶음 몇, 낱개 몇?"],"watch":"3·6","min":2},
          "title": "36은 묶음과 낱개로 어떻게?",
          "question": "**36**을 나타내요.\n10개씩 묶음 ▢개\n낱개 ▢개",
          "answer": "묶음 3개, 낱개 6개",
          "note": "36은 10개씩 3묶음과 낱개 6."
        },
        "suggested_extras": [
          "m_same_digit_22_33",
          "a_supp_workbook"
      ...
      },
      {
        ...
        "data": {
          ...
          "levels": {
            ...
            "심화": {
              "q": "묶음과 낱개로 만들 수 있는 40보다 큰 수를 말해 봐요.",
              "a": "여러 답 (41~50)",
              "open": true
            }
          }
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "묶음과 낱개로 수를 만들어 봐요",
          "challenge": "묶음과 낱개를 자유롭게 골라\n두 자리 수를 만들어 봐요.\n내가 만든 수를 읽어 봐요.",
          "note": "열린 활동. 묶음과 낱개를 골라 두 자리 수를 만들어 읽어 봐요."
        },
        "suggested_extras": [
          "g_baduk_guess",
          "q_my_age_birthday",
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
        "tnote": {"ask":["묶음 4·낱개 7이면 어떤 수? 앞 숫자는 뭘 말해요?"],"watch":"47 — 십의 자리 = 묶음","min":3},
          "title": "두 자리 모두 어떤 수를 말할까요?",
          "question": "**십의 자리**는 묶음 수\n**일의 자리**는 낱개 수\n\n묶음 4·낱개 7이면 어떤 수?",
          "answer": 47,
          "note": "십의 자리는 묶음 수(4), 일의 자리는 낱개 수(7) → 47."
        },
        "suggested_extras": [
          "e_place_value_start",
          "x_loose_no_grouping"
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
          "title": "묶음·낱개 수 만들기 대결",
          "tag": "짝 활동",
          "type": "pair",
          "icon": "🎯",
          "goal": "묶음과 낱개로 두 자리 수를 만들고 읽어요.",
          "steps": [
            "한 사람이 묶음 수(1~5)와 낱개 수(0~9)를 말해요.",
            "짝이 연결 모형으로 만들고 수를 말해요.",
            "두 가지로 읽어요(예: 스물셋 · 이십삼).",
            "역할을 바꿔요."
          ],
          "materials": [
      ...
      },
      {
        ...
        "data": {
          "title": "스스로 점검",
          "content": "두 자리 수를 묶음과 낱개로 셀 수 있나요?\n두 가지 말로 읽을 수 있나요?\n묶음·낱개로 수를 만들 수 있나요?"
        },
        "suggested_extras": []
      },
      {
  ...
  {
    "meta": {
      "title": "1학년 수학 5단원 8차시",
      "subtitle": "50까지 수의 순서를 알아볼까요",
      "std": "[2수01-03]",
      "duration": 40,
      "lesson_format": " · 40분 표준 증보(4요소)"
    },
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["25는 어디에 들어갈까? 양옆이 뭐예요?"],"watch":"24·26","min":3},
          "scene_title": "자리를 찾아 봐요",
          "kids": [
            {
              "face": "2️⃣",
              "label": "24"
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["25 양옆의 수를 말해 볼까?"],"watch":"24, 26","min":2},
          "title": "25 양옆의 수는?",
          "bidirect": [
            "앞 수 **24**",
            "25",
      ...
      },
      {
        ...
        "block": "arrow_flow",
        "data": {
        "tnote": {"ask":["배열표에서 아래로 한 칸 가면 얼마 커져요?"],"watch":"10","min":3},
          "title": "수 배열표에서 규칙을 찾아 봐요",
          "steps": [
            "오른쪽으로 → **1씩 커져요**",
            "아래로 ↓ **10씩 커져요**",
            "줄과 칸에 규칙이 있어요",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["39 다음은 310이에요?"],"watch":"40 — 낱개 9 다음은 묶음이 하나 늘어남","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "39 다음은 310이야",
          "right": "39 다음은 **40**.\n9 다음엔 묶음이 하나 늘어 십의 자리가 커져요.",
          "hint": "낱개 9 다음은 새 묶음."
        },
        "suggested_extras": []
      },
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["26과 29 사이 빈칸 두 개는?"],"watch":"27, 28","min":2},
          "title": "두 빈칸을 채워 봐요",
          "question": "26, ▢, ▢, 29\n\n두 빈칸에 알맞은 수는?",
          "answer": "27, 28",
          "note": "1씩 커져요: 26,27,28,29."
        },
        "suggested_extras": [
          "a_count_30_to_38"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["23 위 칸과 아래 칸은?"],"watch":"13, 33","min":3},
          "title": "위·아래 빈칸을 채워 봐요",
          "question": "배열표에서 23의\n**위 칸**(13보다…)과\n**아래 칸**은 어떤 수?",
          "answer": "위 칸 13, 아래 칸 33",
          "note": "배열표에서 위는 10 작은 수, 아래는 10 큰 수."
        },
        "suggested_extras": [
          "a_home_grid",
          "r_calendar_days"
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "30부터 38까지 차례로 눌러 봐요",
          "question": "30, 31, 32 …\n**순서대로** 38까지\n빠진 수 없이 눌러 봐요.",
          "answer": "30,31,32,33,34,35,36,37,38",
          "note": "빠진 수 없이 1씩 커지게."
        },
        "suggested_extras": [
          "x_skip_in_sequence",
      ...
      },
      {
        ...
        "data": {
          "title": "회오리 빈칸을 채워 봐요",
          "question": "수가 **나선**으로 놓여 있어요.\n순서 규칙을 찾아\n빈칸을 채워 봐요.",
          "answer": "순서 규칙대로 1씩 커지게 빈칸을 채워요",
          "note": "나선이어도 수는 차례대로 1씩 커져요."
        },
        "suggested_extras": [
          "a_advanced_workbook_08",
          "m_supp_advanced_diff"
        ]
      },
      {
        "id": "s15b",
        ...
        "block": "offline_activity",
        "data": {
          "title": "수 배열표 빈칸 채우기 짝",
          "tag": "짝 활동",
          "type": "pair",
          "icon": "🔢",
          "goal": "배열표의 규칙으로 빈칸을 채워요.",
          "steps": [
            "1~50 배열표에서 짝이 수 몇 개를 손가락으로 가려요.",
            "가려진 수를 양옆·위아래 수로 알아내 말해요.",
            "맞으면 손을 떼고 확인해요.",
            "역할을 바꿔요."
          ],
          "materials": [
      ...
      },
      {
        ...
        "data": {
          "title": "스스로 점검",
          "content": "1 큰 수·1 작은 수를 찾을 수 있나요?\n어떤 수의 양옆 수를 말할 수 있나요?\n배열표 규칙으로 빈칸을 채울 수 있나요?"
        },
        "suggested_extras": []
      },
      {
  ...
  LESSONS["u5_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["두 수 중 어느 게 커요? 어떻게 알았어요?"],"watch":"\"앞 숫자\"가 나오면 묶음으로 바꿔 말하기","min":3},
          "scene_title": "카드 뒤집기 놀이",
          "kids": [
            {
              "face": "🃏",
              "label": "내 카드"
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["묶음이 같으면?"],"watch":"낱개","min":2},
          "title": "묶음의 수가 같을 때",
          "bidirect": [
            "34 — 묶음 3, 낱개 4",
            "37 — 묶음 3, 낱개 7",
      ...
      },
      {
        ...
        "block": "compare",
        "data": {
        "tnote": {"ask":["세 수를 비교할 땐 어떻게 해요?"],"watch":"묶음 먼저 → 같으면 낱개","min":3},
          "title": "세 수를 비교해 봐요",
          "items": [
            {
              "ten_frame": 2,
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["낱개가 크면 더 큰 수예요? 26과 31은?"],"watch":"묶음 먼저","min":3},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "낱개(일의 자리)가 크면 더 큰 수야",
          "right": "먼저 **십의 자리(묶음)**부터 비교해요.\n십의 자리가 같을 때만 일의 자리를 봐요.",
          "hint": "묶음 수가 많은 쪽이 더 커요."
        },
        "suggested_extras": []
      },
      {
        ...
        "data": {
          ...
          "question": "**45**와 **42**\n\n더 큰 수는 어느 것일까요?",
          "answer": 45,
          "note": "십의 자리 같으면(4=4) 일의 자리로: 5>2라 45가 더 커요."
        },
        "suggested_extras": [
          "a_card_only_compare",
          "x_same_pick_winner"
      ...
      },
      {
        ...
        "data": {
          ...
          "question": "**38**과 **33**\n\n더 작은 수는 어느 것일까요?",
          "answer": 33,
          "note": "십의 자리 같음(3=3), 일의 자리 3<8이라 33이 더 작아요."
        },
        "suggested_extras": [
          "a_supp_compare",
          "r_book_pages"
      ...
      },
      {
        ...
        "data": {
          ...
          "scenario": {
            "icon": "🛤️",
            "body": "갈림길마다 **더 큰 수**를 따라가요.\n끝까지 가면 보물이 나와요!"
          }
        },
        "suggested_extras": [
          "a_workbook_compare_path",
          "g_path_chooser",
          "r_jersey_compare"
        ]
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
        "tnote": {"ask":["29·47·36 중 가장 큰 수를 어떻게 찾았어요?"],"watch":"묶음 4","min":2},
          "title": "가장 큰 수를 골라 봐요",
          "question": "**29 · 47 · 36**\n\n셋 중 **가장 큰 수**는?",
          "answer": 47,
          "note": "십의 자리 비교: 4가 가장 커요 → 47."
        },
        "suggested_extras": [
          "a_workbook_largest",
          "e_largest_4_5"
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "가장 작은 수를 골라 봐요",
          "question": "**42 · 24 · 40**\n\n셋 중 **가장 작은 수**는?",
          "answer": 24,
          "note": "십의 자리: 2가 가장 작아요 → 24."
        },
        "suggested_extras": [
          "m_same_no_record",
          "m_same_then_ones"
      ...
      },
      {
        ...
        "block": "card_arrange",
        "data": {
        "tnote": {"ask":["큰 수부터 줄을 세우면 어떤 순서?"],"watch":"묶음 → 낱개","min":3},
          "title": "큰 수부터 줄을 세워 봐요",
          "steps": [
            "수 카드 — 35 · 19 · 48 · 27",
            "**큰 수부터** 차례로",
            "48 → 35 → 27 → 19",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
          "title": "카드 두 장 크기 비교 대결",
          "tag": "짝 활동",
          "type": "pair",
          "icon": "🆚",
          "goal": "두 수의 크기를 묶음·낱개로 비교해요.",
          "steps": [
            "수 카드(10~50)를 뒤집어 놓아요.",
            "둘이 동시에 한 장씩 뒤집어요.",
            "더 큰 수를 먼저 말한 사람이 두 장을 가져가요.",
            "묶음이 같으면 낱개로 비교해요."
          ],
          "materials": [
            "수 카드 10~50"
      ...
      },
      {
        ...
        "data": {
          "title": "스스로 점검",
          "content": "묶음 수로 크기를 비교할 수 있나요?\n묶음이 같을 때 낱개로 비교할 수 있나요?\n가장 큰 수·작은 수를 찾을 수 있나요?"
        },
        "suggested_extras": []
      },
      {
    ...
    "slides": [
      ...
      },
      {
        ...
        "data": {
          ...
          "question": "천천히, 차근차근 풀어 봐요.\n어려운 문제는 **묶음과 낱개**를 떠올려요.",
          "img": "assets/photo/math/num50_check.jpg"
        },
        "suggested_extras": [
          "q_my_strong_question",
          "m_count_slowly"
        ],
        "tnote": {
          "ask": [
            "배운 것으로 어떤 문제를 만들 수 있을까?",
            "어려운 문제가 나오면 무엇을 떠올려요?"
          ],
          "watch": "50까지 수 종합 확인 · 묶음과 낱개",
          "min": 3
        }
      },
      {
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["빨대는 묶음 몇, 낱개 몇? 두 가지로 읽어 볼까?"],"watch":"두 읽기","min":3},
          "title": "평가 1 — 빨대 세고 읽기",
          "question": "빨대를 세어 봐요.\n묶음 ▢개, 낱개 ▢개\n수로 ▢, 말로 읽어 봐요.",
          "answer": "묶음 수는 십의 자리, 낱개 수는 일의 자리로 읽어요",
          "note": "센 묶음·낱개를 수로 적고 두 가지로 읽어요."
        },
        "suggested_extras": [
          "a_workbook_82",
          "x_109_for_19"
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["두 자리 수는 일의 자리만 보면 돼요?"],"watch":"묶음 먼저","min":2},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "두 자리 수는 일의 자리만 보면 돼",
          "right": "십의 자리부터 비교하고\n같을 때만 일의 자리를 봐요.",
          "hint": "묶음 수 먼저, 그다음 낱개."
        },
        "suggested_extras": []
      },
      {
        ...
        "data": {
          "title": "평가 2 — 빨대 세고 읽기",
          "question": "다른 그림의 빨대를 세어\n묶음과 낱개로 나타내고\n두 가지로 읽어 봐요.",
          "answer": "묶음 ▢개·낱개 ▢개로 적고 두 가지로 읽어요",
          "note": "그림마다 답이 달라요. 묶음·낱개로 정리하는지 보세요."
        },
        "suggested_extras": [
          "r_class_book_count"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["37과 39 사이는?"],"watch":"38","min":2},
          "title": "평가 3 — 빈칸에 알맞은 수",
          "question": "37, ▢, 39\n\n빈칸에 알맞은 수를 써 봐요.",
          "answer": 38,
          "note": "37,38,39. 1씩 커져요."
        },
        "suggested_extras": [
          "x_grid_blank_wrong"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "평가 4 — 빈칸에 알맞은 수",
          "question": "▢, 45, 46, ▢\n\n빈칸 두 곳에 알맞은 수를 써 봐요.",
          "answer": "44, 47",
          "note": "44,45,46,47. 1씩 커져요."
        },
        "suggested_extras": [
          "a_supp_recount"
        ]
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["34와 41, 어느 쪽이 커요? 왜?"],"watch":"묶음 4 > 3","min":2},
          "title": "평가 5 — 더 큰 수에 ○",
          "question": "**34**와 **41**\n\n더 큰 수에 ○ 해 봐요.",
          "answer": 41,
          "note": "십의 자리 4>3이라 41이 더 커요."
        },
        "suggested_extras": [
          "x_ones_only_compare",
          "r_grocery_compare"
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["모아서 15가 되는 짝을 하나 말해 볼까? 또?"],"watch":"여러 짝","min":3},
          "title": "평가 6 — 모아서 15 짝짓기",
          "question": "모아서 **15**가 되는\n두 수를 짝지어 봐요.\n(여러 짝이 있을 수 있어요)",
          "answers": [
            "7과 8",
            "6과 9"
          ],
          "note": "모아서 15면 정답 (7·8 / 6·9 / 5·10 …)."
        },
        "suggested_extras": [
          "x_make_15_wrong"
        ]
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
        "tnote": {"ask":["13을 두 가지 방법으로 갈라 볼까?"],"watch":"서로 다른 두 가지","min":3},
          "title": "평가 7 — 13을 두 가지로 갈라요",
          "question": "**13**을 두 묶음으로\n**서로 다른 두 가지** 방법으로\n갈라 봐요.",
          "answers": [
            "6과 7",
            "4와 9"
          ],
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "평가 8 — 묶음과 낱개 세기",
          "question": "그림을 보고\n묶음 ▢개, 낱개 ▢개\n모두 몇 개인지 써 봐요.",
          "answer": "묶음 ▢개·낱개 ▢개로 세어 모두 몇 개인지 적어요",
          "note": "그림마다 답이 달라요. 묶음·낱개·전체 수를 정리하는지 확인."
        },
        "suggested_extras": [
          "m_help_grade_self"
        ]
      ...
      },
      {
        ...
        "block": "advanced_problem",
        "data": {
          "title": "평가 9 — 셋 중 가장 큰 수에 ○",
          "question": "**28 · 46 · 33**\n\n가장 큰 수에 ○ 해 봐요.",
          "answer": 46,
          "note": "십의 자리 4가 가장 커요 → 46."
        },
        "suggested_extras": [
          "m_compare_groups_first"
        ]
      ...
      },
      {
        ...
        "data": {
          ...
          "type": "pair",
          "icon": "✅",
          "goal": "평가 답을 짝과 비교하고 이유를 말해요.",
          "steps": [
            "평가 1~9 답을 짝과 번갈아 말해요.",
            "다른 답이 있으면 묶음·낱개로 다시 세어 봐요.",
            "어느 쪽이 맞는지 이유를 말해요.",
            "틀린 문제는 ○ 표시해 두어요."
          ],
          "materials": [
  ...
  {
    "meta": {
      "title": "1학년 수학 5단원 11차시",
      "subtitle": "수학이랑 만들어요 (창의 활동)",
      "std": "[2수01-03]",
      "duration": 40,
      "lesson_format": " · 40분 표준 증보(4요소)"
    },
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "tnote": {"ask":["규칙대로 칠하면 무엇이 나올까?"],"watch":"기대감","min":2},
          "scene_title": "숨겨진 수를 찾아봐요",
          "kids": [
            {
              "face": "🔢",
              "label": "수"
      ...
      },
      {
        ...
        "tnote": {
          "ask": [
            "수의 범위마다 색을 어떻게 약속할까?",
            "색 약속을 말해 볼까? 20~29는 무슨 색?"
          ],
          "watch": "수 범위 → 색 규칙 만들기 · 범위 = 묶음 수",
          "min": 3
        }
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["24는 무슨 색? 어떻게 알았어요?"],"watch":"묶음 2","min":2},
          "title": "예시를 같이 봐요 — 24",
          "bidirect": [
            "24는 20~29 범위",
            "약속한 색 → **노랑**",
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
          "title": "수를 눌러 색을 칠해 봐요",
          "question": "각 칸의 수를 보고\n약속한 색으로 칠해 봐요.\n묶음 수로 범위를 빠르게 찾아요.",
          "answer": "약속한 색으로 칠해요 — 묶음 수로 범위를 빠르게 찾아요",
          "note": "범위별 색 약속을 지켜요."
        },
        "suggested_extras": [
          "g_paint_clicker",
      ...
      },
      {
        ...
        "block": "misconception",
        "data": {
        "tnote": {"ask":["색만 보고 아무렇게나 놓아도 돼요?"],"watch":"색은 범위, 자리는 순서","min":2},
          "title": "조심해요",
          "label": "오개념 주의",
          "wrong": "색만 보고 아무렇게나 놓아도 돼",
          "right": "같은 색(범위) 안에서도 **큰 수부터** 차례로 정렬해요.",
          "hint": "색으로 범위, 그 안에서 다시 크기 비교."
        },
        "suggested_extras": []
      },
      {
        ...
        "data": {
          "title": "더 많은 수를 칠해 봐요",
          "question": "남은 칸도 모두 칠해요.\n조금씩 **그림 모양**이\n보이기 시작해요.",
          "answer": "규칙대로 남은 칸도 칠하면 숨은 그림이 드러나요",
          "note": "빠뜨린 칸 없이 칠해요."
        },
        "suggested_extras": [
          "x_count_skip"
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["큰 순서로 놓을 때 무엇부터 봐요?"],"watch":"묶음","min":3},
          "title": "큰 순서대로 자리를 정해 봐요",
          "question": "칠한 수들을\n**큰 순서대로** 자리에 놓아\n그림을 완성해요.",
          "answer": "큰 수부터 차례로 — 십의 자리(묶음)부터 비교",
          "note": "정렬은 큰 수부터 놓아요."
        },
        "suggested_extras": [
          "m_step_by_step_sort",
          "m_pair_compare_extend"
        ]
      },
      {
        "id": "s09",
        ...
        "data": {
          "title": "그림 완성 1",
          "question": "규칙대로 다 칠하면\n어떤 그림이 나올까요?\n친구와 비교해 봐요.",
          "answer": "규칙대로 다 칠하면 숨은 그림 완성 (그림은 활동지마다 달라요)",
          "note": "열린 활동. 결과 그림은 활동지에 따라 달라요."
        },
        "suggested_extras": [
          "q_hidden_picture"
        ]
      },
      {
        ...
        "data": {
          "title": "그림 완성 2",
          "question": "다른 숨은 그림도\n같은 방법으로 완성해 봐요.",
          "answer": "같은 방법으로 색칠해 완성 (그림은 활동지마다 달라요)",
          "note": "열린 활동."
        },
        "suggested_extras": [
          "e_more_ranges"
      ...
      },
      {
        ...
        "block": "basic_problem",
        "data": {
        "tnote": {"ask":["두 수 중 큰 수를 먼저 고르는 연습 — 어느 게 커요?"],"watch":"묶음→낱개","min":2},
          "title": "정렬 워밍업",
          "question": "수 두 개 중\n더 큰 수를 먼저 골라\n정렬 연습을 해 봐요.",
          "answer": "두 수 중 큰 수를 먼저 골라요",
          "note": "십의 자리부터 비교."
        },
        "suggested_extras": [
          "m_personal_choice_first"
        ]
      },
      {
        "id": "s101",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["큰 순서로 놓든 작은 순서로 놓든 뭐가 같아요?"],"watch":"이웃 관계","min":3},
          "title": "출발이 달라도 도착은 같아요",
          "content": "큰 순서로 놓든 작은 순서로 놓든\n**수의 자리 관계**는 같아요.\n어느 쪽으로 세워도 규칙은 하나예요."
        },
        "suggested_extras": [
          "q_my_sort_rule"
        ]
      },
      {
        ...
        "data": {
          "title": "색을 보고 큰 순서로",
          "question": "색칠한 수들을\n색(범위)을 단서로\n**큰 순서대로** 정렬해 봐요.",
          "answer": "색(범위)을 단서로 큰 수부터 차례로 정렬해요",
          "note": "범위가 큰 색부터 놓아요."
        },
        "suggested_extras": [
          "m_no_win_lose_play",
      ...
      },
      {
        ...
        "data": {
          ...
          "type": "pair",
          "icon": "📏",
          "goal": "수 카드 네 장을 큰 순서·작은 순서로 놓아요.",
          "steps": [
            "수 카드 네 장을 뽑아요.",
            "한 사람이 큰 순서로 놓고, 짝이 확인해요.",
            "같은 카드를 작은 순서로 다시 놓아요.",
            "이웃한 카드의 자리가 같은지 이야기해요."
          ],
          "materials": [
            "수 카드 10~50"
          ],
