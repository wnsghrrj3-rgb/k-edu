...
LESSONS["u3_l01"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["두 바구니를 한 바구니에 담으면 몇 개일까?","세지 않고 아는 방법이 있을까?"],"watch":"\"다시 다 세요\"가 먼저 나오는 게 정상 — 오늘은 \"모으기\"라는 말만 심기","min":3},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["가르기는 모으기와 무엇이 반대예요?"],"watch":"한 묶음 → 두 묶음","min":2},
        "title": "이번 단원에서 배울 것 ②",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["오늘 아침에 무엇이 합쳐졌어요? 덜어진 건?"],"watch":"\"급식 반찬\" \"친구가 와서\"처럼 생활 예를 수로 바꾸기","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["합치면 무조건 9가 넘을까?"],"watch":"2와 3을 모으면 5 — 작은 수끼리도 모음","min":2},
        "title": "이런 생각을 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "multi",
      "data": {
        "tnote": {"ask":["이건 합치는 이야기예요, 덜어내는 이야기예요? 왜?"],"watch":"\"더 왔다·모았다\"와 \"갔다·먹었다\" 낱말 짚기","min":3},
        "title": "합치는 상황을 모두 골라요",
        "expectedCount": 2,
        "options": [
          {
            "label": "두 바구니의 귤을 한 상자에 담기",
            "correct": true
          },
          {
    ...
    },
    {
      ...
      "data": {
        "tnote": {"ask":["교실에서 합쳐지는 것 하나, 나눠지는 것 하나 찾아볼까?"],"watch":"붙임쪽지에 수를 같이 쓰게","min":4},
        "title": "교실 속 모으기·가르기 찾기",
        "tag": "모둠 활동",
        "icon": "🔍",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🥕",
          "body": "민지는 당근을 2개 뽑았고, 준서는 4개를 뽑았어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "items": [
          ...
          {
            "q": "사과 4개와 꽃 5송이 중 많은 것은?",
            "a": "꽃"
          },
          {
            "q": "수를 셀 때 어떻게 세면 좋을까요?",
            "a": "하나씩 빠짐없이"
          }
        ],
        "self": [
    ...
    },
    {
      ...
      "data": {
        "title": "다음 시간엔",
        "preview": "두 묶음을 하나로 합치는 **모으기**, 그리고 거꾸로 나누는 **가르기**를 본격적으로 배워요.",
        "emoji": "🧺"
      }
    }
  ],
  "extras": [
    {
      ...
      "type": "video",
      "icon": "🎥",
      "title": "수 세기 노래로 준비 운동",
      "url": "https://www.youtube.com/results?search_query=%EC%B4%88%EB%93%B1+1%ED%95%99%EB%85%84+%EC%88%98+%EC%84%B8%EA%B8%B0+%EB%85%B8%EB%9E%98",
      "description": "밭 채소를 세기 전, 1부터 9까지 수 세기를 노래로 다시 떠올려요. 도입 흥미 유발.",
    ...
    },
    {
      ...
      "type": "fun_question",
      "icon": "💡",
      "title": "우리 집 밥상에서 채소 찾기",
      "content": "어젯밤 밥상에 오른 채소를 떠올려 봐요. 토마토·오이·당근… 종류별로 몇 개였는지 세어 볼 수 있을까요?",
      "fit_slides": [
        "motivate",
        "real_world"
      ]
    },
    {
      ...
      "type": "fun_question",
      "icon": "💡",
      "title": "한꺼번에 세면 왜 빠를까요?",
      "content": "채소를 하나씩 따로 셀 때와, 종류별로 모아 한꺼번에 셀 때 무엇이 더 빠를까요? 왜 그럴까요?",
      "fit_slides": [
        "concept",
        "motivate"
      ]
    },
    {
      ...
      "icon": "🧩",
      "title": "빠짐없이 세는 일대일대응",
      "content": "센 것에는 손가락이나 동그라미로 표시해요. 표시하며 세면 두 번 세거나 빠뜨리는 실수를 막을 수 있어요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "type": "tip",
      "icon": "🧩",
      "title": "단원 도입은 점수보다 흥미",
      "content": "단원 도입 차시는 정답을 맞히는 것보다, 모으기·세기에 흥미를 갖게 하는 것이 목표예요. 자유롭게 말하도록 기다려 주세요.",
      "fit_slides": [
        "motivate",
        "summary"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "시장·마트의 채소 코너",
      "content": "마트 채소 코너에서는 같은 채소를 한곳에 모아 두어요. 모아 두면 세기도 쉽고 고르기도 편하기 때문이에요.",
      "fit_slides": [
        "real_world",
        "concept"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "급식 반찬 수 세기",
      "content": "오늘 급식에 반찬이 몇 가지였나요? 종류별로 세어 보면 우리 생활 곳곳에 수 세기가 있다는 걸 알 수 있어요.",
      "fit_slides": [
        "real_world",
        "motivate"
      ]
    },
    {
      ...
      "icon": "🎮",
      "title": "채소와 수 짝짓기",
      "description": "채소 그림과 그 개수를 나타내는 수를 짝지어 보세요.",
      "hint": "채소를 하나씩 세어 보고 같은 수를 찾아요.",
      "pairs": [
        {
          "a": {
            "emoji": "🍅🍅🍅",
    ...
    },
    {
      ...
      "type": "book",
      "icon": "📖",
      "title": "『텃밭에서 만난 수』 같은 자연 수 그림책",
      "content": "밭·정원에서 채소와 열매를 세며 수를 익히는 그림책. 단원 도입 분위기와 잘 어울려요.",
      "source": "도서관 그림책 코너에서 자연·수 주제로 확인",
      "fit_slides": [
        "motivate",
        "summary"
      ]
    },
    {
      ...
      "icon": "❓",
      "title": "오개념 — 큰 것이 더 많다?",
      "content": "큰 채소가 작은 채소보다 항상 많다고 생각하는 경우가 있어요. 크기와 개수는 다른 것임을 그림으로 비교해 보여 주세요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "⬆",
      "title": "다음 단원 미리 보기",
      "content": "오늘 모아 센 경험은 다음 시간 모으기와 가르기로 이어져요. 모으면 더 많아지고, 가르면 둘로 나뉘어요.",
      "fit_slides": [
        "next_lesson"
      ]
    },
    {
      ...
      "icon": "🧩",
      "title": "아이 말 끝까지 듣기",
      "content": "도입에서는 틀린 답이라도 끝까지 들어 주세요. 왜 그렇게 생각했는지 물으면 다음 개념으로 자연스럽게 이어집니다.",
      "fit_slides": [
        "motivate"
      ]
    }
...
LESSONS["u3_l02"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["빨강 바구니 몇 개? 노랑 바구니 몇 개?"],"watch":"두 묶음을 따로 먼저 세게","min":2},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["모은 뒤에 다시 세면 몇이에요? 처음 두 수하고 무슨 관계?"],"watch":"3과 2 → 5 를 \"3과 2를 모으면 5\"로 말하기","min":3},
        "title": "이제 한 상자에 모아요",
    ...
    },
    {
      ...
      "block": "visual_demo",
      "data": {
        "tnote": {"ask":["십 배열판에서 3과 2를 모으면 몇 칸이 차요?"],"watch":"두 색으로 놓으면 한눈에","min":2},
        "title": "십 배열판으로 보면",
        "items": [
          {
            "ten_frame": 3,
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["한쪽만 세고 \"3!\" 하면 뭐가 빠진 거예요?"],"watch":"두 묶음 다 넣기","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["모으기를 하면 수가 커질까, 작아질까? 왜?"],"watch":"\"더 생기니까\" — 단, 0을 모으면 그대로(11차시 예고 아님, 나오면 인정만)","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "data": {
        "tnote": {"ask":["3과 4를 배열판에 놓으면 몇 칸? 5칸 넘어가요?"],"watch":"5 기준으로 보기","min":4},
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🐤",
          "body": "병아리 6마리가 마당에 있어요. 한 마리가 더 왔어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🚌",
          "body": "버스에 5명이 타고 있어요. 정류장에서 2명이 더 탔어요. 버스에는 모두 몇 명이 있을까요?"
        },
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["5개를 두 바구니에 나누면 몇 개씩? 다른 방법도 있어요?"],"watch":"가르기 여러 가지 → 다음 차시로","min":3},
        "title": "거꾸로! 가르기",
    ...
    },
    {
      ...
      "data": {
        "title": "다음 시간엔",
        "preview": "모으기와 반대! 한 묶음을 둘로 나누는 **가르기**를 배워요.",
        "emoji": "✂️"
      }
    }
  ],
  "extras": [
    {
      ...
      "icon": "🎥",
      "title": "모으기와 가르기 영상",
      "url": "https://www.youtube.com/results?search_query=%EC%B4%88%EB%93%B1+1%ED%95%99%EB%85%84+%EB%AA%A8%EC%9C%BC%EA%B8%B0+%EA%B0%80%EB%A5%B4%EA%B8%B0",
      "description": "두 수를 모으고 한 수를 가르는 과정을 그림으로 보여 주는 영상. 개념 도입에 활용.",
      "source": "유튜브 검색 (교사 사전 확인 권장)",
      "fit_slides": [
        "motivate",
        "review"
    ...
    },
    {
      ...
      "icon": "💡",
      "title": "간식을 모으면?",
      "content": "사탕 3개와 2개를 한 봉지에 모으면 모두 몇 개일까요? 직접 손가락으로 모아 세어 봐요.",
      "fit_slides": [
        "motivate",
        "concept"
      ]
    },
    {
      ...
      "icon": "💡",
      "title": "어떻게 갈라 줄까요?",
      "content": "사탕 6개를 동생과 나누어 가지려고 해요. 어떻게 가르면 좋을까요? 가르는 방법은 여러 가지예요.",
      "fit_slides": [
        "concept",
        "real_world"
      ]
    },
    {
      ...
      "type": "tip",
      "icon": "🧩",
      "title": "모으기·가르기는 반대 과정",
      "content": "모으기는 둘을 하나로, 가르기는 하나를 둘로 만들어요. 같은 그림을 양방향으로 보여 주면 관계가 한눈에 들어와요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "type": "tip",
      "icon": "🧩",
      "title": "구체물로 먼저, 수로 나중에",
      "content": "공깃돌이나 블록으로 직접 모으고 가른 뒤 수로 적게 하면 개념이 더 단단해져요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "식탁에서 수저 모으기",
      "content": "식탁을 차릴 때 수저를 모으고, 먹고 나서 나누어 정리해요. 모으기·가르기는 집에서도 자주 일어나요.",
      "fit_slides": [
        "real_world",
        "concept"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "편 나누기",
      "content": "놀이할 때 친구들을 두 편으로 갈라요. 6명을 3명과 3명으로, 또는 4명과 2명으로. 이것도 가르기예요.",
      "fit_slides": [
        "real_world",
        "concept"
      ]
    },
    {
      ...
      "icon": "🎮",
      "title": "5 모으기 짝짓기",
      "description": "모으면 5가 되는 두 수를 짝지어 보세요.",
      "hint": "두 수를 더해 5가 되는 짝을 찾아요.",
      "pairs": [
        {
          "a": {
            "text": "1과 4"
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "6 가르기 짝짓기",
      "description": "6을 두 수로 가른 짝을 찾아보세요.",
      "hint": "6을 둘로 가르는 여러 방법을 떠올려요.",
      "pairs": [
        {
          "a": {
            "text": "6"
    ...
    },
    {
      ...
      "icon": "📖",
      "title": "『사과가 쿵!』",
      "content": "열매가 하나씩 늘어나는 단순한 구조로 모으기 감각을 길러요.",
      "source": "도서관 그림책 코너에서 확인",
      "fit_slides": [
        "motivate",
        "concept"
      ]
    },
    {
      ...
      "type": "misconception",
      "icon": "❓",
      "title": "오개념 — 가르기는 답이 하나?",
      "content": "6을 가르는 방법이 하나뿐이라고 생각하는 경우가 있어요. 1과 5, 2와 4, 3과 3처럼 여러 가지임을 보여 주세요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "⬆",
      "title": "9까지 넓혀 보기",
      "content": "오늘은 작은 수로 연습했어요. 다음 시간에는 9까지의 수로 모으기·가르기를 해 봐요.",
      "fit_slides": [
        "next_lesson"
      ]
    }
...
LESSONS["u3_l03"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["사탕 5개를 둘이 나누는 방법이 한 가지뿐일까?"],"watch":"\"똑같이\"만 생각하는 아이 — 2와 3도, 1과 4도","min":3},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["5를 가르는 방법이 몇 가지예요?"],"watch":"1·4, 2·3, 3·2, 4·1 — 순서 바뀐 것도 세는지는 s09에서","min":3},
        "title": "5 가르기 — 방법 ②, ③",
        "items": [
          {
            "emoji": "🍬",
    ...
    },
    {
      ...
      "block": "interactive_ten_frame",
      "data": {
        "tnote": {"ask":["6을 배열판에서 갈라 볼까? 한쪽이 커지면 다른 쪽은?"],"watch":"한쪽 +1 → 다른 쪽 -1","min":4},
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["가르기 짝에서 한쪽이 커지면 다른 쪽은 어떻게 돼요?"],"watch":"\"전체는 그대로\"라는 말이 나오면 최고","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["\"3과 2\"와 \"2와 3\"은 같은 걸까요, 다른 걸까요?"],"watch":"누가 3개를 갖느냐가 다름 — 이야기로","min":3},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "basic_problem",
      "data": {
        "tnote": {"ask":["다른 접시에 몇 개를 담아야 해요? 어떻게 알았어요?"],"watch":"전체에서 한쪽을 세고 남은 것","min":2},
        "title": "빈칸 가르기",
        "scenario": {
          "icon": "🥚",
          "body": "달걀 9개를 두 접시에 나눠 담아요. 한 접시에 5개를 담았어요."
        },
    ...
    },
    {
      ...
      "block": "real_world",
      "data": {
        "tnote": {"ask":["남은 자리에 몇 명이 앉을 수 있어요?"],"watch":"생활 속 가르기","min":2},
        "title": "우리 생활 속 가르기",
        "scenario": {
          "icon": "🚌",
          "body": "체험학습 버스 자리가 한 줄에 4칸이에요. 우리 모둠 4명 중 2명이 앉았어요."
        },
    ...
    },
    {
      ...
      "data": {
        "title": "오늘 배운 것",
        "points": [
          "한 수는 **여러 가지 방법**으로 가를 수 있다 (5는 1과4, 2와3, 3과2, 4와1).",
    ...
    },
    {
      ...
      "data": {
        ...
        "levels": {
          ...
          "심화": {
            "q": "8을 두 묶음으로 가르는 방법을 여러 가지 말해 봐요.",
            "a": "여러 답 (예: 6과 2, 5와 3)",
            "open": true
          }
        }
    ...
    },
    {
      ...
      "data": {
        "title": "다음 시간엔",
        "preview": "모으기·가르기 상황으로 **수학 이야기**를 직접 만들어 봐요. 그림을 보고 말로 풀어내는 시간!",
        "emoji": "📖"
      }
    }
  ],
  "extras": [
    {
      ...
      "type": "video",
      "icon": "🎥",
      "title": "연결 모형으로 수 나타내기",
      "url": "https://www.youtube.com/results?search_query=%EC%97%B0%EA%B2%B0%ED%81%90%EB%B8%8C+%EB%AA%A8%EC%9C%BC%EA%B8%B0+%EA%B0%80%EB%A5%B4%EA%B8%B0",
      "description": "연결 모형(큐브)으로 수를 만들고 모으고 가르는 과정을 보여 주는 영상.",
      "source": "유튜브 검색 (교사 사전 확인 권장)",
      "fit_slides": [
        "motivate",
        "review"
    ...
    },
    {
      ...
      "icon": "💡",
      "title": "8을 어떻게 가를까요?",
      "content": "달걀 8개를 두 바구니에 나누어 담으려고 해요. 몇 개와 몇 개로 가를 수 있을까요? 가능한 방법을 모두 말해 봐요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "💡",
      "title": "9는 몇 가지로 가를까요?",
      "content": "9를 두 수로 가르는 방법을 친구와 번갈아 말해 봐요. 누가 더 많이 찾을 수 있을까요?",
      "fit_slides": [
        "concept",
        "game"
      ]
    },
    {
      ...
      "icon": "🧩",
      "title": "가르기 표로 규칙 보기",
      "content": "9 가르기를 1과 8, 2와 7… 순서대로 적으면 한쪽이 1씩 줄고 다른 쪽이 1씩 느는 규칙이 보여요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "🧩",
      "title": "0도 가르기에 들어가요",
      "content": "9는 0과 9로도 가를 수 있어요. 한쪽이 0이면 다른 쪽이 전부라는 뜻이에요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "달걀판에서 가르기",
      "content": "달걀 한 판을 두 칸으로 나누어 담아 보면 가르기를 손으로 익힐 수 있어요.",
      "fit_slides": [
        "real_world",
        "concept"
      ]
    },
    {
      ...
      "icon": "🌍",
      "title": "의자 나누어 놓기",
      "content": "교실 의자 9개를 두 모둠으로 나누어 놓을 때도 가르기를 써요. 4개와 5개, 3개와 6개처럼요.",
      "fit_slides": [
        "real_world",
        "concept"
      ]
    },
    {
      ...
      "icon": "🎮",
      "title": "9 가르기 짝짓기",
      "description": "9를 두 수로 가른 짝을 모두 찾아보세요.",
      "hint": "한쪽 수를 보고 나머지가 얼마인지 생각해요.",
      "pairs": [
        {
          "a": {
            "text": "9는 1과"
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "8 모으기 짝짓기",
      "description": "모으면 8이 되는 두 수를 짝지어 보세요.",
      "hint": "두 수를 더해 8이 되는 짝을 찾아요.",
      "pairs": [
        {
          "a": {
            "text": "3과 5"
    ...
    },
    {
      ...
      "icon": "📖",
      "title": "수 가르기 그림책",
      "content": "수를 여러 방법으로 나누는 이야기를 담은 그림책으로 가르기의 다양성을 느껴요.",
      "source": "도서관에서 수·나눔 주제로 확인",
      "fit_slides": [
        "concept",
        "summary"
      ]
    },
    {
      ...
      "type": "misconception",
      "icon": "❓",
      "title": "오개념 — 3과 5는 5와 3과 다르다?",
      "content": "모으기에서 3과 5, 5와 3은 합이 같아요. 순서를 바꿔도 모은 수는 같다는 것을 짚어 주세요.",
      "fit_slides": [
        "concept"
      ]
    },
    {
      ...
      "icon": "⬆",
      "title": "다음은 이야기 만들기",
      "content": "모으기·가르기를 그림 이야기로 만들면 덧셈·뺄셈으로 이어져요. 다음 시간에 해 봐요.",
      "fit_slides": [
        "next_lesson"
      ]
    }
...
LESSONS["u3_l04"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["연못에 무슨 일이 일어났어요? 이야기로 말해 볼까?"],"watch":"있었다→생겼다→되었다 세 토막","min":3},
    ...
    },
    {
      ...
      "tnote": {
        "ask": [
          "그림 속 이야기를 수로 어떻게 말할까?",
          "이야기에 꼭 들어가는 세 가지가 뭐예요?"
        ],
        "watch": "그림 → 수 이야기 옮기기 · ①있었나 ②생겼나 ③되었나",
        "min": 3
      }
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["수가 늘어나는 말에는 뭐가 있어요?"],"watch":"더 오다·모으다·모두","min":2},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["수가 줄어드는 말은요?"],"watch":"가다·먹다·남다","min":2},
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["\"2마리가 더 왔다\"인데 왜 빼면 안 돼요?"],"watch":"낱말(더 왔다)로 판단","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["사과 6개 그림 하나로 더하는 이야기도, 빼는 이야기도 만들 수 있어요?"],"watch":"같은 그림·다른 이야기 — 정답 여러 개","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🍪",
          "body": "접시에 쿠키가 7개 있었어요. 동생이 2개를 먹었어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "options": [
          ...
          {
            "label": "빨강 풍선 4개와 파랑 풍선 3개를 모았어요",
            "correct": true
          },
          {
            "label": "버스에서 5명이 내렸어요"
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["짝이 만든 이야기는 더하는 이야기였어요, 빼는 이야기였어요?"],"watch":"듣고 판단하기","min":4},
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🚌",
          "body": "버스에 6명이 타고 있었어요. 정류장에서 2명이 더 탔어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🐟",
          "body": "어항에 물고기 4마리가 있었어요. 3마리가 더 들어왔어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "levels": {
          "기본": {
            "q": "다람쥐 5마리가 있고 3마리가 더 왔어요. 모두 몇 마리?",
            "a": "8마리",
            "steps": [
              "5와 3을 모으기 → 8"
            ]
          ...
          "도전": {
            "q": "연못에 물고기가 7마리 헤엄쳐요. 이야기를 수로 말하면?",
            "a": "7마리",
            "steps": [
              "그림 속 수 = 7"
            ]
          ...
          "심화": {
            "q": "그림을 보고 모으기 이야기를 만들어 식으로 말해 봐요.",
            "a": "여러 답 (예: 5와 3 → 8)",
            "open": true
          }
        }
  ...
  "extras": [
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "이야기 분류 짝짓기",
      "description": "이야기 문장과 '더하기/빼기' 종류를 짝지어 보세요.",
      "hint": "늘어나는 말인지 줄어드는 말인지 찾아요.",
      "pairs": [
        {
          "a": {
            "text": "2마리가 더 왔어요"
...
LESSONS["u3_l05"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["벌은 모두 몇 마리? 이걸 짧게 쓸 수 없을까?"],"watch":"\"3하고 2 더하면 5\" → 기호 도입 동기","min":3},
    ...
    },
    {
      ...
      "tnote": {
        "ask": [
          "＋와 ＝ 기호는 무엇을 나타낼까?",
          "더하기 기호는 어떻게 생겼어요? 무슨 뜻?"
        ],
        "watch": "기호로 덧셈식 읽고 쓰기 · + = 더 오다·모으다",
        "min": 3
      }
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["= 는 무슨 뜻이에요?"],"watch":"\"답이 나온다\"가 아니라 \"같다\"","min":3},
        "title": "'모두'를 = 로 써요",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["= 오른쪽엔 아무 수나 써도 돼요?"],"watch":"양쪽이 같아야 함","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["3 + 2 와 2 + 3 은 답이 같을까?"],"watch":"벌 그림 순서 바꿔 세기","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "basic_problem",
      "data": {
        "tnote": {"ask":["사과 4개에 2개 더하면 식으로 어떻게 써요?"],"watch":"4 + 2 = 6 — 순서대로 읽기","min":2},
        "title": "식으로 쓰고 답을 구해요",
        "items": [
          {
            "emoji": "🍎",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🐥",
          "body": "병아리 5마리가 있는데 3마리가 더 왔어요. 식으로 쓰면 5 + 3 = ?"
        },
        "question": "5 + 3 = 몇일까요?",
        "input": "count_input",
        "answer": 8,
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["카드 두 장으로 식을 만들면 짝이 뭘 확인해 줘요?"],"watch":"답이 맞는지 배열판으로","min":4},
        "title": "덧셈식 카드 놀이",
        "tag": "짝 활동",
        "icon": "🃏",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🚌",
          "body": "버스에 4명이 타고 있었는데 정류장에서 3명이 더 탔어요."
        },
...
LESSONS["u3_l06_07"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["딸기를 빠르게 세는 방법이 있을까?"],"watch":"\"4부터 5, 6, 7\"이 나오면 이어 세기 이름 붙이기","min":3},
    ...
    },
    {
      ...
      "tnote": {
        "ask": [
          "두 수의 순서를 바꾸면 답이 달라질까?"
        ],
        "watch": "이어 세기·순서 바꿔 더하기",
        "min": 3
      }
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["모두 세기는 어디서부터 세요?"],"watch":"1부터 끝까지","min":2},
        "title": "① 모두 세기",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["이어 세기는 어디서 시작해요? 몇 번 더 세요?"],"watch":"4에서 시작, 3번","min":3},
        "title": "② 이어 세기",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["4 + 3 과 3 + 4, 어느 쪽이 세기 편해요?"],"watch":"큰 수부터 이어 세면 빠름","min":3},
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["4 + 3 을 4, 5, 6, 7, 8로 세면 뭐가 잘못됐어요?"],"watch":"시작 수를 또 셈","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["6 + 1 은 어떤 방법이 가장 빨라요?"],"watch":"이어 세기 한 번","min":2},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "basic_problem",
      "data": {
        "tnote": {"ask":["6 + 2, 큰 수부터 이어 세 볼까? 몇부터?"],"watch":"\"6!\" 하고 7, 8","min":2},
        "title": "이어 세기로 풀어요",
        "items": [
          {
            "emoji": "🍎",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🥚",
          "body": "달걀을 2 + 5 로도, 5 + 2 로도 셀 수 있어요."
        },
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["왼손 3개 오른손 4개면 식 두 개를 말해 볼까?"],"watch":"3+4=7, 4+3=7","min":4},
        "title": "공깃돌 두 식 놀이",
        "tag": "짝 활동",
        "icon": "🪨",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🚌",
          "body": "버스에 7명이 타고 있었는데 2명이 더 탔어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "levels": {
          ...
          "심화": {
            "q": "순서를 바꿔도 답이 같은 덧셈을 하나 더 만들어 봐요.",
            "a": "여러 답 (예: 3＋4 = 4＋3)",
            "open": true
          }
        }
  ...
  "extras": [
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "자리 바꾼 식 짝짓기",
      "description": "답이 같은(자리만 바꾼) 식끼리 짝지어 보세요.",
      "hint": "두 수의 자리만 다르고 합은 같아요.",
      "pairs": [
        {
          "a": {
            "text": "2 + 6"
...
LESSONS["u3_l08"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["딸기를 먹으면 남은 건 몇 개? 짧게 쓸 수 있을까?"],"watch":"\"7에서 2 먹으면 5\"","min":3},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["7 - 2 = 5 를 읽어 볼까?"],"watch":"\"7 빼기 2는 5\" — \"7 마이너스\"는 아직","min":2},
        "title": "남은 수를 = 로 써요",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["7 - 2 를 2 - 7 로 쓰면 왜 안 돼요?"],"watch":"처음 있던 수가 앞","min":3},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["3 + 2 = 5 를 보고 뺄셈식도 만들 수 있을까?"],"watch":"5 - 2 = 3 — 가르기와 연결","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["가르기와 뺄셈은 무엇이 같아요?"],"watch":"5는 3과 2 = 5-2=3","min":2},
        "title": "가르기가 뺄셈이에요",
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["몇 개가 사라졌어요? 식으로 말해 볼까?"],"watch":"\"몇 - 몇 = 몇\" 세 수 다 말하기","min":4},
        "title": "사라진 물건 놀이",
        "tag": "짝 활동",
        "icon": "🫳",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🚌",
          "body": "버스에 8명이 타고 있었는데 정류장에서 3명이 내렸어요."
        },
...
LESSONS["u3_l09_10"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["오이 남은 걸 빠르게 아는 방법이 있을까?"],"watch":"\"9부터 거꾸로\"가 나오면 이름 붙이기","min":3},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["거꾸로 세기는 어디서 시작해요? 몇 번?"],"watch":"9에서 시작, 3번 → 6","min":3},
        "title": "① 거꾸로 세기",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["9 - 3 = 6 이 맞는지 덧셈으로 어떻게 확인해요?"],"watch":"6 + 3 = 9","min":3},
        "title": "③ 덧셈으로 확인해요",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["9, 8, 7, 6, 5로 세면 뭐가 잘못됐어요?"],"watch":"시작 수 또 셈","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["8 - 1 은 어떤 방법이 빨라요? 8 - 7 은요?"],"watch":"8-7은 \"7에서 8까지 하나\"로 세는 게 빠름","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["누가 몇 개 더 많아요? 이것도 뺄셈이에요?"],"watch":"차이 = 뺄셈","min":3},
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["한 명 일어나면 몇 - 몇 = 몇?"],"watch":"남은 사람 수를 식으로","min":4},
        "title": "의자 앉기 뺄셈 놀이",
        "tag": "모둠 활동",
        "icon": "🪑",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🍪",
          "body": "쿠키 8개가 있었는데 친구들과 5개를 먹었어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "levels": {
          ...
          "심화": {
            "q": "뺄셈 하나를 골라 덧셈으로 확인해 봐요.",
            "a": "여러 답 (예: 9－4＝5 → 5＋4＝9)",
            "open": true
          }
        }
      },
...
LESSONS["u3_l11"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["빈 접시의 콩은 몇 개예요?"],"watch":"0","min":2},
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["4개에 0개를 더하면 몇 개?"],"watch":"그대로 4","min":2},
        "title": "0을 더하면 그대로",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["5개에서 0개를 빼면?"],"watch":"아무것도 안 뺌 → 5","min":2},
        "title": "0을 빼도 그대로",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["3개를 3개 다 빼면?"],"watch":"0 — 같은 수 빼면 0","min":2},
        "title": "모두 빼면 0",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["4 + 0 이 0이라고 하면 뭐가 이상해요?"],"watch":"\"아무것도 안 더했는데 사라짐?\"","min":3},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["0 + 0 은? 7 - 7 은?"],"watch":"둘 다 0, 이유 말하기","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["주먹(0개)을 더하면 몇?"],"watch":"그대로","min":3},
        "title": "빈손 더하기 놀이",
        "tag": "짝 활동",
        "icon": "✋",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🪙",
          "body": "저금통에 동전 6개가 있는데 오늘은 한 개도 넣지 않았어요."
        },
  ...
  "extras": [
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "0 식 짝짓기",
      "description": "0이 있는 식과 답을 짝지어 보세요.",
      "hint": "0을 더하거나 빼면 그대로, 같은 수를 빼면 0.",
      "pairs": [
        {
          "a": {
            "text": "5 + 0"
...
LESSONS["u3_l12"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["6을 만드는 식을 몇 가지나 만들 수 있을까?"],"watch":"덧셈·뺄셈 둘 다","min":3},
    ...
    },
    {
      ...
      "tnote": {
        "ask": [
          "세 수는 어떤 순서로 계산할까?",
          "6이 되는 덧셈식을 하나 말해 볼까? 또?"
        ],
        "watch": "앞에서부터 차례로 계산 · 1+5 … 5+1",
        "min": 3
      }
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["빼서 6이 되는 식은?"],"watch":"7-1, 8-2, 9-3 — 9까지라 세 개","min":2},
        "title": "6이 되는 뺄셈식",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["식을 풀 때 가장 먼저 볼 것은?"],"watch":"가운데 기호","min":2},
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["5 - 2 를 7이라고 하면 뭘 잘못 본 거예요?"],"watch":"기호","min":2},
        "title": "이런 실수를 조심해요",
        "label": "자주 하는 실수",
    ...
    },
    {
      ...
      "block": "question",
      "data": {
        "tnote": {"ask":["답이 7인 식은 덧셈이 많을까, 뺄셈이 많을까?"],"watch":"9까지라 뺄셈은 8-1, 9-2 둘","min":3},
        "title": "같이 생각해 봐요",
    ...
    },
    {
      ...
      "block": "offline_activity",
      "data": {
        "tnote": {"ask":["오늘의 수는 8! 식을 하나씩 번갈아 말해 볼까?"],"watch":"겹치지 않게","min":4},
        "title": "오늘의 수 만들기 놀이",
        "tag": "모둠 활동",
        "icon": "🎯",
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🍬",
          "body": "사탕 5개가 있었는데 3개를 더 받고, 그중 2개를 먹었어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🐢",
          "body": "연못에 거북 4마리가 있었는데 3마리가 더 오고, 2마리가 물속으로 갔어요."
        },
  ...
  "extras": [
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "같은 답 식 짝짓기",
      "description": "답이 같은 덧셈식과 뺄셈식을 짝지어 보세요.",
      "hint": "양쪽을 각각 풀어 답을 비교해요.",
      "pairs": [
        {
          "a": {
            "text": "2 + 3"
...
LESSONS["u3_l13"] =
{
  ...
  "slides": [
    ...
    },
    {
      ...
      "block": "motivate",
      "data": {
        "tnote": {"ask":["3단원에서 가장 자신 있는 건? 더 연습할 건?"],"watch":"솔직하게","min":2},
    ...
    },
    {
      ...
      "tnote": {
        "ask": [
          ...
          "3과 2를 모으면? 5는 3과 몇으로 갈라요?"
        ],
        "watch": "덧셈·뺄셈 종합 확인 · 모으기·가르기 짝",
        "min": 3
      }
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["덧셈은 어떤 상황이에요? 빠른 방법은?"],"watch":"큰 수부터 이어 세기","min":2},
        "title": "② 덧셈을 떠올려요",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["뺄셈은? 답 확인은 어떻게?"],"watch":"덧셈으로","min":2},
        "title": "③ 뺄셈을 떠올려요",
    ...
    },
    {
      ...
      "block": "concept",
      "data": {
        "tnote": {"ask":["4 + 0 은? 4 - 4 는?"],"watch":"4, 0","min":2},
        "title": "④ 0이 있는 식",
    ...
    },
    {
      ...
      "block": "misconception",
      "data": {
        "tnote": {"ask":["세 가지 실수 중 내가 한 적 있는 건?"],"watch":"자기 점검","min":3},
        "title": "점검! 이런 실수 없었나요?",
        "label": "단원 빈출 실수",
    ...
    },
    {
      ...
      "data": {
        ...
        "levels": {
          ...
          "심화": {
            "q": "이 단원에서 배운 것으로 나만의 덧셈·뺄셈 문제를 내 봐요.",
            "a": "여러 답",
            "open": true
          }
        }
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🌷",
          "body": "화단에 빨강 꽃 4송이와 노랑 꽃 3송이가 피었어요."
        },
    ...
    },
    {
      ...
      "data": {
        ...
        "scenario": {
          "icon": "🐸",
          "body": "연못에 개구리 8마리가 있었는데 3마리가 뛰어 나갔어요."
        },
    ...
    },
    {
      ...
      "block": "advanced_problem",
      "data": {
        "tnote": {"ask":["농장 그림에서 덧셈식 하나, 뺄셈식 하나 만들어 볼까?"],"watch":"이야기 → 식","min":3},
        "title": "농장에서 식을 만들어요",
    ...
    },
    {
      ...
      "data": {
        ...
        "type": "pair",
        "icon": "🧮",
        "goal": "덧셈·뺄셈 식을 서로 내고 확인해요.",
        "steps": [
          "수 카드 두 장을 뽑아 덧셈식을 만들어 말해요.",
          "짝이 이어 세기로 답을 확인해요.",
          "큰 카드에서 작은 카드를 빼는 뺄셈식도 만들어요.",
          "덧셈으로 답을 확인하고 역할을 바꿔요."
        ],
        "materials": [
          "수 카드 0~9"
        ],
  ...
  "extras": [
    ...
    },
    {
      ...
      "icon": "🎮",
      "title": "단원 식 짝짓기",
      "description": "여러 가지 식과 답을 짝지어 단원을 정리해요.",
      "hint": "덧셈·뺄셈·0 식을 골고루 풀어 봐요.",
      "pairs": [
        {
          "a": {
            "text": "4 + 4"
