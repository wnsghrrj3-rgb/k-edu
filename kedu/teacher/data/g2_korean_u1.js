  ...
  window.LESSONS["u1_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"새 친구가 많아! 어떻게 말을 걸지?\""},{"face":"👦","label":"두리 \"먼저 잘 들어 주면 친해질 것 같아.\""}],
        "tnote": {"ask":["새 친구와 잘 지내려면 어떻게 말하고 들어야 할까?"],"watch":"\"잘 듣기\"가 먼저 나오게","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["새 친구와 친해지려면 무엇부터 하면 좋을까?","친구가 말하는 중에 하고 싶은 말이 떠오르면 어떻게 할까?"],"watch":"경청·인사 태도 열기 · 끝까지 듣고 내 차례에","min":4},
          "title": "잘 듣고 잘 말하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["카드 세 장 중 가장 지키기 어려운 건 어느 거야?"],"watch":"눈 마주치기·기다리기·반응","min":4},
          "title": "바른 듣기 태도는? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["짝에게 인사하고 이름을 말해 볼까? 짝은 어떤 자세로 들을까?"],"watch":"바라보며 듣기","min":5},
          "title": "친구와 인사를 나눠요 🎤",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["친구 말이 끝났는지 어떻게 알 수 있어?"],"watch":"말이 멈추고 나를 볼 때","min":5},
          "title": "반갑게 인사 나누기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["짝과 인사 나누기 활동에서 무엇이 가장 좋았어?"],"watch":"느낌 말하기","min":5},
          "tag": "👋 짝 활동",
          "title": "이름 인사 짝 놀이",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["오늘 배운 듣기 태도를 한 가지만 말해 볼까?"],"watch":"끼어들지 않기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "친구가 말할 때는 어떻게 하나요?",
  ...
  window.LESSONS["u1_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"나를 뭐라고 소개하지? 이름만?\""},{"face":"👦","label":"두리 \"좋아하는 것도 말해 주면 더 알 수 있을걸!\""}],
        "tnote": {"ask":["친구들에게 나에 대해 무엇을 말해 주면 좋을까?"],"watch":"이름·좋아하는 것·잘하는 것·꿈","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["나를 소개한다면 무엇부터 말하고 싶어?","읽는 사람이 궁금해할 내용이란 어떤 걸까? \"어제 뭐 먹었는지\"도?"],"watch":"소개 항목 떠올리기 · 나를 알려 주는 것","min":4},
          "title": "소개하는 글에 담는 것",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["소개 글에 어울리지 않는 카드는 왜 그럴까?"],"watch":"나를 알려 주지 않음","min":4},
          "title": "소개 글에 들어갈 내용은? 🤔",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["나는 무엇을 소개하고 싶어? 한 가지만 골라 볼까?"],"watch":"고른 까닭도","min":5},
          "title": "소개할 내용을 떠올려요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"저는 그림 그리기를 좋아합니다\"는 나의 무엇을 알려 줘?"],"watch":"좋아하는 것","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝과 소개 항목을 모으니 몇 가지가 됐어?"],"watch":"항목 이름으로","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["소개 글을 읽으면 무엇을 알 수 있어?"],"watch":"그 사람","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u1_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"나도 말할래! 나도!\""},{"face":"👧","label":"하나 \"다 같이 말하니까 하나도 안 들려…\""}],
        "tnote": {"ask":["여럿이 한꺼번에 말하면 왜 못 알아들을까? 어떻게 하면 될까?"],"watch":"한 사람씩","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["모두 한꺼번에 말하면 어떤 점이 불편할까?","\"말차례를 지킨다\"는 무슨 뜻일까?"],"watch":"말차례 개념·필요 이해 · 차례대로·끝나면 내 차례","min":4},
          "title": "말차례를 지켜요",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["카드 중 말차례를 지킨 모습은 어느 거야? 왜?"],"watch":"끝난 뒤 손 들기","min":4},
          "title": "말차례를 지킨 모습은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["짝과 번갈아 말할 때 내 차례를 어떻게 알 수 있을까?"],"watch":"짝 말이 끝났을 때","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["친구가 말할 때 끝까지 듣는 까닭은?"],"watch":"무슨 말인지 알려고","min":5},
          "title": "말차례 지켜 대화하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["말차례 놀이에서 차례를 안 지킨 순간이 있었어? 그때 어땠어?"],"watch":"느낌","min":5},
          "tag": "👋 짝 활동",
          "title": "말차례 대화 짝 놀이",
          "type": "pair",
          "goal": "순서를 지켜 대화해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["말차례를 지키려면 무엇을 해야 해?"],"watch":"기다렸다 말하기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "말차례란 무엇인가요?",
  ...
  window.LESSONS["u1_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"두리야, 내 이야기 듣고 있어?\""},{"face":"👦","label":"두리 \"응, 맞아! 그렇구나!\""}],
        "tnote": {"ask":["즐겁게 대화하려면 어떤 약속이 필요할까? 지난 시간 말차례 말고 또?"],"watch":"바라보기·고운 말·반응","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["친구와 즐겁게 대화하려면 어떤 약속이 필요할까?","\"맞아\", \"그렇구나\" 같은 반응이 왜 대화를 즐겁게 할까?"],"watch":"대화 약속 내면화 · 듣고 있다는 표시","min":4},
          "title": "바른 대화 약속",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["카드 세 장의 약속을 짝과 하나씩 몸으로 해 볼까?"],"watch":"바라보기·반응·고운 말","min":4},
          "title": "바른 대화 모습은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["말차례를 지켜 대화할 때 내가 잘한 점은?"],"watch":"자기 점검","min":5},
          "title": "말차례를 지켜 대화해요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"말하는 사람을 바라보며 듣습니다\"는 왜 바른 대화일까?"],"watch":"존중","min":5},
          "title": "바른 대화 약속 지키기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["우리 반 대화 약속 한 가지를 짝과 정해 볼까?"],"watch":"짧은 문장으로","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["약속을 지키면 대화가 어떻게 돼?"],"watch":"즐겁고 잘 통함","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "대화에는 무엇이 필요한가요?",
  ...
  window.LESSONS["u1_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"나는 이 글이 슬펐어.\""},{"face":"👦","label":"두리 \"난 재미있었는데? 생각이 다르네!\""}],
        "tnote": {"ask":["같은 글을 읽고도 하나와 두리 생각이 달라. 어떻게 나누면 좋을까?"],"watch":"까닭과 함께·존중","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["같은 글인데 왜 생각이 다를까?","내 생각을 말할 때 무엇을 함께 말해야 해?"],"watch":"생각의 다양성 존중 · 까닭","min":4},
          "title": "생각을 나누는 방법",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["친구 생각이 나와 다를 때 어떤 말을 하면 좋을까?"],"watch":"\"그렇게 생각할 수도 있구나\"","min":4},
          "title": "생각을 잘 나누는 모습은? ✅",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["글을 읽고 든 생각을 짝과 나눠 볼까? 같았어, 달랐어?"],"watch":"다름 존중","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["짧은 글을 읽고 어떤 생각이 들었어? 왜?"],"watch":"까닭","min":5},
          "title": "글 읽고 생각 나누기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 생각을 듣고 새로 알게 된 게 있었어?"],"watch":"들은 것 말하기","min":5},
          "tag": "👋 짝 활동",
          "title": "생각 나누기 짝 활동",
          "type": "pair",
          "goal": "서로 다른 생각을 존중해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["생각을 나눌 때 가장 중요한 마음은?"],"watch":"존중","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "같은 글을 읽어도 생각은?",
  ...
  window.LESSONS["u1_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"하나야, 왜 그렇게 생각했어?\""},{"face":"👧","label":"하나 \"질문해 주니까 더 말하고 싶어져!\""}],
        "tnote": {"ask":["\"왜 그렇게 생각해?\"라고 물으면 왜 생각이 깊어질까?"],"watch":"까닭을 말하게 됨","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["어떤 질문을 하면 이야기가 더 깊어질까?","좋은 질문과 좋은 반응은 무엇이 달라? 둘 다 왜 필요해?"],"watch":"질문·반응으로 대화 심화 · 궁금한 점·공감","min":4},
          "title": "질문하고 반응하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["아쉬운 반응 카드는 왜 아쉬울까?"],"watch":"무시·딴청","min":4},
          "title": "좋은 질문·반응은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["모둠 이야기에서 질문을 한 번, 반응을 한 번 해 볼까?"],"watch":"역할 나누기","min":5},
          "title": "모둠 이야기 나누기 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"왜 그렇게 생각했나요?\"는 어떤 도움이 될까?"],"watch":"까닭·깊이","min":5},
          "title": "질문하고 반응하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["질문 주고받기에서 어떤 질문이 제일 좋았어?"],"watch":"궁금한 마음","min":5},
          "tag": "👋 짝 활동",
          "title": "질문 주고받기 짝 놀이",
          "type": "pair",
          "goal": "질문으로 대화를 이어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["질문할 때 마음은 어떤 마음이어야 해?"],"watch":"궁금·존중","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u1_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"나를 소개하려는데 뭐부터 말하지?\""},{"face":"👦","label":"두리 \"이름, 좋아하는 것, 잘하는 것… 항목으로 정리해 봐!\""}],
        "tnote": {"ask":["나를 소개할 때 어떤 것부터 정리하면 좋을까?"],"watch":"항목별","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["나를 소개한다면 어떤 것부터 정리할까?","친구가 궁금해할 만한 것은 무엇일까? 까닭을 더하면 뭐가 좋아?"],"watch":"소개 항목 선별·정리 · 더 잘 전해짐","min":4},
          "title": "소개 내용 정리하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["소개에 어울리지 않는 카드는 왜 그럴까?"],"watch":"나와 상관없는 것","min":4},
          "title": "소개에 어울리는 내용은? 🤔",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["나는 무엇을 소개할지 두 가지만 정해 볼까?"],"watch":"고른 까닭","min":5},
          "title": "내 소개 내용을 정리해요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["이름·좋아하는 것·잘하는 것 중 어느 것을 넣을래?"],"watch":"고르기","min":5},
          "title": "소개할 내용 정리하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["소개 카드를 채우니 빈칸이 있었어? 무엇을 더 넣을까?"],"watch":"항목 채우기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["소개하기 전에 먼저 할 일은?"],"watch":"정리","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소개하기 전에 먼저 할 일은?",
  ...
  window.LESSONS["u1_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"저는 축구를 좋아합니다.\""},{"face":"👦","label":"두리 \"왜? 까닭도 말해 줘!\""}],
        "tnote": {"ask":["\"저는 축구를 좋아합니다\"에 까닭을 더하면 무엇이 달라져?"],"watch":"더 잘 전해짐","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["'좋아합니다'에 까닭을 더하면 무엇이 좋을까?","\"왜냐하면 ~기 때문입니다\"를 넣어 나를 소개해 볼까?"],"watch":"까닭 넣은 소개 표현 · 표현 익히기","min":4},
          "title": "소개하는 표현",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["아쉬운 소개 문장은 무엇이 빠졌을까?"],"watch":"까닭·바른 표현","min":4},
          "title": "바른 소개 문장은? ✅",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["소개 표현을 따라 쓸 때 어디에 까닭이 들어가?"],"watch":"두 번째 문장","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"이야기가 재미있기 때문입니다\"는 무엇을 말해 주는 문장이야?"],"watch":"까닭","min":5},
          "title": "까닭을 더해 소개하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 말한 소개에 까닭을 더해 다시 말해 볼까?"],"watch":"왜냐하면","min":5},
          "tag": "👋 짝 활동",
          "title": "까닭 더하기 짝 활동",
          "type": "pair",
          "goal": "소개에 까닭을 더해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["\"좋아합니다\"에 무엇을 더하면 좋아?"],"watch":"까닭","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소개에 까닭을 더하면?",
  ...
  window.LESSONS["u1_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"정리한 걸 글로 쓰려니 뭐부터 써야 하지?\""},{"face":"👧","label":"하나 \"인사부터! 그다음 이름, 그다음 좋아하는 것.\""}],
        "tnote": {"ask":["정리한 내용을 글로 쓸 때 어떤 순서가 좋을까?"],"watch":"인사→이름→내용→끝인사","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["소개 글을 어떤 순서로 쓰면 좋을까?","소개 글이 3~5문장 한 문단이면 왜 좋을까?"],"watch":"글 짜임 이해·쓰기 · 읽기 쉬움","min":4},
          "title": "소개 글의 짜임",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["처음·가운데·끝에 어울리는 문장을 짝과 골라 볼까?"],"watch":"짜임","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["첫 문장을 \"안녕하세요, 저는 ○○입니다\"로 써 볼까?"],"watch":"인사+이름","min":5},
          "title": "소개 글을 써요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["소개 글은 무엇으로 시작하면 좋을까?"],"watch":"처음=인사","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 글에서 순서가 바뀐 곳이 있었어?"],"watch":"짜임 점검","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["가운데에는 무엇을 쓰지?"],"watch":"소개할 내용과 까닭","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소개 글은 어떤 순서로 쓰나요?",
  ...
  window.LESSONS["u1_l10"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"발표하려니 떨려…\""},{"face":"👦","label":"두리 \"허리 펴고 앞을 보고 또박또박! 듣는 사람도 바른 자세!\""}],
        "tnote": {"ask":["친구들이 잘 들으려면 어떻게 발표하면 좋을까?"],"watch":"자세·목소리","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["친구들이 잘 들으려면 어떻게 발표할까?","발표 전에 글을 다시 읽으면 무엇을 찾을 수 있을까?"],"watch":"다듬기·바른 발표 · 어색한 곳","min":4},
          "title": "다듬고 발표하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["발표할 때와 들을 때 자세가 어떻게 달라?"],"watch":"카드 세 장","min":4},
          "title": "바른 발표 모습은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["발표해 볼까? 듣는 친구는 무엇을 볼까?"],"watch":"자세·목소리","min":5},
          "title": "소개 글을 발표해요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["발표할 때 목소리는 어떻게 하면 좋을까?"],"watch":"또박또박·크게","min":5},
          "title": "다듬고 바르게 발표하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 발표를 듣고 고칠 곳 한 군데를 말해 줄까?"],"watch":"고운 말로","min":5},
          "tag": "👋 짝 활동",
          "title": "발표 연습 짝 활동",
          "type": "pair",
          "goal": "바른 발표를 연습해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["들을 때는 어떻게 들어?"],"watch":"끝까지","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "발표 전에 글을 어떻게 하나요?",
  ...
  window.LESSONS["u1_l11"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"나는 우리 할머니를 소개하고 싶어!\""},{"face":"👧","label":"하나 \"할머니의 어떤 점을 알려 줄 거야?\""}],
        "tnote": {"ask":["소개하고 싶은 사람이 있어? 그 사람의 어떤 점을 알려 주고 싶어?"],"watch":"좋은 점·고마운 점","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["소개하고 싶은 사람의 어떤 점을 알려 주고 싶어?","주변 사람 소개와 나를 소개할 때 짜임이 어떻게 비슷해?"],"watch":"대상·내용 선정 · 누구·좋은 점·까닭","min":4},
          "title": "주변 사람 소개하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["소개하면 안 되는 카드는 왜 그럴까?"],"watch":"비밀·나쁜 점","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["소개할 사람을 정했어? 왜 그 사람이야?"],"watch":"까닭","min":5},
          "title": "소개 글을 써요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"우리 이모는 요리를 잘합니다\"는 그 사람의 무엇을 알려 줘?"],"watch":"잘하는 것","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝은 누구를 소개하기로 했어? 무슨 점?"],"watch":"듣고 말하기","min":5},
          "tag": "👋 짝 활동",
          "title": "누구를 소개할까 짝 활동",
          "type": "pair",
          "goal": "소개할 사람을 정해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["소개 전에 할 일은?"],"watch":"내용 정하기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  window.LESSONS["u1_l12"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"우리 할머니는 김치를 잘 담그세요!\""},{"face":"👦","label":"두리 \"어떤 김치를 제일 잘 담그셔?\""}],
        "tnote": {"ask":["친구 소개를 듣고 무엇을 물어보면 좋을까?"],"watch":"궁금한 점","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["친구 소개를 듣고 무엇을 물어보면 좋을까?","질문할 때 말차례는 왜 지켜야 할까?"],"watch":"소개 발표·경청·질문 종합 · 여럿이면 안 들림","min":4},
          "title": "소개하고 질문하기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["궁금한 점이 있을 때 카드처럼 어떻게 할까?"],"watch":"손 들고 고운 말로","min":4},
          "title": "바른 소개·듣기 모습은? ✅",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["소개를 발표하고 짝의 질문에 답해 볼까?"],"watch":"질문·답","min":5},
          "title": "주변 사람을 소개해요 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["친구 소개를 듣고 어떻게 물으면 좋을까?"],"watch":"\"~은 무엇인가요?\"","min":5},
          "title": "소개하고 질문 나누기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝에게 한 질문은 뭐였어? 짝은 뭐라고 답했어?"],"watch":"되짚기","min":5},
          "tag": "👋 짝 활동",
          "title": "소개 발표·질문 짝 활동",
          "type": "pair",
          "goal": "소개하고 질문을 나눠요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["소개를 들은 뒤 무엇을 하지?"],"watch":"질문","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "소개를 들은 뒤 무엇을 하나요?",
  ...
  window.LESSONS["u1_l13"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"말차례 지키기, 소개하기… 많이 배웠어!\""},{"face":"👦","label":"두리 \"나는 할머니 소개가 제일 기억에 남아.\""}],
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["이 단원에서 가장 도움이 된 것은 무엇일까?","말차례를 지켜 대화하는 법과 소개하는 법, 둘 다 한 문장으로 말해 볼까?"],"watch":"단원 자기점검 · 정리","min":4},
          "title": "말차례·소개 정리",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["나는 이만큼 할 수 있나? ○를 몇 개 했어?"],"watch":"자기 점검","min":5},
          "title": "스스로 확인해요",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"말차례를 지켜 대화합니다\"는 바른 문장이야? 왜?"],"watch":"판단","min":5},
          "title": "단원을 돌아보며 확인하기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["배운 것 나누기에서 짝은 무엇이 기억에 남는다고 했어?"],"watch":"듣기","min":5},
          "tag": "👋 짝 활동",
          "title": "배운 것 나누기 짝 활동",
          "type": "pair",
          "goal": "단원을 함께 정리해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["대화할 때 지킬 것은?"],"watch":"말차례","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "대화할 때 지킬 것은?",
  ...
  window.LESSONS["u1_l14"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"\"저는 책을 좋아합니다\" 끝에 점을 찍어야 해?\""},{"face":"👧","label":"하나 \"응! 묻는 말이면 물음표를 써.\""}],
        "tnote": {"ask":["문장은 어떻게 끝맺을까? \"저는 책을 좋아합니다\" 끝에 뭘 붙여?"],"watch":"마침표","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["문장은 어떻게 끝맺을까?","알리는 문장·묻는 문장·느낌 문장의 부호는 각각?"],"watch":"문장 부호로 바른 문장 마무리 · . ? !","min":4},
          "title": "바른 문장과 문장 부호",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["\"만나서 정말 반가워( )\"에는 어떤 부호가 어울려?"],"watch":"느낌표","min":4},
          "title": "알맞은 문장 부호는? ✅",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["글씨를 바르게 쓸 때 문장 부호도 함께 써 볼까?"],"watch":"부호 자리","min":5},
          "title": "글씨를 바르게 써요 ✍️",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"저는 책을 좋아합니다\" 끝에는 어떤 부호?"],"watch":"마침표","min":5},
          "title": "바른 문장과 문장 부호",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 낸 문장에 알맞은 부호를 골라 볼까?"],"watch":"놀이","min":5},
          "tag": "👋 짝 활동",
          "title": "문장 부호 짝 놀이",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["묻는 문장 끝에는?"],"watch":"물음표","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "알리는 문장 끝에는?",
