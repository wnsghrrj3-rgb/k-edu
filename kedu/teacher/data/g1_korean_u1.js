  ...
  LESSONS["u1_l01"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"간판에 글자가 잔뜩이야!\""},{"face":"🐿️","label":"도토 \"이 글자는 어떻게 만들었을까?\""}],
        "tnote": {"ask":["오늘 학교 오는 길에 본 글자 하나만 말해 볼까?"],"watch":"못 읽어도 됨 — \"봤다\"는 경험이 먼저","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㄱ이랑 ㅏ를 붙이면 무슨 글자가 될까?"],"watch":"자음·모음 이름은 아직 몰라도 됨 — 두 조각이 만난다는 그림만","min":4},
          "title": "글자는 자음자 + 모음자",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 그림, 이름이 뭐지?","그 이름은 몇 글자야?"],"watch":"카드마다 낱말을 손뼉으로 글자 수만큼 치게","min":4},
          "title": "그림 속 글자를 찾아봐요! 🔍",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["우리 교실 어디에 글자가 붙어 있어?"],"watch":"사물함·시간표·급훈 — 아이가 가리키면 교사가 읽어 줌","min":4},
          "title": "어디에서 글자를 봤나요?",
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["내 이름 첫 글자를 큰 소리로 읽어 볼까?"],"watch":"못 읽는 아이는 교사가 먼저 읽고 따라 하게","min":5},
          "title": "글자와 친해지기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "data": {
        "tnote": {"ask":["짝이 가리킨 글자, 너도 찾을 수 있어?"],"watch":"번갈아 가리키기 — 한 아이만 찾지 않게","min":5},
          "tag": "👋 짝 활동",
          "title": "글자 찾기 짝 놀이",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["글자를 배우면 뭐가 좋아질까?"],"watch":"\"엄마한테 편지 써요\" 같은 답이 나오면 크게 칭찬","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "오늘 무엇에 대해 배웠나요?",
  ...
  LESSONS["u1_l02"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"이 가게, 뭘 파는 데지?\""},{"face":"👧","label":"하나 \"글자를 읽으면 알 텐데!\""}],
        "tnote": {"ask":["글자를 하나도 못 읽는다면 병원에서 어떻게 될까?"],"watch":"\"약을 잘못 먹어요\"까지 나오게 — 글자의 쓸모","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["편지에 글자가 없으면 마음을 전할 수 있을까?"],"watch":"그림으로도 전한다는 답 → \"글자면 더 정확히\"로 이어 줌","min":4},
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["여기 보이는 글자는 뭐라고 읽을까?"],"watch":"카드 그림의 글자를 먼저 교사가 읽고 따라 읽게","min":4},
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["글자를 읽어서 좋았던 일, 누가 말해 볼래?"],"watch":"발표 뽑기 전 짝에게 먼저 말하게 하면 손이 늘어남","min":5},
          "title": "글자를 읽어서 좋았던 일 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"물\"이라고 쓰인 컵이랑 빈 컵, 어느 게 물일까?"],"watch":"글자가 없으면 모른다는 걸 몸으로","min":5},
          "title": "글자가 하는 일",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 이름표에 뭐라고 써 줄 거야?"],"watch":"이름을 못 쓰면 첫 글자만·교사가 본보기","min":5},
          "tag": "👋 짝 활동",
          "title": "이름표 만들기 짝 활동",
          "type": "pair",
          "goal": "글자로 뜻을 전해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["이름표에 글자를 쓰면 뭘 알 수 있어?"],"watch":"\"누구 거\"라는 답 확인","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "글자는 무엇을 전할까요?",
  ...
  LESSONS["u1_l03"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"가지·오이·무! 시장이다!\""},{"face":"🐿️","label":"도토 \"이름 속에 뭐가 숨어 있을까?\""}],
        "tnote": {"ask":["\"무\" 하고 소리 내면 입이 어떻게 움직여?"],"watch":"자음·모음 구분 전에 소리부터 느끼게","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["\"가\"는 ㄱ이 왼쪽? ㅏ가 오른쪽? 손가락으로 짚어 볼까?"],"watch":"옆/위아래 위치를 손가락으로 — 이름 암기보다 자리","min":4},
          "title": "글자 속 자음자와 모음자",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 낱말에서 자음자는 어디, 모음자는 어디야?"],"watch":"자음 = 먼저 오는 것, 모음 = 뒤에 붙는 것으로 단순화","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["\"무\"를 나누면 뭐랑 뭐야?"],"watch":"ㅁ·ㅜ — \"무\"를 통째로 답하면 두 조각으로 갈라 보여 주기","min":4},
          "title": "이 글자, 어떻게 나눌까요?",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㄱ, ㄴ, ㄷ 이름을 소리 내 볼까?"],"watch":"기역·니은·디귿 — 틀려도 지금은 넘어감","min":5},
          "title": "자음자와 모음자 찾기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["이 카드는 자음자 칸? 모음자 칸?"],"watch":"헷갈리는 카드(ㅇ)는 교사가 같이 판단","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["ㅏ는 자음자야, 모음자야?"],"watch":"즉답 — 틀린 아이는 s04 표를 다시 보게","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㄱ은 무엇일까요?",
  ...
  LESSONS["u1_l04"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"ㄴ이랑 ㅏ가 흩어졌어!\""},{"face":"👧","label":"하나 \"모으면 무슨 글자가 될까?\""}],
        "tnote": {"ask":["ㄴ이랑 ㅏ를 모으면 무슨 글자야?"],"watch":"\"나\" — 자석 글자로 실제로 붙여 보이기","min":3},
          "scene_title": "자모를 모으면? 🧲",
          "visual": "🔡",
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㅅ 아래에 ㅗ를 붙이면 무슨 글자? 옆에 붙이면 안 돼?"],"watch":"모음 모양에 따라 자리가 정해짐 — 옆으로 붙인 \"ㅅㅗ\"를 보여 주면 웃으며 이해","min":4},
          "title": "글자를 만드는 방법",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["두 조각을 합치면 무슨 글자가 될까?"],"watch":"먼저 각 조각 소리를 내고 → 합치기","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["ㅂ·ㅏ·ㄴ·ㅏ·ㄴ·ㅏ로 만들 수 있는 낱말은?"],"watch":"\"바나나\" — 글자가 반복됨을 눈치채게","min":4},
          "title": "자모 카드로 낱말 만들기",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㄱ＋ㅏ＝가, 그럼 ㄴ＋ㅏ는?"],"watch":"규칙 발견 — ㄷ＋ㅏ까지 이어 부르기","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 고른 두 카드로 무슨 글자가 됐어?"],"watch":"만든 글자는 꼭 소리 내 읽게","min":5},
          "tag": "👋 짝 활동",
          "title": "글자 만들기 짝 놀이",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["글자는 뭐랑 뭐로 만들어?"],"watch":"\"자음자와 모음자\"를 다 같이 외치기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㄱ＋ㅏ는?",
  ...
  LESSONS["u1_l05"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"\"가\"는 옆에 붙었네?\""},{"face":"👦","label":"두리 \"\"고\"는 아래에 있어!\""}],
        "tnote": {"ask":["\"가\"와 \"고\"의 모음자는 어디에 붙어 있어?"],"watch":"옆·아래 — 손으로 방향을 만들며 답하게","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["모음자가 세로로 긴 건 어디에, 가로로 긴 건 어디에 붙을까?"],"watch":"ㅏㅓㅣ=옆, ㅗㅜㅡ=아래 규칙을 아이 말로","min":4},
          "title": "두 가지 글자 짜임",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 글자는 옆 짜임? 위아래 짜임?"],"watch":"몸으로: 옆이면 팔을 옆으로, 위아래면 위아래로","min":4},
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["\"소\"는 옆일까, 위아래일까? 왜?"],"watch":"ㅗ가 가로로 길어서 아래 — 까닭까지","min":4},
          "title": "옆일까, 위아래일까?",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㅇ＋ㅗ는 무슨 글자? ㅇ＋ㅣ는?"],"watch":"ㅇ은 소리가 없다는 걸 자연스럽게","min":5},
          "title": "받침 없는 글자의 짜임",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 보여 준 글자의 첫소리는 어디야?"],"watch":"첫소리·가운뎃소리 낱말을 이번 차시에서 처음 쓰므로 교사가 먼저 시범","min":5},
          "tag": "👋 짝 활동",
          "title": "짜임 나누기 짝 활동",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["받침 없는 글자는 뭐랑 뭐로 이루어져?"],"watch":"\"첫소리와 가운뎃소리\" — 자음자·모음자로 답해도 정답","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  LESSONS["u1_l06"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"오늘은 글자 만들기 놀이래!\""},{"face":"🐿️","label":"도토 \"뽑은 카드로 뭘 만들지?\""}],
        "tnote": {"ask":["자음자 하나, 모음자 하나를 뽑아 볼까? 무슨 글자야?"],"watch":"실제 카드 뽑기로 시작 — 소리 내기까지","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㅈ＋ㅏ랑 ㄷ＋ㅜ, 어느 게 옆 짜임이야?"],"watch":"지난 시간 규칙 복습 — 두 글자 다 답하게","min":4},
          "title": "짜임을 떠올리며 합치기",
      ...
      },
      {
        ...
        "block": "chosung_quiz",
        "data": {
        "tnote": {"ask":["ㅈ, ㄷ 자음자 두 개면 무슨 낱말일까? 초성만 보고 맞혀 볼까?"],"watch":"초성 퀴즈가 어려우면 그림 힌트를 먼저","min":5},
          "title": "자음자와 모음자를 합치면? 🧩",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["네가 만든 낱말, 뜻이 있는 말이야?"],"watch":"\"고무·바지\"처럼 뜻이 있는 낱말과 아닌 것을 구별","min":5},
          "title": "내가 만든 낱말 발표하기 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㅗ에 자음자를 바꿔 끼우면 무슨 글자들이 나올까?"],"watch":"고·노·도·모 이어 부르기 — 규칙성","min":5},
          "title": "글자 만들기 놀이",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["모음자는 그대로 두고 자음자만 바꾸면 글자가 어떻게 돼?"],"watch":"한 조각만 바뀌어도 다른 글자","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["자음자를 바꾸면 글자는 어떻게 될까?"],"watch":"\"달라져요\" — 예 하나 더 말하게","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㅍ＋ㅗ는?",
  ...
  LESSONS["u1_l07"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"엎드려서 읽으니 편한데?\""},{"face":"👦","label":"두리 \"눈이 아프지 않아?\""}],
        "tnote": {"ask":["엎드려서 책을 읽으면 어디가 아플까?"],"watch":"눈·목·허리 — 실제로 잠깐 해 보고 느낌 말하기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["눈과 책 사이는 얼마나 띄울까? 한 뼘 재 볼까?"],"watch":"자기 뼘으로 재 보게 — 몸으로 기억","min":4},
          "title": "바르게 읽는 자세",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 자세, 뭐가 잘못됐어?"],"watch":"틀린 곳 하나만 찾게 — 고친 자세로 바로 앉아 보기","min":4},
          "title": "어떤 자세가 바를까요?",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["바른 자세로 앉아서 \"가·나·다\" 읽어 볼래?"],"watch":"발표 전 반 전체가 자세 잡기","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["허리를 펴고 읽는 것과 구부리고 읽는 것, 소리가 어떻게 달라?"],"watch":"허리를 펴면 목소리가 커짐을 체험","min":5},
          "title": "바른 자세로 읽기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝의 자세에서 잘한 점 하나만 말해 줄까?"],"watch":"지적보다 칭찬 먼저","min":5},
          "tag": "👋 짝 활동",
          "title": "또박또박 읽기 짝 점검",
          "type": "pair",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["바른 자세는 왜 필요할까?"],"watch":"\"오래 앉을 수 있어요·잘 보여요\"","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "바르게 읽을 때 허리는?",
  ...
  LESSONS["u1_l08"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"연필을 꽉 쥐어야 잘 써지지!\""},{"face":"🐿️","label":"도토 \"손이 아프지 않을까?\""}],
        "tnote": {"ask":["연필을 주먹으로 꽉 쥐면 손이 어떻게 될까?"],"watch":"실제로 해 보면 \"아파요·글씨가 비뚤어요\"","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["연필은 몇 손가락으로 잡을까? 보여 줄래?"],"watch":"세 손가락 — 교사가 아이 손을 잡고 교정","min":4},
          "title": "바르게 쓰는 자세",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 친구 연필 잡는 손, 뭐가 이상해?"],"watch":"주먹 쥐기·너무 아래 잡기","min":4},
          "title": "어떤 자세가 바를까요?",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["바른 자세로 \"나\"를 써서 보여 줄래?"],"watch":"반대 손이 공책을 잡고 있는지 같이 확인","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["연필을 바르게 잡고 \"나\"를 쓰면 글씨가 어떻게 달라져?"],"watch":"반듯해짐 — 전후 비교","min":5},
          "title": "바른 자세로 쓰기",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝 손 모양, 세 손가락이야?"],"watch":"고쳐 줄 때는 말로만 — 손을 억지로 바꾸지 않게","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["바른 쓰기 자세는 왜 좋을까?"],"watch":"\"손이 안 아파요·글씨가 예뻐요\"","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "쓸 때 연필은 어떻게?",
  ...
  LESSONS["u1_l09"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"ㅐ? 처음 보는 모음자야!\""},{"face":"👦","label":"두리 \"ㅔ도 있대. 뭐가 다르지?\""}],
        "tnote": {"ask":["ㅐ랑 ㅔ, 소리를 내 볼까? 입 모양이 어때?"],"watch":"소리 구별이 어려움 — 지금은 \"둘 다 모음자\"로 충분","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㅂ에 ㅐ를 붙이면 무슨 글자? 물 위에 뜨는 그거!"],"watch":"\"배\" — 뜻이 있는 낱말로 확인","min":4},
          "title": "모음자 ㅐ와 ㅔ",
      ...
      },
      {
        ...
        "block": "chosung_quiz",
        "data": {
        "tnote": {"ask":["ㅂ 하나만 있는데 무슨 낱말일까? ㅐ가 들어가요!"],"watch":"배 — 힌트를 순서대로","min":4},
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["ㅐ나 ㅔ가 들어간 낱말을 하나 말해 볼래?"],"watch":"개·배·게·세수 — 겹치면 다른 낱말로","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㄱ＋ㅐ는 무슨 글자? 멍멍 짖는 동물!"],"watch":"\"개\" — 쓰기까지","min":5},
          "title": "여러 가지 모음자 ①",
          "levels": {
            "읽기": {
              "q": "모음자 ㅐ, ㅔ를 읽어 볼까요?",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["자음자에 ㅐ를 붙여 만든 글자, 읽어 줄래?"],"watch":"뜻 없는 글자도 읽기는 정답","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["모음자가 바뀌면 글자는 어떻게 돼?"],"watch":"\"달라져요\" — 배/베 예로 확인","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㄱ＋ㅐ는?",
  ...
  LESSONS["u1_l10"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"ㅘ는 ㅗ랑 ㅏ가 붙었어!\""},{"face":"🐿️","label":"도토 \"모음자 둘이 만났네?\""}],
        "tnote": {"ask":["ㅘ를 보면 어떤 모음자 두 개가 보여?"],"watch":"ㅗ와 ㅏ — 손가락으로 나눠 짚기","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["\"과일\"의 첫 글자에 ㅘ가 있어. 찾아볼까?"],"watch":"\"과\" — 낱말 속에서 찾기","min":4},
          "title": "여러 가지 모음자",
      ...
      },
      {
        ...
        "block": "chosung_quiz",
        "data": {
        "tnote": {"ask":["ㄱ ㅇ 두 자음자, 오늘 배운 모음자가 들어가요. 무슨 낱말?"],"watch":"과일 — 힌트 순서대로","min":4},
          "title": "여러 모음자 낱말 맞히기 🧩",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["오늘 배운 모음자가 든 낱말, 하나만 말해 볼래?"],"watch":"돼지·화분·왼손 외 다른 것이 나오면 칭찬","min":5},
          "title": "여러 모음자 낱말 말하기 🎤",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㅏ랑 ㅑ, 소리가 같아? 내 볼까?"],"watch":"아/야 — 짧은 줄 하나 차이","min":5},
          "title": "여러 가지 모음자 ②",
          "levels": {
            "읽기": {
              "q": "모음자 ㅑ, ㅕ를 읽어 볼까요?",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["ㅏ 카드와 ㅑ 카드 짝을 지어 볼까? 뭐가 달라?"],"watch":"줄 하나 — 눈으로 비교","min":5},
          "tag": "👋 짝 활동",
          "title": "모음자 짝 맞추기",
          "type": "pair",
          "goal": "비슷한 모음자를 구별해요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["ㅇ＋ㅑ는 무슨 글자?"],"watch":"\"야\" — 소리로 확인","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㅇ＋ㅑ는?",
  ...
  LESSONS["u1_l11"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"\"귀\"의 모음자는 뭘까?\""},{"face":"👦","label":"두리 \"ㅜ랑 ㅣ가 만난 거 아냐?\""}],
        "tnote": {"ask":["\"귀\"에서 모음자를 찾아볼까? 몇 개가 만났어?"],"watch":"ㅜ+ㅣ — 둘이 만난 모음자","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㅇ에 ㅢ를 붙이면? 앉는 그거!"],"watch":"\"의자\" — 낱말로 확인","min":4},
          "title": "또 다른 모음자",
      ...
      },
      {
        ...
        "block": "chosung_quiz",
        "data": {
        "tnote": {"ask":["ㄱ 하나만 있어요. 얼굴에 있고 소리를 들어요. 무슨 낱말?"],"watch":"귀","min":4},
          "title": "여러 모음자 낱말 맞히기 🧩",
          "sub": "가운데 글자를 보고 무슨 낱말일지 생각해요. [정답 보기]를 누르면 답이 나와요",
          "items": [
            {
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["오늘 배운 모음자가 든 낱말을 말해 볼래?"],"watch":"귀·의자·바위·가위 외에도 인정","min":5},
          "title": "모음자 낱말 말하기 놀이 🎤",
          "sub": "버튼을 누르면 발표할 친구를 뽑아요. 오늘 배운 모음자가 들어간 낱말을 하나 말해요!",
          "count": 24,
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["ㅛ랑 ㅠ 소리를 내 볼까? ㅗ·ㅜ와 뭐가 달라?"],"watch":"요/유 — 줄 하나","min":5},
          "title": "여러 가지 모음자 ③",
          "levels": {
            "읽기": {
              "q": "모음자 ㅛ, ㅠ를 읽어 볼까요?",
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["배운 모음자 카드를 순서대로 놓아 볼까? 몇 개야?"],"watch":"전부 못 세도 됨 — 많다는 걸 느끼게","min":5},
          "tag": "👋 짝 활동",
          "title": "모음자 모으기 짝 놀이",
          "type": "pair",
          "goal": "여러 모음자를 모아 읽어요",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["모음자를 몇 가지나 배웠어?"],"watch":"\"여러 가지\" — 정확한 수는 요구하지 않음","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "ㅇ＋ㅛ는?",
  ...
  LESSONS["u1_l12"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👦","label":"두리 \"이제 글자 짜임을 다 알아!\""},{"face":"👧","label":"하나 \"정말? 확인해 보자!\""}],
        "tnote": {"ask":["이 단원에서 뭘 배웠는지 한 가지만 말해 볼래?"],"watch":"자음자·모음자·짜임 — 아이 말로","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["\"가\"는 옆 짜임, 그럼 \"고\"는?"],"watch":"위아래 — 표에서 찾게","min":4},
          "title": "우리가 배운 것",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["이 글자의 자음자는? 모음자는? 짜임은?"],"watch":"세 가지 순서대로 — 하나씩","min":4},
          "title": "이 글자를 점검해 볼까요?",
      ...
      },
      {
        ...
        "block": "question",
        "data": {
        "tnote": {"ask":["\"재\"는 뭐랑 뭐로 나뉘고 어떤 짜임이야?"],"watch":"ㅈ＋ㅐ 옆 — 새 모음자 ㅐ도 짜임은 같음","min":4},
          "title": "옆일까, 위아래일까?",
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"다\"의 자음자는? 모음자는?"],"watch":"ㄷ·ㅏ — 쓰기까지","min":5},
          "title": "글자 짜임 점검",
          "levels": {
            "읽기": {
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝이 보여 준 글자, 뭐랑 뭐야?"],"watch":"못 맞히면 짝이 힌트(자음자만)","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["글자는 뭐랑 뭐로 이루어질까?"],"watch":"다 같이 외치기","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "'다'의 자음자는?",
  ...
  LESSONS["u1_l13"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"🐿️","label":"도토 \"칠판에 자모가 흩어졌어!\""},{"face":"👧","label":"하나 \"모으면 낱말이 될 거야!\""}],
        "tnote": {"ask":["ㄴ·ㅂ·ㅣ·ㅜ로 무슨 낱말을 만들 수 있을까?"],"watch":"나비/누비 — 여러 답 가능","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["ㄱ·ㅁ·ㅗ·ㅜ로는? 고무? 구모? 어느 게 진짜 낱말이야?"],"watch":"뜻 있는 낱말 고르기","min":4},
          "title": "낱말 알아맞히기 놀이",
      ...
      },
      {
        ...
        "block": "chosung_quiz",
        "data": {
        "tnote": {"ask":["ㄴ ㅂ, 초성만 보고 무슨 낱말일까?"],"watch":"나비 — 그림 힌트","min":4},
          "title": "흩어진 자모로 낱말 찾기 🧩",
          "sub": "가운데 자음자와 모음자를 보고 무슨 낱말일지 생각해요. [정답 보기]를 누르면 답이 나와요",
          "items": [
            {
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["네가 낼 문제, 자모를 흩어서 보여 줄래?"],"watch":"문제 내는 아이가 답도 알고 있어야 함","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["네가 만든 글자, 소리 내어 읽어 볼까?"],"watch":"뜻 없는 글자도 읽으면 정답","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["짝과 누가 더 많이 만들었어? 둘 다 읽어 볼까?"],"watch":"경쟁보다 읽기","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["\"도\"는 뭐랑 뭐로 만들었어?"],"watch":"ㄷ·ㅗ","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
  ...
  LESSONS["u1_l14"] =
  {
    ...
    "slides": [
      ...
      },
      {
        ...
        "block": "motivate",
        "data": {
        "kids": [{"face":"👧","label":"하나 \"우리 이제 글자를 만들 수 있어!\""},{"face":"👦","label":"두리 \"오늘은 낱말까지 만들어 보자!\""}],
        "tnote": {"ask":["처음엔 못 읽던 글자, 지금은 읽을 수 있는 게 있어?"],"watch":"자기 이름·간판 — 성장 확인","min":3},
      ...
      },
      {
        ...
        "block": "concept",
        "data": {
        "tnote": {"ask":["보기 자음자 ㄱ에 ㅡ를 붙이면? 그 다음엔?"],"watch":"\"그\" — 낱말을 만들려면 글자를 이어야 함","min":4},
          "title": "낱말 만들고 읽기",
      ...
      },
      {
        ...
        "block": "card_quiz",
        "data": {
        "tnote": {"ask":["보기 자모로 낱말을 하나 만들면 뭐가 돼?"],"watch":"카드 하나씩 열며","min":4},
          "title": "보기 자모로 낱말 만들기",
      ...
      },
      {
        ...
        "block": "present",
        "data": {
        "tnote": {"ask":["만든 낱말을 바른 자세로 또박또박 읽어 볼래?"],"watch":"7·8차시 자세 상기","min":5},
      ...
      },
      {
        ...
        "block": "leveled_problem",
        "data": {
        "tnote": {"ask":["\"포도\"는 어떤 글자 두 개를 이었어?"],"watch":"포＋도 — 두 글자","min":5},
      ...
      },
      {
        ...
        "block": "offline_activity",
        "data": {
        "tnote": {"ask":["글자 카드를 이어 만든 낱말, 짝에게 읽어 줄래?"],"watch":"뜻이 있는지 짝이 확인","min":5},
          "tag": "👋 짝 활동",
      ...
      },
      {
        ...
        "block": "exit_ticket",
        "data": {
        "tnote": {"ask":["낱말은 뭘 이어서 만들까?"],"watch":"\"글자\"","min":3},
          "title": "오늘 확인해요",
          "items": [
            {
              "q": "'포도'는 몇 글자인가요?",
