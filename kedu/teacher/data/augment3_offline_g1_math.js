...
const A = {
  ...
  'g1_math_u4.js': {
    u4_l06: { id: 's12b', title: '짝에게 비교 문제 내기', tag: '짝 활동', type: 'pair', icon: '⚖️', goal: '길이·무게·들이·넓이 중 하나를 골라 문제를 내고 풀어요.', steps: ['책상 위 물건 두 개를 골라요.', '"무엇을 견줄까?"(길이·무게·들이·넓이) 먼저 말해요.', '짝이 비교 방법을 말하고 답해요(예: 한쪽 끝 맞추기).', '역할을 바꿔 네 가지 모두 한 번씩 해요.'], materials: ['책상 위 물건'], minutes: 5, tnote: { ask: ['비교하기 전에 먼저 정할 것은?'], watch: '무엇을 견주는지', min: 5 } }
  },
  'g1_math_u3.js': {
