...
(function (root, factory) {
  ...
  const PUZZLE_DATA = {
    ...
    /* ── 🧭 스스로 찾기 12종 (2026-07-20 저작·전수 겹침 0 검증) — 자리 안내 없음 ── */
    candle:    { pl: [["Q",2.828,0,1,0],["M",0.828,4,0,0],["S",2.828,6,7,0],["S",2.828,6,1,0],["L",0,8,0,0],["L",5.657,13.657,4,0],["P",0.828,13.657,0,0]], w: 6.83, h: 15.66 },
    mountain:  { pl: [["L",9.657,9,4,0],["L",9.657,9,6,0],["M",18.142,6.172,1,0],["S",2,7,1,0],["S",22.971,7,1,0],["P",4.172,6,7,0],["Q",17.657,0,1,0]], w: 24.97, h: 9 },
    rabbit:    { pl: [["L",4,10,0,0],["L",9.657,15.657,4,0],["Q",9.657,6,1,0],["P",9.657,6,6,0],["S",9.657,6,4,0],["M",4,15.657,4,0],["S",9.657,15.657,6,0]], w: 12.49, h: 15.66 },
    dog:       { pl: [["S",0,4.828,7,0],["S",2,2.828,6,0],["Q",2,4,0,0],["L",4.828,2,0,0],["L",10.485,7.657,4,0],["M",10.485,7.657,2,0],["P",10.485,4,7,0]], w: 16.14, h: 11.66 },
    duck:      { pl: [["L",5,4,1,0],["L",5,4,7,0],["S",2,4.172,0,0],["Q",2,1.343,0,0],["S",0,2.757,7,0],["M",9,4,7,0],["P",3,8,0,0]], w: 11.83, h: 10 },
    fox:       { pl: [["L",5.657,2.828,0,0],["L",5.657,2.828,2,0],["S",0,2.828,6,0],["S",11.314,2.828,4,0],["M",5.657,8.485,1,0],["P",8.485,11.313,7,0],["Q",12.727,4.485,1,0]], w: 14.73, h: 11.31 },
    turtle:    { pl: [["L",10,0,1,0],["L",10,8,5,0],["Q",16,2,1,0],["P",6,4,4,0],["M",10,8,2,0],["S",10,8,0,0],["S",12,6,7,0]], w: 18, h: 12 },
    camel:     { pl: [["L",4,8.828,1,0],["L",8,12.828,5,0],["M",8.828,6,1,0],["P",4,8.828,6,0],["S",6,2.828,4,0],["Q",1,12.828,0,0],["S",8,12.828,2,0]], w: 12, h: 15.66 },
    butterfly: { pl: [["L",4,5.828,3,0],["L",6,5.828,7,0],["P",6,2.828,2,0],["S",6,2.828,4,0],["S",6,2.828,6,0],["M",0,9.828,0,0],["Q",10,9.828,1,0]], w: 12, h: 13.83 },
    jet:       { pl: [["P",3.657,7.657,0,1],["S",11.657,5.657,3,0],["L",5.657,7.657,0,0],["L",5.657,5.657,4,0],["M",2.829,7.657,1,0],["S",8.657,5.657,4,0],["Q",5.657,13.314,1,0]], w: 11.66, h: 17.31 },
    seal:      { pl: [["L",7,4,1,0],["L",11,8,5,0],["Q",7,1.172,0,0],["S",7,4,4,0],["M",15,4,6,0],["S",7,8,0,0],["P",0,8,0,0]], w: 19, h: 10.83 },
    trophy:    { pl: [["L",8.485,2.828,0,0],["L",8.485,2.828,2,0],["Q",8.485,8.485,1,0],["M",8.485,12.485,1,0],["P",5.657,15.313,0,0],["S",2.828,2.828,4,0],["S",14.142,2.828,6,0]], w: 16.97, h: 17.31 }
  };
  ...
  const PUZZLES = [
    ...
    /* stars 4 = 🧭 스스로 찾기: 자리 안내(호버·뒤집기 귀띔) 없음 — 혼자 이리저리 궁리 */
    { id: 'duck',      name: '오리',     stars: 4 },
    { id: 'rabbit',    name: '토끼',     stars: 4 },
    { id: 'dog',       name: '강아지',   stars: 4 },
    { id: 'fox',       name: '여우',     stars: 4 },
    { id: 'turtle',    name: '거북이',   stars: 4 },
    { id: 'seal',      name: '물개',     stars: 4 },
    { id: 'camel',     name: '낙타',     stars: 4 },
    { id: 'butterfly', name: '나비',     stars: 4 },
    { id: 'candle',    name: '촛불',     stars: 4 },
    { id: 'mountain',  name: '산',       stars: 4 },
    { id: 'jet',       name: '비행기',   stars: 4 },
    { id: 'trophy',    name: '트로피',   stars: 4 }
  ].map(function (m) {
