...
window.MK_SVGPACK = (() => {
  ...
  const REG = [
    { src: {
      ...
      scenes: [{ id: 'p1', name: "영화 포스터", width: 1080, height: 1350, duration: 5,
        background: "#101114", transition: 'fade', order: 0, elements: PACK["movie-poster-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "공간 소개 카드", width: 1080, height: 1080, duration: 5,
        background: "#E8E4DC", transition: 'fade', order: 0, elements: PACK["realestate-social-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "학습 정리지", width: 1600, height: 1100, duration: 5,
        background: "#FFFDF6", transition: 'fade', order: 0, elements: PACK["worksheet-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "개장 안내", width: 1080, height: 1350, duration: 5,
        background: "#F7E35F", transition: 'fade', order: 0, elements: PACK["grand-opening-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "문구 카드", width: 1080, height: 1080, duration: 5,
        background: "#E9E1F5", transition: 'fade', order: 0, elements: PACK["quote-social-01"].elements }],
