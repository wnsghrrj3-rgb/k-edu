...
window.MK_SVGPACK = (() => {
  ...
  const REG = [
    { src: {
      ...
      pageCount: 1,
      scenes: [{ id: 'p1', name: "Y2K 행사면", width: 1080, height: 1350, duration: 5, background: "#D8FF3E", transition: 'fade', order: 0, elements: PACK["y2k-event-01"].elements }],
    ...
    { src: {
      ...
      pageCount: 1,
      scenes: [{ id: 'p1', name: "전시 안내", width: 1080, height: 1350, duration: 5, background: "#EEE9E0", transition: 'fade', order: 0, elements: PACK["museum-exhibition-01"].elements }],
    ...
    { src: {
      ...
      pageCount: 1,
      scenes: [{ id: 'p1', name: "학급 선거", width: 1080, height: 1350, duration: 5, background: "#EAF4FF", transition: 'fade', order: 0, elements: PACK["school-election-01"].elements }],
    ...
    { src: {
      ...
      pageCount: 1,
      scenes: [{ id: 'p1', name: "실적 보고", width: 1600, height: 900, duration: 5, background: "#F5F7F8", transition: 'fade', order: 0, elements: PACK["finance-report-01"].elements }],
    ...
    { src: {
      ...
      pageCount: 1,
      scenes: [{ id: 'p1', name: "반려동물 안내", width: 1080, height: 1350, duration: 5, background: "#FFF3DE", transition: 'fade', order: 0, elements: PACK["pet-adoption-01"].elements }],
