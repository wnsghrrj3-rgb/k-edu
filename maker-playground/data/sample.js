  ...
  const TEMPLATES = [
    {
      ...
      scenes: [
        { id: 's1', name: '표지', width: 1280, height: 720, duration: 5, background: '#FFFFFF', transition: 'fade', order: 0,
          elements: [t(8, 16, 84, 10, '물의 여행', 700), t(8, 32, 66, 4, '4학년 과학 · 증발과 응결'), t(8, 82, 44, 2.8, '2026년 7월 · 과학 1교시')] },
        { id: 's2', name: '오늘의 흐름', width: 1280, height: 720, duration: 5, background: '#FFFFFF', transition: 'fade', order: 1,
          elements: [t(8, 12, 44, 6.5, '오늘의 흐름', 700), t(8, 34, 56, 3.8, '1. 젖은 운동장은 왜 마를까?'), t(8, 47, 56, 3.8, '2. 증발 실험 — 물의 변신'), t(8, 60, 56, 3.8, '3. 차가운 컵의 물방울, 응결')] },
        { id: 's3', name: '증발이란?', width: 1280, height: 720, duration: 6, background: '#FFFFFF', transition: 'slide', order: 2,
          elements: [t(8, 10, 50, 6, '증발이란?', 700), t(8, 28, 44, 3.4, '물이 표면에서 천천히 수증기로\n변해 공기 중으로 흩어지는 현상'), img(58, 24, 34, 54, '실험 사진')] },
        { id: 's4', name: '정리', width: 1280, height: 720, duration: 4, background: '#1F2733', transition: 'fade', order: 3,
          elements: [t(20, 36, 60, 8, '오늘 배운 것', 700), t(20, 58, 60, 3.2, '물은 사라지지 않고 모습만 바꾼다\n다음 시간 — 구름과 비')] },
      ],
    },
    {
