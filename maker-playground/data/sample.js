  ...
  const TEMPLATES = [
    {
      ...
      scenes: [
        { id: 's1', name: '표지', width: 1280, height: 720, duration: 5, background: '#FFFFFF', transition: 'fade', order: 0,
          elements: [box(0, 0, 2.4, 100, '#2E8C7F'), box(70, 14, 22, 40, '#E3F1EE'), img(73.5, 20, 15, 28, ''),
            t(9, 20, 58, 10, '물의 여행', 700), t(9, 36, 56, 3.8, '4학년 과학 · 증발과 응결'),
            box(9, 46, 7, 1, '#E8735A'), t(9, 84, 44, 2.6, '2026년 7월 · 과학 1교시')] },
        { id: 's2', name: '오늘의 흐름', width: 1280, height: 720, duration: 5, background: '#FFFFFF', transition: 'fade', order: 1,
          elements: [t(8, 11, 44, 6, '오늘의 흐름', 700), box(8, 30, 25, 44, '#E3F1EE'), box(37.5, 30, 25, 44, '#F5F1E6'), box(67, 30, 25, 44, '#FBE9E4'),
            t(11, 36, 8, 5, '1', 700), t(11, 50, 19, 3, '젖은 운동장은\n왜 마를까?', 600),
            t(40.5, 36, 8, 5, '2', 700), t(40.5, 50, 19, 3, '증발 실험\n물의 변신', 600),
            t(70, 36, 8, 5, '3', 700), t(70, 50, 19, 3, '차가운 컵의\n물방울, 응결', 600)] },
        { id: 's3', name: '증발이란?', width: 1280, height: 720, duration: 6, background: '#FFFFFF', transition: 'slide', order: 2,
          elements: [box(8, 11, 11, 6, '#E3F1EE'), t(9.5, 12.6, 9, 2.6, '핵심 개념', 600),
            t(8, 22, 46, 6, '증발이란?', 700), t(8, 38, 44, 3.4, '물이 표면에서 천천히 수증기로\n변해 공기 중으로 흩어지는 현상'),
            box(8, 56, 7, 1, '#2E8C7F'), t(8, 62, 42, 2.8, '예) 빨래 마르기 · 물웅덩이 사라지기'),
            img(58, 20, 34, 58, '실험 사진')] },
        { id: 's4', name: '정리', width: 1280, height: 720, duration: 4, background: '#1F2733', transition: 'fade', order: 3,
          elements: [box(20, 34, 7, 1.2, '#2E8C7F'), t(20, 40, 60, 8, '오늘 배운 것', 700),
            t(20, 60, 60, 3.2, '물은 사라지지 않고 모습만 바꾼다\n다음 시간 — 구름과 비'), box(20, 78, 4, 1.2, '#E8735A')] },
      ],
    },
    {
