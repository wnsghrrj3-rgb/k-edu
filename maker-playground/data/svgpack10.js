...
window.MK_SVGPACK = (() => {
  ...
  const REG = [
    { src: {
      ...
      scenes: [{ id: 'p1', name: "발표회 안내", width: 1080, height: 1350, duration: 5,
        background: "#071827", transition: 'fade', order: 0, elements: PACK["tech-conference-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "학예회 초대장", width: 1080, height: 1350, duration: 5,
        background: "#FFF8E9", transition: 'fade', order: 0, elements: PACK["school-invite-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "무드보드", width: 1600, height: 1100, duration: 5,
        background: "#EAE2D8", transition: 'fade', order: 0, elements: PACK["brand-moodboard-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "일정표", width: 1080, height: 1350, duration: 5,
        background: "#E8F2F2", transition: 'fade', order: 0, elements: PACK["travel-itinerary-01"].elements }],
    ...
    { src: {
      ...
      scenes: [{ id: 'p1', name: "수업 안내", width: 1080, height: 1350, duration: 5,
        background: "#191724", transition: 'fade', order: 0, elements: PACK["course-promo-01"].elements }],
