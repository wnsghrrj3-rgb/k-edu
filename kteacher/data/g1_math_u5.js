...
(function () {
  ...
  // ===== 기본문제 (3) =====
  {id:"s09",stage:"기본문제",block:"basic_problem",data:{title:"모두 몇 개일까요?",question:"왼쪽 🐚 **9개**\n오른쪽 🐚 **6개**\n\n두 묶음을 모으면 ▢개"},suggested_extras:["m_count_on_from_larger","a_finger_split"]},
  {id:"s10",stage:"기본문제",block:"basic_problem",data:{title:"14를 갈라요 — 한 묶음은 8",question:"**14**를 두 묶음으로 갈라요.\n한 묶음이 **8**이면\n다른 묶음은 ▢"},suggested_extras:["a_supp_workbook"]},
  {id:"s11",stage:"기본문제",block:"basic_problem",data:{title:"16을 갈라요 — 한 묶음은 9",question:"**16**을 두 묶음으로 갈라요.\n한 묶음이 **9**이면\n다른 묶음은 ▢"},suggested_extras:["m_count_back_subtraction"]},
  // ===== 응용문제 (4) =====
  {id:"s12",stage:"응용문제",block:"advanced_problem",data:{title:"두 묶음을 자유롭게 모아 봐요",question:"🐚 묶음을 자유롭게 골라\n**두 묶음을 모아** 봐요.\n친구와 만든 수가 다를 수 있어요."},suggested_extras:["r_buttons_share","x_order_diff_pair","q_secret_pair"]},
  ...
  // ===== 기본문제 (3) =====
  {id:"s09",stage:"기본문제",block:"basic_problem",data:{title:"튜브가 모두 몇 개일까요?",question:"10개씩 묶음 **2개**가 있어요.\n\n튜브는 모두 ▢개"},suggested_extras:["a_tube_count","r_egg_carton"]},
  {id:"s10",stage:"기본문제",block:"basic_problem",data:{title:"구명조끼가 모두 몇 개일까요?",question:"10개씩 묶음 **4개**가 있어요.\n\n구명조끼는 모두 ▢개"},suggested_extras:["r_lifejacket_storage"]},
  {id:"s11",stage:"기본문제",block:"basic_problem",data:{title:"30을 두 가지로 읽어요",question:"아이스크림 **묶음 3개**\n수로는 ▢\n말로는 ▢ / ▢"},suggested_extras:["x_korean_writing_repeat"]},
  // ===== 응용문제 (4) =====
  {id:"s12",stage:"응용문제",block:"advanced_problem",data:{title:"10개씩 묶음을 자유롭게 만들어 봐요",question:"구슬을 10개씩 묶어 봐요.\n묶음 ▢개를 만들면\n몇십이 될까요?"},suggested_extras:["m_choose_tool","q_thirty_things","g_make_fifty_game"]},
  ...
  // ===== 기본문제 (4) =====
  {id:"s08",stage:"기본문제",block:"basic_problem",data:{title:"파라솔이 몇 개일까요?",question:"10개씩 묶음 **2개**와\n낱개 **5개**가 있어요.\n\n파라솔은 모두 ▢개"},suggested_extras:["r_locker_24","m_context_reading"]},
  {id:"s09",stage:"기본문제",block:"basic_problem",data:{title:"게가 몇 마리일까요?",question:"10개씩 묶음 **3개**와\n낱개 **4개**가 있어요.\n\n게는 모두 ▢마리"},suggested_extras:["a_baduk_count"]},
  {id:"s10",stage:"기본문제",block:"basic_problem",data:{title:"물고기가 몇 마리일까요?",question:"10개씩 묶음 **4개**와\n낱개 **1개**가 있어요.\n\n물고기는 모두 ▢마리"},suggested_extras:["r_book_page_35"]},
  {id:"s11",stage:"기본문제",block:"basic_problem",data:{title:"36은 묶음과 낱개로 어떻게?",question:"**36**을 나타내요.\n10개씩 묶음 ▢개\n낱개 ▢개"},suggested_extras:["m_same_digit_22_33","a_supp_workbook"]},
  // ===== 응용문제 (4) =====
  {id:"s12",stage:"응용문제",block:"advanced_problem",data:{title:"묶음과 낱개로 수를 만들어 봐요",question:"묶음과 낱개를 자유롭게 골라\n두 자리 수를 만들어 봐요.\n내가 만든 수를 읽어 봐요."},suggested_extras:["g_baduk_guess","q_my_age_birthday","m_baduk_limit"]},
