...
window.EN_LADDER = {
  ...
  levels: [
    ...
    {
      id: 'lv2', num: 2, name: '긴 단어와 짧은 글 읽기', open: true,
      desc: '자음·모음 묶음과 매직 e까지 익혀 짧은 글을 읽습니다.',
      steps: [
        { id: 'lv2-01', track: 'P', name: 'sh·ch 소리 읽기', en: 'sh+i+p → ship' },
        { id: 'lv2-02', track: 'V', name: '음식 단어 1', en: 'fish · chips · lunch' },
        { id: 'lv2-03', track: 'P', name: 'th·ck 소리 읽기', en: 'th+i+s → this' },
        { id: 'lv2-04', track: 'V', name: '학교 단어 1', en: 'desk · chair · book' },
        { id: 'lv2-05', track: 'P', name: 'st·sp·sn·sw 소리 읽기', en: 's+t+o+p → stop' },
        { id: 'lv2-06', track: 'P', name: 'bl·cl·fl·gr·fr·dr 소리 읽기', en: 'f+l+a+g → flag' },
        { id: 'lv2-07', track: 'V', name: '동작 단어 1', en: 'stop · swim · jump' },
        { id: 'lv2-08', track: 'P', name: '끝소리 묶어 읽기', en: 'ha+n+d → hand' },
        { id: 'lv2-09', track: 'R', name: '짧은 글 읽기 1', en: 'I see a big fish.' },
        { id: 'lv2-10', track: 'G', name: 'am · are · is 찾아내기', en: 'I am / You are / It is', star: true },
        { id: 'lv2-11', track: 'P', name: '매직 e — a_e 읽기', en: 'cap → cape' },
        { id: 'lv2-12', track: 'V', name: '음식·놀이 단어 2', en: 'cake · grape · game' },
        { id: 'lv2-13', track: 'P', name: '매직 e — i_e 읽기', en: 'kit → kite' },
        { id: 'lv2-14', track: 'P', name: '매직 e — o_e·u_e 읽기', en: 'home · nose · cute' },
        { id: 'lv2-15', track: 'V', name: '몸·얼굴 단어', en: 'face · nose · hand' },
        { id: 'lv2-16', track: 'P', name: '매직 e 섞어 읽기', en: 'cap ↔ cape · kit ↔ kite' },
        { id: 'lv2-17', track: 'R', name: '짧은 글 읽기 2', en: 'It is a cake.' },
        { id: 'lv2-18', track: 'V', name: '시간·하루 단어', en: 'time · late · wake' },
        { id: 'lv2-19', track: 'P', name: '모음 ai·ay 읽기', en: 'rain · day' },
        { id: 'lv2-20', track: 'V', name: '날씨·바깥 단어', en: 'rain · day · play' },
        { id: 'lv2-21', track: 'P', name: '모음 ee·ea 읽기', en: 'see · tree · eat' },
        { id: 'lv2-22', track: 'V', name: '학교·읽기 단어 2', en: 'read · see · green' },
        { id: 'lv2-23', track: 'P', name: '모음 oa·ow 읽기', en: 'boat · snow' },
        { id: 'lv2-24', track: 'G', name: 'a · an 붙이기', en: 'a dog / an egg' },
        { id: 'lv2-25', track: 'V', name: '탈것·바깥 단어', en: 'boat · road · bike' },
        { id: 'lv2-26', track: 'R', name: '짧은 글 읽기 3', en: 'It is a boat.' },
        { id: 'lv2-27', track: 'V', name: '기본 단어 익히기 3', en: 'he · she · we · they' },
        { id: 'lv2-28', track: 'V', name: '수·양 단어', en: 'six ~ ten · many' },
        { id: 'lv2-29', track: 'G', name: '"It is a ~." 문장 만들기', en: 'It is a ~. / They are ~.' },
        { id: 'lv2-30', track: 'V', name: '기분 단어', en: 'happy · sad · fine' },
        { id: 'lv2-31', track: 'V', name: '자연 단어', en: 'tree · lake · rock' },
        { id: 'lv2-32', track: 'V', name: '동작 단어 2', en: 'ride · wave · stand' },
        { id: 'lv2-33', track: 'R', name: '짧은 글 읽기 4', en: 'Mina의 하루', star: true },
        { id: 'lv2-34', track: 'M', name: 'Lv2 마무리 평가', en: 'Read it yourself!', mission: true }
      ]
    },
